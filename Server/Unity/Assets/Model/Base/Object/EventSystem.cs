...
namespace ETModel
{
    ...
    public sealed class EventSystem
    {
        ...
        private HashSet<long> loaders = new HashSet<long>();
        ...
        public void Add(Component component)
        {
            ...
            {
                this.loaders.Add(component.InstanceId);
            }
        ...
        public void Remove(long instanceId)
        {
            ...
            this.loaders.Remove(instanceId);
        }
        ...
        public void Awake<P1, P2, P3, P4, P5>(Component component, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5)
        {
            List<IAwakeSystem> iAwakeSystems = this.awakeSystems[component.GetType()];
            if (iAwakeSystems == null)
            {
            ...
            foreach (IAwakeSystem aAwakeSystem in iAwakeSystems)
            {
                ...
                IAwake<P1, P2, P3, P4, P5> iAwake = aAwakeSystem as IAwake<P1, P2, P3, P4, P5>;
                if (iAwake == null)
                {
                    continue;
                }
                ...
                try
                {
                    iAwake.Run(component, p1, p2, p3, p4, p5);
                }
                catch (Exception e)
                {
                    Log.Error(e);
        ...
        public void Load()
        {
            foreach(long instanceId in this.loaders)
            {
                this.loaders2.Enqueue(instanceId);
            }
            while (this.loaders2.Count > 0)
            {
                long instanceId = this.loaders2.Dequeue();
                Component component;
