...
namespace ETModel
{
    public static class ComponentFactory
    {
        ...
        {
            Component component = CreateInstance(type, fromPool);
        ...
        public static T CreateWithParent<T>(Component parent, bool fromPool = true) where T : Component
        {
            ...
            T component = (T)CreateInstance(type, fromPool);
        ...
        public static T CreateWithType<T, A>(Type type, A a, bool fromPool = true) where T : Component
        {
            T component = (T)CreateInstance(type, fromPool);
        ...
        public static T Create<T, A, B, C, D>(A a, B b, C c, D d, bool fromPool = true) where T : Component
        {
            Type type = typeof(T);
        ...
        public static T Create<T, A, B, C, D, E>(A a, B b, C c, D d, E e, bool fromPool = true) where T : Component
        {
            Type type = typeof(T);
            ...
            Game.EventSystem.Awake(component, a, b, c, d, e);
            return component;
        }
        ...
        private static Component CreateInstance(Type type, bool fromPool = true)
        {
            Component component;
            if (fromPool)
            {
