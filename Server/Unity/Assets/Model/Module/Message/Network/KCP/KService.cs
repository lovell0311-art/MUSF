...
namespace ETModel
{
	public static class KcpProtocalType
	{
		...
		public const byte RouterReconnectSYN = 9;//软路由
		public const byte RouterReconnectACK = 10;//软路由
		public const byte RouterSYN = 11;//软路由
		public const byte RouterACK = 12;//软路由
				...
				switch (flag)
				{
                    ...
                    case KcpProtocalType.MSG_V1:  // 正常消息
                                               // 长度<11，不是Msg消息
                        {
                            ...
                            if (Checksum(this.cache,0, messageLength) != checksum)
							{
								// 数据被修改
								break;
							}
