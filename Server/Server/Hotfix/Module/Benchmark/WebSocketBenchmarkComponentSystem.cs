...
namespace ETHotfix
{
	...
	public static class WebSocketBenchmarkComponentHelper
	{
		...
		public static async Task TestAsync(this WebSocketBenchmarkComponent self, NetOuterComponent networkComponent, int j, string address)
		{
			try
			{
		...
		public static async Task Send(this WebSocketBenchmarkComponent self, Session session, int j)
		{
			try
			{
				...
				long time2 = CustomFrameWork.TimeHelper.ClientNow();
