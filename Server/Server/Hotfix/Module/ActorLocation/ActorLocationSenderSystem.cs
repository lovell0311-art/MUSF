...
namespace ETHotfix
{
    ...
    public class ActorLocationSenderAwakeSystem : AwakeSystem<ActorLocationSender>
    {
        ...
        public async void StartAsync(ActorLocationSender self)
        {
    ...
    {
		private static async Task<IActorResponse> Run(this ActorLocationSender self, IActorRequest iActorRequest)
		{
	    ...
	    public static async void Send(this ActorLocationSender self, IActorLocationMessage request)
	    {
		    if (request == null)
		    {
		...
		public static async Task<IActorLocationResponse> Call(this ActorLocationSender self, IActorLocationRequest request)
		{
			if (request == null)
			{
