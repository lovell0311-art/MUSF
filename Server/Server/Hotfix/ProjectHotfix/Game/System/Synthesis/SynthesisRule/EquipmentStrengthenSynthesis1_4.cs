...
namespace ETHotfix
{
    ...
    /// 装备强化1
    /// </summary>
    [SynthesisRule(typeof(EquipmentStrengthenSynthesis4_4))]
    public class EquipmentStrengthenSynthesis4_4 : C_SynthesisRule<SynthesisComponent, List<Item>, Synthesis_InfoConfig, G2C_ItemsSynthesis,int>
    {
