...
namespace ETHotfix
{
    ...
    /// 大天使项链合成
    /// </summary>
    [SynthesisRule(typeof(ArchangelSynthesisNecklace))]
    public class ArchangelSynthesisNecklace : C_SynthesisRule<SynthesisComponent, List<Item>, Synthesis_InfoConfig, G2C_ItemsSynthesis, int>
    {
