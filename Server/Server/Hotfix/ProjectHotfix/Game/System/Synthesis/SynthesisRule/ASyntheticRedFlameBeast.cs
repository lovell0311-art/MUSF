...
namespace ETHotfix
{
    ...
    /// 赤焰兽合成
    /// </summary>
    [SynthesisRule(typeof(ChiyanshouSynthesis))]
    public class ChiyanshouSynthesis : C_SynthesisRule<SynthesisComponent, List<Item>, Synthesis_InfoConfig, G2C_ItemsSynthesis,int>
    {
