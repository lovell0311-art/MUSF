...
namespace ETHotfix
{
    ...
    /// 宠物进阶2
    /// </summary>
    [SynthesisRule(typeof(AdvancedPet2))]
    public class AdvancedPet2: C_SynthesisRule<SynthesisComponent, List<Item>, Synthesis_InfoConfig, G2C_ItemsSynthesis, int>
    {
        public override async Task Run(SynthesisComponent synthesis, List<Item> itemList, Synthesis_InfoConfig config, G2C_ItemsSynthesis b_Response, int mClientFinalR)
        {
            ...
            {
                case 350008: curSynItemConfigID = 350015; break;
                case 350009: curSynItemConfigID = 350016; break;
                case 350010: curSynItemConfigID = 350017; break;
                case 350012: curSynItemConfigID = 350019; break;
                case 350013: curSynItemConfigID = 350020; break;
                case 350014: curSynItemConfigID = 350021; break;
                case 350030: curSynItemConfigID = 350031; break;
            }
