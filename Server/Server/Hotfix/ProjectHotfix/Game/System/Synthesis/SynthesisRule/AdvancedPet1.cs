...
namespace ETHotfix
{
    ...
    /// 宠物进阶
    /// </summary>
    [SynthesisRule(typeof(AdvancedPet1))]
    public class AdvancedPet1 : C_SynthesisRule<SynthesisComponent, List<Item>, Synthesis_InfoConfig, G2C_ItemsSynthesis, int>
    {
        public override async Task Run(SynthesisComponent synthesis, List<Item> itemList, Synthesis_InfoConfig config, G2C_ItemsSynthesis b_Response, int mClientFinalR)
        {
            ...
            {
                case 350001: curSynItemConfigID = 350008; break;
                case 350002: curSynItemConfigID = 350009; break;
                case 350003: curSynItemConfigID = 350010; break;
                case 350005: curSynItemConfigID = 350012; break;
                case 350006: curSynItemConfigID = 350013; break;
                case 350007: curSynItemConfigID = 350014; break;
                case 350029: curSynItemConfigID = 350030; break;
            }
