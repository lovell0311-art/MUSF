...
namespace ETHotfix
{
    ...
    /// 四代翅膀合成
    /// </summary>
    [SynthesisRule(typeof(FourthWingSynthesis))]
    public class FourthWingSynthesis : C_SynthesisRule<SynthesisComponent, List<Item>, Synthesis_InfoConfig, G2C_ItemsSynthesis,int>
    {
        /// <summary>
        /// 出现幸运属性概率
        /// </summary>
        ...
        private const int SpecialEntryCountMax = 5;
        ...
        {
            List<int> FourthWing = new List<int>()
            {
                //220002,
                //220003,
                220004,
            ...
            int curSynItemConfigID = FourthWing[RandomHelper.RandomNumber(0, FourthWing.Count)];
            ...
            {
                Log.Warning($"方法: FourthWingSynthesis 前后概率不一致C:{mClientFinalR}S:{curSuccessRate}SMax:{config.MaxSuccessRate}");
            }
            //限制最大成功率
