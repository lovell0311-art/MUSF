...
namespace ETHotfix
{
    ...
    /// 坐骑护卫-龙魂(冰晶)
    /// </summary>
    [SynthesisRule(typeof(FlamingHorseSynthesis))]
    public class FlamingHorseSynthesis : C_SynthesisRule<SynthesisComponent, List<Item>, Synthesis_InfoConfig, G2C_ItemsSynthesis,int>
    {
