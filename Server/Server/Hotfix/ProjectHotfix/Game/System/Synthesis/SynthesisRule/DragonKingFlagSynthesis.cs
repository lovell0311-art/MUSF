...
namespace ETHotfix
{
    ...
    /// 龙王旗帜合成
    /// </summary>
    [SynthesisRule(typeof(LongwangqizhiSynthesis))]
    public class LongwangqizhiSynthesis : C_SynthesisRule<SynthesisComponent, List<Item>, Synthesis_InfoConfig, G2C_ItemsSynthesis,int>
    {
