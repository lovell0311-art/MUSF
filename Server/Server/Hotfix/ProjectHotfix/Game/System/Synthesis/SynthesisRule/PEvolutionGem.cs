...
namespace ETHotfix
{
    ...
    /// 龙王旗帜合成
    /// </summary>
    [SynthesisRule(typeof(PEvolutionGem))]
    public class PEvolutionGem : C_SynthesisRule<SynthesisComponent, List<Item>, Synthesis_InfoConfig, G2C_ItemsSynthesis,int>
    {
    ...
    public static class JingHuaBaoShi
    { 
        public static async Task Run(SynthesisComponent synthesis, List<Item> itemList, Synthesis_InfoConfig config, G2C_ItemsSynthesis b_Response, int mClientFinalR) 
        {
            int curSuccessRate = config.BaseSuccessRate;
            int curSynItemConfigID = 280012;
