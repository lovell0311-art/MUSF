...
namespace ETHotfix
{
    ...
    /// 装备强化1
    /// </summary>
    [SynthesisRule(typeof(EquipmentStrengthenSynthesis1_1))]
    public class EquipmentStrengthenSynthesis1_1 : C_SynthesisRule<SynthesisComponent, List<Item>, Synthesis_InfoConfig, G2C_ItemsSynthesis,int>
    {
