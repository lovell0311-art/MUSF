...
namespace ETHotfix
{
    ...
    /// 配置技能
    /// </summary>
    [GameTaskActionMethod(EGameTaskActionType.SetSkill)]
    public class GameTaskAction_SetSkill : IGameTaskActionHandler
    {
        /// <summary>
        /// 初始化任务进度
        /// </summary>
    ...
    [EventMethod("ClientMsgC2G_UpdateTaskProgress")]
    public class DiscardItem_ClientMsgC2G_UpdateTaskProgress : ITEventMethodOnRun<ETModel.EventType.ClientMsgC2G_UpdateTaskProgress>
    {
        public void OnRun(ETModel.EventType.ClientMsgC2G_UpdateTaskProgress args)
        {
            ...
            gameTasksCom.GetTasksInProgressByActionType(ref list, EGameTaskActionType.SetSkill);

            foreach (var gameTask in gameTaskList)
            {
                gameTasksCom.TriggerTaskAction(gameTask.ConfigId, 0, args.request.Value);
            }
        }
    }
