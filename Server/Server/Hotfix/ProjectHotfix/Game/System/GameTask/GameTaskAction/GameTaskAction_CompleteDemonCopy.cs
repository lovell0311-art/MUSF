...
namespace ETHotfix
{
    ...
    /// 属性加点
    /// </summary>
    [GameTaskActionMethod(EGameTaskActionType.CompleteDemonCopy)]
    public class GameTaskAction_CompleteDemonCopy : IGameTaskActionHandler
    {
        /// <summary>
        /// 初始化任务进度
        /// </summary>
    ...
    [EventMethod("GamePlayerCompleteDemonCopy")]
    public class CompleteRedCopy_GamePlayerCompleteDemonCopy : ITEventMethodOnRun<ETModel.EventType.PlayerCompleteDemonCopy>
    {
        public void OnRun(ETModel.EventType.PlayerCompleteDemonCopy args)
        {
