...
namespace ETHotfix
{
    ...
    /// 属性加点
    /// </summary>
    [GameTaskActionMethod(EGameTaskActionType.BreakThroughTheGate)]
    public class GameTaskAction_BreakThroughTheGate : IGameTaskActionHandler
    {
        /// <summary>
        /// 初始化任务进度
        /// </summary>
    ...
    [EventMethod("GamePlayerBreakThroughTheGate")]
    public class BreakThroughTheGate_GamePlayerBreakThroughTheGate : ITEventMethodOnRun<ETModel.EventType.BreakThroughTheGate>
    {
        public void OnRun(ETModel.EventType.BreakThroughTheGate args)
        {
            ...
            gameTasksCom.GetTasksInProgressByActionType(ref list, EGameTaskActionType.BreakThroughTheGate);
