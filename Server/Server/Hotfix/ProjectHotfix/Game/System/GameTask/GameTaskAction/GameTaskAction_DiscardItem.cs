...
namespace ETHotfix
{
    ...
    /// 丢弃物品
    /// </summary>
    [GameTaskActionMethod(EGameTaskActionType.DiscardItem)]
    public class GameTaskAction_DiscardItem : IGameTaskActionHandler
    {
        /// <summary>
        /// 初始化任务进度
        /// </summary>
    ...
    public class DiscardItem_DiscardItemFromBackpack : ITEventMethodOnRun<ETModel.EventType.DiscardItemFromBackpack>
    {
        public void OnRun(ETModel.EventType.DiscardItemFromBackpack args)
        {
            ...
            gameTasksCom.GetTasksInProgressByActionType(ref list, EGameTaskActionType.DiscardItem);
