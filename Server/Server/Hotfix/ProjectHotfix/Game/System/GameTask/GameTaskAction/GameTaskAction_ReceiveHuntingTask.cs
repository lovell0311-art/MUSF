...
namespace ETHotfix
{
    ...
    /// 领取狩猎任务
    /// </summary>
    [GameTaskActionMethod(EGameTaskActionType.ReceiveHuntingTask)]
    public class GameTaskAction_ReceiveHuntingTask : IGameTaskActionHandler
    {
        /// <summary>
        /// 初始化任务进度
        /// </summary>
    ...
    [EventMethod("ReceiveHuntingTask")]
    public class ReceiveHuntingTask_ReceiveHuntingTask : ITEventMethodOnRun<ETModel.EventType.ReceiveHuntingTask>
    {
        public void OnRun(ETModel.EventType.ReceiveHuntingTask args)
        {
            ...
            gameTasksCom.GetTasksInProgressByActionType(ref list, EGameTaskActionType.ReceiveHuntingTask);
