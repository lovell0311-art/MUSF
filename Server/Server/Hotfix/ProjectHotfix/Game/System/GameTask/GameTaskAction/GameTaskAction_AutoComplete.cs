...
namespace ETHotfix
{
    ...
    /// 自动完成任务
    /// </summary>
    [GameTaskActionMethod(EGameTaskActionType.AutoComplete)]
    public class GameTaskAction_AutoComplete : IGameTaskActionHandler
    {
        /// <summary>
        /// 初始化任务进度
        /// </summary>
    ...
    public class AutoComplete_PlayerReadyComplete : ITEventMethodOnRun<ETModel.EventType.PlayerReadyComplete>
    {
        public void OnRun(ETModel.EventType.PlayerReadyComplete args)
        {
            ...
            gameTasksCom.GetTasksInProgressByActionType(ref list, EGameTaskActionType.AutoComplete);
