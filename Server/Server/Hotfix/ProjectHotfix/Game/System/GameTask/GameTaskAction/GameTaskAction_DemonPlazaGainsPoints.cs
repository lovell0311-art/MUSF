...
namespace ETHotfix
{
    ...
    /// 属性加点
    /// </summary>
    [GameTaskActionMethod(EGameTaskActionType.DemonPlazaGainsPoints)]
    public class GameTaskAction_DemonPlazaGainsPoints : IGameTaskActionHandler
    {
        /// <summary>
        /// 初始化任务进度
        /// </summary>
    ...
    [EventMethod("GamePlayerDemonPlazaGainsPoints")]
    public class BreakThroughTheGate_GamePlayerDemonPlazaGainsPoints : ITEventMethodOnRun<ETModel.EventType.DemonPlazaGainsPoints>
    {
        public void OnRun(ETModel.EventType.DemonPlazaGainsPoints args)
        {
            ...
            gameTasksCom.GetTasksInProgressByActionType(ref list, EGameTaskActionType.DemonPlazaGainsPoints);

            foreach (var gameTask in gameTaskList)
            {
                gameTasksCom.TriggerTaskAction(gameTask.ConfigId, 0, args.transferPoint);
            }
        }
    }
