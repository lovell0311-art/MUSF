...
namespace ETHotfix
{
    ...
    /// 属性加点
    /// </summary>
    [GameTaskActionMethod(EGameTaskActionType.ConfigureAttributePoint)]
    public class GameTaskAction_ConfigureAttributePoint : IGameTaskActionHandler
    {
        /// <summary>
        /// 初始化任务进度
        /// </summary>
    ...
    [EventMethod("GamePlayerConfigureAttributePoint")]
    public class ConfigureAttributePoint_GamePlayerConfigureAttributePoint : ITEventMethodOnRun<ETModel.EventType.GamePlayerConfigureAttributePoint>
    {
        public void OnRun(ETModel.EventType.GamePlayerConfigureAttributePoint args)
        {
            ...
            gameTasksCom.GetTasksInProgressByActionType(ref list, EGameTaskActionType.ConfigureAttributePoint);
