...
namespace ETHotfix
{
    [GameTaskActionMethod(EGameTaskActionType.TeamKillMonster)]
    public class GameTaskAction_TeamKillMonster : IGameTaskActionHandler
    {
        /// <summary>
        /// 初始化任务进度
        /// </summary>
    ...
    public class EnemyDeath_TeamKillMonster : ITEventMethodOnRun<ETModel.EventType.EnemyDeath>
    {
        public void OnRun(ETModel.EventType.EnemyDeath args)
        {
            ...
            gameTasksCom.GetTasksInProgressByActionType(ref list,EGameTaskActionType.TeamKillMonster);
