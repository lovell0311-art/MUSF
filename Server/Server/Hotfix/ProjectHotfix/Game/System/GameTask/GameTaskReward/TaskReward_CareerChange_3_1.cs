...
namespace ETHotfix
{
    ...
    public class TaskReward_CareerChange_3_1 : IGameTaskRewardHandler
    {
        /// <summary>
        /// 可以给奖励
        /// </summary>
        ...
        public void StartGivingRewards(GameTask gameTask, Player ownPlayer)
        {
            ...
            Log.PLog($"a:{ownPlayer.UserId} r:{ownPlayer.GameUserId} 完成三转 第一阶段 Level:{gamePlayer.Data.Level} FreePoint:{oldFreePoint} => {gamePlayer.Data.FreePoint}");
        }
    }
}
