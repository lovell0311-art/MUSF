...
namespace ETHotfix
{
    ...
    /// 召唤术师角色卡
    /// </summary>
    [ItemUseRule(typeof(Use310077))]
    public class Use310077 : C_ItemUseRule<Player, Item, IResponse>
    {
        public override async Task Run(Player b_Player, Item b_Item, IResponse b_Response)
        {
            ...
            mCurrentTemp.Player.Data.RoleDic[(int)E_GameOccupation.SummonWarlock] = 1;
