...
namespace ETHotfix
{
    ...
    /// 樱花花瓣
    /// </summary>
    [ItemUseRule(typeof(Use310063))]
    public class Use310063 : C_ItemUseRule<Player, Item, IResponse>
    {
        public override async Task Run(Player b_Player, Item b_Item, IResponse b_Response)
        {
            ...
            mCurrentTemp.AddHealthState(E_BattleSkillStats.UseYingHuaHuaBan310063, b_Item.ConfigData.Value, b_Item.ConfigData.Value2, 0, mCreateFunc, mBattleComponent);
            mCurrentTemp.UpdateHealthState();

            mCurrentTemp.Data.DBBufflist[(int)E_BattleSkillStats.UseYingHuaHuaBan310063] = mBattleComponent.CurrentTimeTick + b_Item.ConfigData.Value2;
