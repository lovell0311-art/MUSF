...
namespace ETHotfix
{
    [ItemUseRule(typeof(Use310135))]
    public class Use310135 : C_ItemUseRule<Player, Item, IResponse>
    {
        public override async Task Run(Player b_Player, Item b_Item, IResponse b_Response)
        {
            ...
            mCurrentTemp.AddHealthState(E_BattleSkillStats.Use310135, b_Item.ConfigData.Value*100, b_Item.ConfigData.Value2, 0, mCreateFunc, mBattleComponent);
            mCurrentTemp.UpdateHealthState();

            mCurrentTemp.Data.DBBufflist[(int)E_BattleSkillStats.Use310135] = mBattleComponent.CurrentTimeTick + b_Item.ConfigData.Value2;
