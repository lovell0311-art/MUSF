...
namespace ETHotfix
{
    ...
    /// 梦幻骑士角色卡
    /// </summary>
    [ItemUseRule(typeof(Use310080))]
    public class Use310080 : C_ItemUseRule<Player, Item, IResponse>
    {
        public override async Task Run(Player b_Player, Item b_Item, IResponse b_Response)
        {
            ...
            mCurrentTemp.Player.Data.RoleDic[(int)E_GameOccupation.GrowLancer] = 1;
