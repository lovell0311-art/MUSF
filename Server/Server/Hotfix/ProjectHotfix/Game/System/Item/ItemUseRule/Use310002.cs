...
namespace ETHotfix
{
    ...
    /// 使用血瓶
    /// </summary>
    [ItemUseRule(typeof(Use310002))]
    public class Use310002 : C_ItemUseRule<Player, Item, IResponse>
    {
        public override async Task Run(Player b_Player, Item b_Item, IResponse b_Response)
        {
            ...
            int addPer = b_Item.ConfigData.Value2;
            ...
            mGamePlayer.UnitData.Hp += addPer;
