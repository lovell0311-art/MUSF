...
namespace ETHotfix
{
    ...
    /// 纳戒
    /// </summary>
    [ItemUseRule(typeof(Use310086))]
    public class Use310086 : C_ItemUseRule<Player, Item, IResponse>
    {
        ...
        public override async Task Run(Player b_Player, Item b_Item, IResponse b_Response)
        {
            ...
            (int, int) Id = (13008, 30);
            Enemy monster = CreateMonster(map, enemyJsonDic[MobId], PosX, PosY, b_Player.GameUserId,13, Id, b_Item.ItemUID);
            G2C_CangBaoTuPosUpdate_notice notice2 = new G2C_CangBaoTuPosUpdate_notice()
            {
                ...
                PosY = PosY,
                NpcConfigID = MobId,
                TreasureType = ETreasureType.NaJie,
                Id = b_Item.ItemUID,
            };
