...
namespace ETHotfix
{
    ...
    /// 经验印章
    /// </summary>
    [ItemUseRule(typeof(Use310070))]
    public class Use310070 : C_ItemUseRule<Player, Item, IResponse>
    {
        public override async Task Run(Player b_Player, Item b_Item, IResponse b_Response)
        {
            ...
            mCurrentTemp.AddHealthState(E_BattleSkillStats.Use310070, 100, b_Item.ConfigData.Value2, 0, mCreateFunc, mBattleComponent);
            mCurrentTemp.UpdateHealthState();

            mCurrentTemp.Data.DBBufflist[(int)E_BattleSkillStats.Use310070] = mBattleComponent.CurrentTimeTick + b_Item.ConfigData.Value2;
