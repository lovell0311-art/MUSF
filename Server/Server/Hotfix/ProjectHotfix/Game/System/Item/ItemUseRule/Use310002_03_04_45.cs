...
namespace ETHotfix
{
    ...
    /// 使用血瓶
    /// </summary>
    [ItemUseRule(typeof(Use310002_03_04_45))]
    public class Use310002_03_04_45 : C_ItemUseRule<Player, Item, IResponse>
    {
        public override async Task Run(Player b_Player, Item b_Item, IResponse b_Response)
        {
            ...
            int addValue = (int)MathF.Ceiling(maxHP * addPer * 0.01f);
            var mCount = b_Item.ConfigData.Value2 * 10 - mGamePlayer.Data.Level * 2;
            if (mCount > 0)
            {
                addValue += mCount;
            }

            mGamePlayer.UnitData.Hp += addValue;
