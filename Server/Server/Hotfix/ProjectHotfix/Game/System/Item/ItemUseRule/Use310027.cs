...
namespace ETHotfix
{
    ...
    /// 智力圣水
    /// </summary>
    [ItemUseRule(typeof(Use310027))]
    public class Use310027 : C_ItemUseRule<Player, Item, IResponse>
    {
        public override async Task Run(Player b_Player, Item b_Item, IResponse b_Response)
        {
            ...
            mCurrentTemp.AddHealthState(E_BattleSkillStats.Use310027, b_Item.ConfigData.Value, b_Item.ConfigData.Value2, 0, mCreateFunc, mBattleComponent);
            mCurrentTemp.UpdateHealthState();

            mCurrentTemp.Data.DBBufflist[(int)E_BattleSkillStats.Use310027] = mBattleComponent.CurrentTimeTick + b_Item.ConfigData.Value2;
