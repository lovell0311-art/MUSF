...
namespace ETHotfix
{
    ...
    /// 统率圣水
    /// </summary>
    [ItemUseRule(typeof(Use310028))]
    public class Use310028 : C_ItemUseRule<Player, Item, IResponse>
    {
                ...
                case E_GameOccupation.Holyteacher:
                    {
                        ...
                        mCurrentTemp.AddHealthState(E_BattleSkillStats.Use310028, b_Item.ConfigData.Value, b_Item.ConfigData.Value2, 0, mCreateFunc, mBattleComponent);
                        mCurrentTemp.UpdateHealthState();

                        mCurrentTemp.Data.DBBufflist[(int)E_BattleSkillStats.Use310028] = mBattleComponent.CurrentTimeTick + b_Item.ConfigData.Value2;
