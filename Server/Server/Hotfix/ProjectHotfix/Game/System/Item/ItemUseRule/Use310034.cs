...
namespace ETHotfix
{
    ...
    /// 恢复卷轴
    /// </summary>
    [ItemUseRule(typeof(Use310034))]
    public class Use310034 : C_ItemUseRule<Player, Item, IResponse>
    {
        public override async Task Run(Player b_Player, Item b_Item, IResponse b_Response)
        {
            ...
            mCurrentTemp.AddHealthState(E_BattleSkillStats.Use310034, b_Item.ConfigData.Value, b_Item.ConfigData.Value2, 0, mCreateFunc, mBattleComponent);
            mCurrentTemp.UpdateHealthState();

            mCurrentTemp.Data.DBBufflist[(int)E_BattleSkillStats.Use310034] = mBattleComponent.CurrentTimeTick + b_Item.ConfigData.Value2;
            ...
            if (mCurrentTemp.HealthStatsDic.TryGetValue(E_BattleSkillStats.Use310034, out var mTempBuffer))
            {
