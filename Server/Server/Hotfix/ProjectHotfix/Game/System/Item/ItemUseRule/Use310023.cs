...
namespace ETHotfix
{
    ...
    /// 魔法卷轴
    /// </summary>
    [ItemUseRule(typeof(Use310023))]
    public class Use310023 : C_ItemUseRule<Player, Item, IResponse>
    {
        public override async Task Run(Player b_Player, Item b_Item, IResponse b_Response)
        {
            ...
            Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
            {
                ...
                mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                {
                    ...
                    if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.Use310023, out var hp_Curse))
                    {
            ...
            mCurrentTemp.AddHealthState(E_BattleSkillStats.Use310023, b_Item.ConfigData.Value, b_Item.ConfigData.Value2, 0, mCreateFunc, mBattleComponent);
            mCurrentTemp.UpdateHealthState();

            mCurrentTemp.Data.DBBufflist[(int)E_BattleSkillStats.Use310023] = mBattleComponent.CurrentTimeTick + b_Item.ConfigData.Value2;
            ...
            mCurrentTemp.UnitData.Mp += b_Item.ConfigData.Value;
