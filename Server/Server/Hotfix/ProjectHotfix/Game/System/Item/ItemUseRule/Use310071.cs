...
namespace ETHotfix
{
    ...
    /// 魔剑士角色卡片
    /// </summary>
    [ItemUseRule(typeof(Use310071))]
    public class Use310071 : C_ItemUseRule<Player, Item, IResponse>
    {
        public override async Task Run(Player b_Player, Item b_Item, IResponse b_Response)
        {
            ...
            mCurrentTemp.Player.Data.RoleDic[(int)E_GameOccupation.Spellsword] = 1;
