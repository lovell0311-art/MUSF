...
namespace ETHotfix
{
    ...
    /// 魔力减少 技能蓝耗减少
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute951)]
    public partial class C_BattleMaster_MasterAttribute951 : C_BattleMaster
    {
    ...
    /// 魔力减少 技能蓝耗减少
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute951
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute951] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
