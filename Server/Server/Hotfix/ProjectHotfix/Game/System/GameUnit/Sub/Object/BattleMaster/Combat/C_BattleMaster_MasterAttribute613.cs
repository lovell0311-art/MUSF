...
namespace ETHotfix
{
    ...
    /// 整套防御力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute613)]
    public partial class C_BattleMaster_MasterAttribute613 : C_BattleMaster
    {
    ...
    /// 整套防御力增加
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute613
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute613] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
