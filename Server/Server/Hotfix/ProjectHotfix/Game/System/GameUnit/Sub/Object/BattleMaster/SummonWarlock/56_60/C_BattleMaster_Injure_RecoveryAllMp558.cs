...
namespace ETHotfix
{
    ...
    /// 受伤魔力回复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Injure_RecoveryAllMp558)]
    public partial class C_BattleMaster_Injure_RecoveryAllMp558 : C_BattleMaster
    {
    ...
    /// 受伤魔力回复
    /// </summary>
    public partial class C_BattleMaster_Injure_RecoveryAllMp558
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 受到伤害时，{0:F}%的几率魔法值完全恢复。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Injure_RecoveryAllMp558] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
