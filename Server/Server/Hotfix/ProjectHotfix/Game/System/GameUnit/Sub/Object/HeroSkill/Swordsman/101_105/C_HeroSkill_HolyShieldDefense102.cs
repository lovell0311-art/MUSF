...
namespace ETHotfix
{
    ...
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.Holy_Shield_Defense)]
    public partial class C_HeroSkill_HolyShieldDefense102 : C_HeroSkillSource
    {
        ...
        {  //数据变化 更新变更数据 
            ...
            //BaseHurtValue = mConfig.OtherDataDic[3];
    ...
    /// 圣盾防御 Holy Shield defense
    /// </summary>
    public partial class C_HeroSkill_HolyShieldDefense102
    {
        ...
        public override bool TryUse(CombatSource b_Attacker, CombatSource b_BeAttacker, C_FindTheWay2D b_Cell, BattleComponent b_BattleComponent, IActorResponse b_Response)
        {
            ...
            {
                b_Response.Error = Root.MainFactory.GetCustomComponent<LanguageComponent>().GetMessageId(431);
                //b_Response.Message = Root.MainFactory.GetCustomComponent<LanguageComponent>().GetMessage("技能使用者不是玩家!");
                return false;
            }
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
                {
                    ...
                    mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                    {
                        ...
                        b_CombatSource.RemoveHealthState(E_BattleSkillStats.HolyShieldDefense102, b_BattleComponent);
                    ...
                    mBattleSyncTimer.SyncAction = (b_CombatSource, b_BattleComponent, b_TimerTask, b_TimeTick) =>
                    {
                        ...
                        if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.HolyShieldDefense102, out var hp_Curse) == false)
                        {
                ...
                b_Attacker.AddHealthState(E_BattleSkillStats.HolyShieldDefense102, mConfig.OtherDataDic[3], mConfig.PersistentTime, 0, mCreateFunc, b_BattleComponent);
