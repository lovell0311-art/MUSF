...
namespace ETHotfix
{
    ...
    /// 单手剑强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.DanShouJian_Strengthening354)]
    public partial class C_BattleMaster_DanShouJian_Strengthening354 : C_BattleMaster
    {
    ...
    /// 单手剑强化
    /// </summary>
    public partial class C_BattleMaster_DanShouJian_Strengthening354
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.DanShouJian_Strengthening354] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
