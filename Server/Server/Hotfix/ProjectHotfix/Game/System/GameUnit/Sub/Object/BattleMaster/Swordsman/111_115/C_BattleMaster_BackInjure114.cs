...
namespace ETHotfix
{
    ...
    /// 复仇
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BackInjureRate114)]
    public partial class C_BattleMaster_BackInjure114 : C_BattleMaster
    {
    ...
    /// 复仇
    /// </summary>
    public partial class C_BattleMaster_BackInjure114
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BackInjureRate114] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
