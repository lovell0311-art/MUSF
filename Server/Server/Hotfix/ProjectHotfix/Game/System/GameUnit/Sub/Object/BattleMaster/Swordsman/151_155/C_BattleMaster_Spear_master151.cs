...
namespace ETHotfix
{
    ...
    /// 矛类精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Spear_master151)]
    public partial class C_BattleMaster_Spear_master151 : C_BattleMaster
    {
    ...
    /// 矛类精通
    /// </summary>
    public partial class C_BattleMaster_Spear_master151
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Spear_master151] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
