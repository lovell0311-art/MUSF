...
namespace ETHotfix
{
    ...
    /// SD恢复速度提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.RecoverySD406)]
    public partial class C_BattleMaster_RecoverySD406 : C_BattleMaster
    {
    ...
    /// SD恢复速度提高
    /// </summary>
    public partial class C_BattleMaster_RecoverySD406
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.RecoverySD406] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
