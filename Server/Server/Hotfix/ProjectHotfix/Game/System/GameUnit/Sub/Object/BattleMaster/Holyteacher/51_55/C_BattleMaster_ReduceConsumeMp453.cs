...
namespace ETHotfix
{
    ...
    /// 魔力减少 技能蓝耗减少
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ReduceConsumeMp453)]
    public partial class C_BattleMaster_ReduceConsumeMp453 : C_BattleMaster
    {
    ...
    /// 魔力减少 技能蓝耗减少
    /// </summary>
    public partial class C_BattleMaster_ReduceConsumeMp453
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ReduceConsumeMp453] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
