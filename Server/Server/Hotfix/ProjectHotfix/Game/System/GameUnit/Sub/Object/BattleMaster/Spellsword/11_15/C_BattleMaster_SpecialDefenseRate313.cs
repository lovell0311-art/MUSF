...
namespace ETHotfix
{
    ...
    /// 整套防御力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.SpecialDefenseRate313)]
    public partial class C_BattleMaster_SpecialDefenseRate313 : C_BattleMaster
    {
    ...
    /// 整套防御力增加
    /// </summary>
    public partial class C_BattleMaster_SpecialDefenseRate313
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.SpecialDefenseRate313] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
