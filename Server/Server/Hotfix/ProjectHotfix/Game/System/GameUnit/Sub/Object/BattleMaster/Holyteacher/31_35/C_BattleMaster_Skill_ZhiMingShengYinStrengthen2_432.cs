...
namespace ETHotfix
{
    ...
    /// 致命圣印强化(2)
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ZhiMingShengYinStrengthen2_432)]
    public partial class C_BattleMaster_Skill_ZhiMingShengYinStrengthen2_432 : C_BattleMaster
    {
    ...
    /// 致命圣印强化(2)
    /// </summary>
    public partial class C_BattleMaster_Skill_ZhiMingShengYinStrengthen2_432
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ZhiMingShengYinStrengthen2_432] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
