...
namespace ETHotfix
{
    ...
    /// 锤类精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Hammers_master150)]
    public partial class C_BattleMaster_Hammers_master150 : C_BattleMaster
    {
    ...
    /// 锤类精通
    /// </summary>
    public partial class C_BattleMaster_Hammers_master150
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Hammers_master150] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
