...
namespace ETHotfix
{
    ...
    /// 攻击力提高强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_AttackIncreaseStrengthen232)]
    public partial class C_BattleMaster_Skill_AttackIncreaseStrengthen232 : C_BattleMaster
    {
    ...
    /// 攻击力提高强化
    /// </summary>
    public partial class C_BattleMaster_Skill_AttackIncreaseStrengthen232
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_AttackIncreaseStrengthen232] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
