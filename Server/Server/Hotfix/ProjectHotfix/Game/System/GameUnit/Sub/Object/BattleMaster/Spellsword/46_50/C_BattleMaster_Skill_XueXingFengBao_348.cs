...
namespace ETHotfix
{
    ...
    /// 血腥风暴
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_XueXingFengBao_348)]
    public partial class C_BattleMaster_Skill_XueXingFengBao_348 : C_BattleMaster
    {
    ...
    /// 血腥风暴
    /// </summary>
    public partial class C_BattleMaster_Skill_XueXingFengBao_348
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 学习血腥风暴技能。3码内的目标为中心给周围的目标造成伤害。5秒后可重新使用。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XueXingFengBao_348] = 1;
