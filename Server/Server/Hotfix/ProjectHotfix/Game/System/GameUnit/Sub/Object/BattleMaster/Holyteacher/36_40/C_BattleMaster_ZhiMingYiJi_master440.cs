...
namespace ETHotfix
{
    ...
    /// 致命一击精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ZhiMingYiJi_master440)]
    public partial class C_BattleMaster_ZhiMingYiJi_master440 : C_BattleMaster
    {
    ...
    /// 致命一击精通
    /// </summary>
    public partial class C_BattleMaster_ZhiMingYiJi_master440
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 致命圣印技能使用时卓越一击几率追加提高{0:F}%。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ZhiMingYiJi_master440] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
