...
namespace ETHotfix
{
    ...
    /// 反伤几率
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BackInjureRate415)]
    public partial class C_BattleMaster_BackInjureRate415 : C_BattleMaster
    {
    ...
    /// 反伤几率
    /// </summary>
    public partial class C_BattleMaster_BackInjureRate415
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BackInjureRate415] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
