...
namespace ETHotfix
{
    ...
    /// 烈焰焚城
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_Pets_SKILL_Id.BurningCity)]
    public partial class C_PetsSkill_BurningCity101002 : C_HeroSkillSource
    {
    ...
    /// 烈焰焚城
    /// </summary>
    public partial class C_PetsSkill_BurningCity101002
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                {
                    var mTeamComponent = pets.GamePlayer.Player.GetCustomComponent<TeamComponent>();
                    if (mTeamComponent != null)
                    {
                        ...
                        mIsHasTeam = mDic != null && mDic.ContainsKey(pets.GamePlayer.InstanceId);
                    }
                }
                var mAttackerFanJiIdlist = pets.GamePlayer.GetFanJiIdlist();
