...
namespace ETHotfix
{
    ...
    /// 雷霆裂闪
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_LeiTingLieShan126)]
    public partial class C_BattleMaster_Skill_LeiTingLieShan126 : C_BattleMaster
    {
    ...
    /// 雷霆裂闪
    /// </summary>
    public partial class C_BattleMaster_Skill_LeiTingLieShan126
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 致命一击伤害增加{0:F}。 雷霆裂闪触发致命一击

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_LeiTingLieShan126] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
