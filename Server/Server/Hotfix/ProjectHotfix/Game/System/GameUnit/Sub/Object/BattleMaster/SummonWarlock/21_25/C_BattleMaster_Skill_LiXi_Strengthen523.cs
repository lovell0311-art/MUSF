...
namespace ETHotfix
{
    ...
    /// 裂袭强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_LiXi_Strengthen523)]
    public partial class C_BattleMaster_Skill_LiXi_Strengthen523 : C_BattleMaster
    {
    ...
    /// 裂袭强化
    /// </summary>
    public partial class C_BattleMaster_Skill_LiXi_Strengthen523
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_LiXi_Strengthen523] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
