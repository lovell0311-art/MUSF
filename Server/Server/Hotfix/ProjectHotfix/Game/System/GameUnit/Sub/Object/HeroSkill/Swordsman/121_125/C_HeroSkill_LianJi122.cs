...
namespace ETHotfix
{
    ...
    /// 连击
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.LianJi122)]
    public partial class C_HeroSkill_LianJi122 : C_HeroSkillSource
    {
    ...
    /// 连击
    /// </summary>
    public partial class C_HeroSkill_LianJi122
    {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Action<long, long, long> mSyncActionChild = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
                {
                    ...
                    int GetHurtValue(E_GameProperty b_SpecialAttack)
                    {
                        ...
                        if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.ComboStrengthening135))
                        {
                            int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.ComboStrengthening135];
                            mHurtValue = (int)(mHurtValue * (10000 + mMasteryValue) * 0.0001f);
                        }
