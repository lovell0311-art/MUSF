...
namespace ETHotfix
{
    ...
    /// sd 完全回复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Attack_RecoveryAllSD468)]
    public partial class C_BattleMaster_Attack_RecoveryAllSD468 : C_BattleMaster
    {
    ...
    /// sd 完全回复
    /// </summary>
    public partial class C_BattleMaster_Attack_RecoveryAllSD468
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Attack_RecoveryAllSD468] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
