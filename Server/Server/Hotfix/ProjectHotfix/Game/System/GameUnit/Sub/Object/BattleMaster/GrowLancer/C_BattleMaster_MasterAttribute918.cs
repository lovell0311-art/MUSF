...
namespace ETHotfix
{
    ...
    /// 力量属性增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute918)]
    public partial class C_BattleMaster_MasterAttribute918 : C_BattleMaster
    {
    ...
    /// 力量属性增加
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute918
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute918] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
