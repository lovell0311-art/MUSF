...
namespace ETHotfix
{
    ...
    /// 杀怪时魔力恢复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.KillRecoveryMp158)]
    public partial class C_BattleMaster_KillRecoveryMp158 : C_BattleMaster
    {
    ...
    /// 杀怪时魔力恢复
    /// </summary>
    public partial class C_BattleMaster_KillRecoveryMp158
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.KillRecoveryMp158] = (int)(1f / mConfig.OtherDataDic[mMasterLevel] * 10000 * 10000);
