...
namespace ETHotfix
{
    ...
    /// 天鹰强化(5)
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.TianYing_AttackStrengthen4_461)]
    public partial class C_BattleMaster_TianYing_AttackStrengthen4_461 : C_BattleMaster
    {
    ...
    /// 天鹰强化(5)
    /// </summary>
    public partial class C_BattleMaster_TianYing_AttackStrengthen4_461
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.TianYing_AttackStrengthen4_461] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
