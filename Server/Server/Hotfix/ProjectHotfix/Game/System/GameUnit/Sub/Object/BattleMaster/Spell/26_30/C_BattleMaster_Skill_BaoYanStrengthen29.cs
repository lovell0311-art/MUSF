...
namespace ETHotfix
{
    ...
    /// 爆炎强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_BaoYanStrengthen29)]
    public partial class C_BattleMaster_Skill_BaoYanStrengthen29 : C_BattleMaster
    {
    ...
    /// 爆炎强化
    /// </summary>
    public partial class C_BattleMaster_Skill_BaoYanStrengthen29
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_BaoYanStrengthen29] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
