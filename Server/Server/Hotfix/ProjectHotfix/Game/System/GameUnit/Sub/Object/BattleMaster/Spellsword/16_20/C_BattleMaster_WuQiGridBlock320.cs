...
namespace ETHotfix
{
    ...
    /// 武器格挡
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.WuQiGridBlock320)]
    public partial class C_BattleMaster_WuQiGridBlock320 : C_BattleMaster
    {
    ...
    /// 武器格挡
    /// </summary>
    public partial class C_BattleMaster_WuQiGridBlock320
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 装备剑, 斧, 枪类的武器时，以{0:F}%的概率防御物理攻击。无法抵挡魔法攻击，发动技能时以Parry（防武器）显示。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.WuQiGridBlock320] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
