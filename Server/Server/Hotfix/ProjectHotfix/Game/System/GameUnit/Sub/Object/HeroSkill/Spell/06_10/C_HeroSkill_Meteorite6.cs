...
namespace ETHotfix
{
    ...
    /// 陨石 Meteorite
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.METEORITE)]
    public partial class C_HeroSkill_Meteorite : C_HeroSkillSource
    {
    ...
    /// 陨石 Meteorite
    /// </summary>
    public partial class C_HeroSkill_Meteorite
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_YunShiStrengthen38))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_YunShiStrengthen38];
