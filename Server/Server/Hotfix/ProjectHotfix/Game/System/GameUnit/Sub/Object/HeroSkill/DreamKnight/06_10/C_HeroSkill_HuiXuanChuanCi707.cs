...
namespace ETHotfix
{
    ...
    /// 回旋穿刺
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.HuiXuanChuanCi707)]
    public partial class C_HeroSkill_HuiXuanChuanCi707 : C_HeroSkillSource
    {
    ...
    /// 回旋穿刺
    /// </summary>
    public partial class C_HeroSkill_HuiXuanChuanCi707
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute927))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute927];
                ...
                if (b_Attacker.BattleMasteryDic.TryGetValue(E_BattleMasteryState.MasterAttribute930,out var Info))
                {
                   if(Info == 1)
