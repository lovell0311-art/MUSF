...
namespace ETHotfix
{
    ...
    /// 黑龙波强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_HeiLongBoStrengthen31)]
    public partial class C_BattleMaster_Skill_HeiLongBoStrengthen31 : C_BattleMaster
    {
    ...
    /// 黑龙波强化
    /// </summary>
    public partial class C_BattleMaster_Skill_HeiLongBoStrengthen31
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HeiLongBoStrengthen31] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
