...
namespace ETHotfix
{
    ...
    /// 最大AG增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute936)]
    public partial class C_BattleMaster_MasterAttribute936 : C_BattleMaster
    {
    ...
    /// 最大AG增加
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute936
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute936] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);

            if (b_AddPoint)
            {
                var mGameProperty = E_GameProperty.PROP_AG_MAX;
