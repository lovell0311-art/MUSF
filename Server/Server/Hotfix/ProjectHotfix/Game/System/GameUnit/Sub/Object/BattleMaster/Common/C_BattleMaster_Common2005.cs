...
namespace ETHotfix
{
    ...
    /// 攻击速度增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Common2005)]
    public partial class C_BattleMaster_Common2005 : C_BattleMaster
    {
    ...
    /// 攻击速度增加
    /// </summary>
    public partial class C_BattleMaster_Common2005
    {
        #region try
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Common2005] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
