...
namespace ETHotfix
{
    ...
    /// 攻击成功率增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Common2006)]
    public partial class C_BattleMaster_Common2006 : C_BattleMaster
    {
    ...
    /// 攻击成功率增加
    /// </summary>
    public partial class C_BattleMaster_Common2006
    {
        #region try
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Common2006] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
