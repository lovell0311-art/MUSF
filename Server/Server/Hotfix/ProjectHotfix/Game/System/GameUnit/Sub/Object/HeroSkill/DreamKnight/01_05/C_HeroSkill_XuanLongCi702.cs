...
namespace ETHotfix
{
    ...
    /// 旋龙刺
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.XuanLongCi702)]
    public partial class C_HeroSkill_XuanLongCi702 : C_HeroSkillSource
    {
    ...
    /// 旋龙刺
    /// </summary>
    public partial class C_HeroSkill_XuanLongCi702
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int mMaxAtteck = (int)(mConfig.OtherDataDic[1] * 1.5f) + b_Attacker.GetNumerialFunc(E_GameProperty.MaxAtteck) + b_Attacker.GetNumerialFunc(E_GameProperty.DreamRiderIrritate) + b_Attacker.GetNumerialFunc(E_GameProperty.DreamRiderPenalize);
                ...
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute926))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute926];
                    mMaxAtteck += mMasteryValue;
                    mMinAtteck += mMasteryValue;
                }
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute929))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute929];
                    mMaxAtteck += mMasteryValue;
                    mMinAtteck += mMasteryValue;
                }
