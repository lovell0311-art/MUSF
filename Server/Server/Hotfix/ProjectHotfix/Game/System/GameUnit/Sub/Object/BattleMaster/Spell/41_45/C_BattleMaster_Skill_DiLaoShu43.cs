...
namespace ETHotfix
{
    ...
    /// 地牢术
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_DiLaoShu43)]
    public partial class C_BattleMaster_Skill_DiLaoShu43 : C_BattleMaster
    {
    ...
    /// 地牢术
    /// </summary>
    public partial class C_BattleMaster_Skill_DiLaoShu43
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 给周围毒人造成高伤害，一定几率使目标无法转动，持续5秒。5秒冷却时间。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DiLaoShu43] = 1;

            var mStudySkillId = (int)E_HeroSkillId.DiLaoShu28;
            var mReadConfigComponent = Root.MainFactory.GetCustomComponent<CustomFrameWork.Component.ReadConfigComponent>();
