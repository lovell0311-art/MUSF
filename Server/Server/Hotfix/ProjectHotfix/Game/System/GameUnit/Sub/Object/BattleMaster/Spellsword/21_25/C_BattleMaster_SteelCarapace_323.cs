...
namespace ETHotfix
{
    ...
    /// 钢铁铠甲
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.SteelCarapace_323)]
    public partial class C_BattleMaster_SteelCarapace_323 : C_BattleMaster
    {
    ...
    /// 钢铁铠甲
    /// </summary>
    public partial class C_BattleMaster_SteelCarapace_323
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.SteelCarapace_323] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
