...
namespace ETHotfix
{
    ...
    /// 单手剑强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.DanShouJian_Strengthening145)]
    public partial class C_BattleMaster_DanShouJian_Strengthening145 : C_BattleMaster
    {
    ...
    /// 单手剑强化
    /// </summary>
    public partial class C_BattleMaster_DanShouJian_Strengthening145
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 单手剑装备时攻击力提高{0:F}。（单手剑2个装备时50%应用）

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.DanShouJian_Strengthening145] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
