...
namespace ETHotfix
{
    ...
    /// 盾牌精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Shield_Master450)]
    public partial class C_BattleMaster_Shield_Master450 : C_BattleMaster
    {
    ...
    /// 盾牌精通
    /// </summary>
    public partial class C_BattleMaster_Shield_Master450
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Shield_Master450] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
