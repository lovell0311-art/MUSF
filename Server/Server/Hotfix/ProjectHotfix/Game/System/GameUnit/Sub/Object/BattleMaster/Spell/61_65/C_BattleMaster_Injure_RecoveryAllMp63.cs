...
namespace ETHotfix
{
    ...
    /// 受伤魔力完全回复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Injure_RecoveryAllMp63)]
    public partial class C_BattleMaster_Injure_RecoveryAllMp63 : C_BattleMaster
    {
    ...
    /// 受伤魔力完全回复
    /// </summary>
    public partial class C_BattleMaster_Injure_RecoveryAllMp63
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Injure_RecoveryAllMp63] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
