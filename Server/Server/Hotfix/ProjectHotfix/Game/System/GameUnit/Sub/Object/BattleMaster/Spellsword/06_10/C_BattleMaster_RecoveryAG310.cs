...
namespace ETHotfix
{
    ...
    /// 属性防御力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.RecoveryAG310)]
    public partial class C_BattleMaster_RecoveryAG310 : C_BattleMaster
    {
    ...
    /// 防御力增加
    /// </summary>
    public partial class C_BattleMaster_RecoveryAG310
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.RecoveryAG310] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
