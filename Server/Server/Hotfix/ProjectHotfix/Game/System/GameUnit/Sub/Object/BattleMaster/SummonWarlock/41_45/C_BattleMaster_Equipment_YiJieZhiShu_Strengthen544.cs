...
namespace ETHotfix
{
    ...
    /// 异界之书强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Equipment_YiJieZhiShu_Strengthen544)]
    public partial class C_BattleMaster_Equipment_YiJieZhiShu_Strengthen544 : C_BattleMaster
    {
    ...
    /// 异界之书强化
    /// </summary>
    public partial class C_BattleMaster_Equipment_YiJieZhiShu_Strengthen544
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Equipment_YiJieZhiShu_Strengthen544] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
