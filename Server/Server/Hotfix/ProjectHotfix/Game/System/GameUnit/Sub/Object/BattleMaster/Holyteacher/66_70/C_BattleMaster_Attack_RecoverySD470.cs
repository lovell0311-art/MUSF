...
namespace ETHotfix
{
    ...
    /// sd 防御恢复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Attack_RecoverySD470)]
    public partial class C_BattleMaster_Attack_RecoverySD470 : C_BattleMaster
    {
    ...
    /// sd 防御恢复
    /// </summary>
    public partial class C_BattleMaster_Attack_RecoverySD470
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 攻击敌人时每次成攻击成功，以50%的概率SD恢复{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Attack_RecoverySD470] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
