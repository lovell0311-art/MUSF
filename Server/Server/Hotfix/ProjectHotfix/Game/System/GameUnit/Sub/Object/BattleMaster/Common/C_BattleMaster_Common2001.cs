...
namespace ETHotfix
{
    ...
    /// 攻击力/魔法攻击力/诅咒力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Common2001)]
    public partial class C_BattleMaster_Common2001 : C_BattleMaster
    {
    ...
    /// 攻击力/魔法攻击力/诅咒力增加
    /// </summary>
    public partial class C_BattleMaster_Common2001
    {
        #region try
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Common2001] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
