...
namespace ETHotfix
{
    ...
    /// 最大生命力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute932)]
    public partial class C_BattleMaster_MasterAttribute932 : C_BattleMaster
    {
    ...
    /// 最大生命力增加
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute932
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute932] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
