...
namespace ETHotfix
{
    ...
    /// 黑暗镇魂曲强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_HeiAnZhenHunQu_Strengthen551)]
    public partial class C_BattleMaster_Skill_HeiAnZhenHunQu_Strengthen551 : C_BattleMaster
    {
    ...
    /// 黑暗镇魂曲强化
    /// </summary>
    public partial class C_BattleMaster_Skill_HeiAnZhenHunQu_Strengthen551
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用黑暗镇魂曲技能时诅咒力追加提高{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HeiAnZhenHunQu_Strengthen551] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
