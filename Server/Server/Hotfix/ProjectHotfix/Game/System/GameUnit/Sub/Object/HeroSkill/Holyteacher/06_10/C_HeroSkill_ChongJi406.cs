...
namespace ETHotfix
{
    ...
    /// 冲击
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.ChongJi406)]
    public partial class C_HeroSkill_ChongJi406 : C_HeroSkillSource
    {
    ...
    /// 冲击
    /// </summary>
    public partial class C_HeroSkill_ChongJi406
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_ChongJiBoStrengthen427))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ChongJiBoStrengthen427];
