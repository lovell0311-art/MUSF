...
namespace ETHotfix
{
    ...
    /// 攻击时sd 完全回复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Attack_RecoveryAllSD273)]
    public partial class C_BattleMaster_Attack_RecoveryAllSD273 : C_BattleMaster
    {
    ...
    /// 攻击时sd 完全回复
    /// </summary>
    public partial class C_BattleMaster_Attack_RecoveryAllSD273
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Attack_RecoveryAllSD273] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
