...
namespace ETHotfix
{
    ...
    /// 掌心雷强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ZhuangXinLeiStrengthen26)]
    public partial class C_BattleMaster_Skill_ZhuangXinLeiStrengthen26 : C_BattleMaster
    {
    ...
    /// 掌心雷强化
    /// </summary>
    public partial class C_BattleMaster_Skill_ZhuangXinLeiStrengthen26
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ZhuangXinLeiStrengthen26] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
