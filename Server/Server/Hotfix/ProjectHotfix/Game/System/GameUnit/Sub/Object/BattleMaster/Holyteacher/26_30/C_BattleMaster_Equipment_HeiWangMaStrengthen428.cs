...
namespace ETHotfix
{
    ...
    /// 黑王马强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Equipment_HeiWangMaStrengthen428)]
    public partial class C_BattleMaster_Equipment_HeiWangMaStrengthen428 : C_BattleMaster
    {
    ...
    /// 黑王马强化
    /// </summary>
    public partial class C_BattleMaster_Equipment_HeiWangMaStrengthen428
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Equipment_HeiWangMaStrengthen428] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
