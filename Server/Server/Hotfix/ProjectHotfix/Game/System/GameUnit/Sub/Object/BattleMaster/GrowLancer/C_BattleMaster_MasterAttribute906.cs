...
namespace ETHotfix
{
    ...
    /// SD恢复速度提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute906)]
    public partial class C_BattleMaster_MasterAttribute906 : C_BattleMaster
    {
    ...
    /// SD恢复速度提高
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute906
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute906] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
