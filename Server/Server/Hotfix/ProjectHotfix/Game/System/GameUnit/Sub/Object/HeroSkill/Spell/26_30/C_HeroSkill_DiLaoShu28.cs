...
namespace ETHotfix
{
    ...
    /// 地牢术
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.DiLaoShu28)]
    public partial class C_HeroSkill_DiLaoShu28 : C_HeroSkillSource
    {
        ...
        {
            if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_DiLaoShuStrengthen45))
            {
                return 3;
            }
            return CoolTime;
    ...
    /// 地牢术
    /// </summary>
    public partial class C_HeroSkill_DiLaoShu28
    {
        ...
        public override bool TryUse(CombatSource b_Attacker, CombatSource b_BeAttacker, C_FindTheWay2D b_Cell, BattleComponent b_BattleComponent, IActorResponse b_Response)
        {
            ...
            if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_DiLaoShu43) == false)
            {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_DiLaoShuStrengthen45))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DiLaoShuStrengthen45];
