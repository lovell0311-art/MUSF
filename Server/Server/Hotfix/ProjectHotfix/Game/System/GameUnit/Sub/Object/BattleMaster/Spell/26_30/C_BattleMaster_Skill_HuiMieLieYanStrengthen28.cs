...
namespace ETHotfix
{
    ...
    /// 毁灭烈焰强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_HuiMieLieYanStrengthen28)]
    public partial class C_BattleMaster_Skill_HuiMieLieYanStrengthen28 : C_BattleMaster
    {
    ...
    /// 毁灭烈焰强化
    /// </summary>
    public partial class C_BattleMaster_Skill_HuiMieLieYanStrengthen28
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HuiMieLieYanStrengthen28] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
