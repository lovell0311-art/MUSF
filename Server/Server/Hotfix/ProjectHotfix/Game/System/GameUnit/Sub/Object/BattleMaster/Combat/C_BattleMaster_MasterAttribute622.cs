...
namespace ETHotfix
{
    ...
    /// 攻击成功率 （PVE）
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute622)]
    public partial class C_BattleMaster_MasterAttribute622 : C_BattleMaster
    {
    ...
    /// 攻击成功率 （PVE）
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute622
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute622] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
