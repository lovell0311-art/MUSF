...
namespace ETHotfix
{
    ...
    /// 反伤
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BackInjureRate14)]
    public partial class C_BattleMaster_BackInjure14 : C_BattleMaster
    {
    ...
    /// 反伤
    /// </summary>
    public partial class C_BattleMaster_BackInjure14
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BackInjureRate14] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
