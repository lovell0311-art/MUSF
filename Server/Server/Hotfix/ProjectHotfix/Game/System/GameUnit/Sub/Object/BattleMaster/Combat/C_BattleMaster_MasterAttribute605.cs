...
namespace ETHotfix
{
    ...
    /// 减少耐久2
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute605)]
    public partial class C_BattleMaster_MasterAttribute605 : C_BattleMaster
    {
    ...
    /// 减少耐久2
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute605
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute605] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
