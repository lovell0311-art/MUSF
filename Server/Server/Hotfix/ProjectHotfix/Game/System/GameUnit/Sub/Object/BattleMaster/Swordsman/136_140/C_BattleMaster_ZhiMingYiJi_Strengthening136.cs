...
namespace ETHotfix
{
    ...
    /// 致命一击强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ZhiMingYiJi_Strengthening136)]
    public partial class C_BattleMaster_ZhiMingYiJi_Strengthening136 : C_BattleMaster
    {
    ...
    /// 致命一击强化
    /// </summary>
    public partial class C_BattleMaster_ZhiMingYiJi_Strengthening136
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 致命一击技能的攻击动作变短，根据属性增加伤害。伤害数量增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ZhiMingYiJi_Strengthening136] = 1;
