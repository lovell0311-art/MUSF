...
namespace ETHotfix
{
    ...
    /// 五重箭
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.WuChongJian10015)]
    public partial class C_HeroSkill_WuChongJian10015 : C_HeroSkillSource
    {
    ...
    /// 五重箭
    /// </summary>
    public partial class C_HeroSkill_WuChongJian10015
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                else
                {
                    ...
                    Vector2 mTargetCenterNormalize = Vector2.Normalize(mTargetPos - mSelfPos) * mConfig.Distance;
