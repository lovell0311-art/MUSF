...
namespace ETHotfix
{
    ...
    /// 地牢术强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_DiLaoShuStrengthen351)]
    public partial class C_BattleMaster_Skill_DiLaoShuStrengthen351 : C_BattleMaster
    {
    ...
    /// 地牢术强化
    /// </summary>
    public partial class C_BattleMaster_Skill_DiLaoShuStrengthen351
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DiLaoShuStrengthen351] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
