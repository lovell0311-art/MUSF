...
namespace ETHotfix
{
    ...
    /// 单手杖强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.DanShouJian_Strengthening355)]
    public partial class C_BattleMaster_DanShouJian_Strengthening355 : C_BattleMaster
    {
    ...
    /// 单手杖强化
    /// </summary>
    public partial class C_BattleMaster_DanShouJian_Strengthening355
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.DanShouJian_Strengthening355] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
