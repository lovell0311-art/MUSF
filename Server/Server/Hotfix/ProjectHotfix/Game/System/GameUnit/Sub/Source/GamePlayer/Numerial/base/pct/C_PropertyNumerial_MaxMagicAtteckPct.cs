...
namespace ETHotfix
{
    ...
    /// 
    /// </summary>
    [PropertyNumerialAttribute(BindId = (int)E_GameProperty.MaxMagicAtteckPct)]
    public partial class C_PropertyNumerial_MaxMagicAtteckPct : C_PropertyNumerial
    {
        public override int Run(GamePlayer b_Component, bool b_HasTemporary = true)
        {
            ...
            if (b_HasTemporary)
            {
                ...
                {
                    if (b_Component.BattleMasteryDic.TryGetValue(E_BattleMasteryState.Skill_FaShenFuTiStrengthen27, out var mMasteryValue))
                    {
                ...
                {
                    if (b_Component.BattleMasteryDic.TryGetValue(E_BattleMasteryState.Skill_ShouHuZhiHunMaster60, out var mMasteryValue))
                    {
                        mResult += mMasteryValue;
                    }
                }
        ...
        {
            int mResult = 0;
            var mGameProperty = E_GameProperty.MaxMagicAtteckPct;
