...
namespace ETHotfix
{
    ...
    /// 祝福强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ZuFuStrengthen_250)]
    public partial class C_BattleMaster_Skill_ZuFuStrengthen_250 : C_BattleMaster
    {
    ...
    /// 祝福强化
    /// </summary>
    public partial class C_BattleMaster_Skill_ZuFuStrengthen_250
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ZuFuStrengthen_250] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
