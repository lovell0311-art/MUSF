...
namespace ETHotfix
{
    ...
    /// 单手剑精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.DanShouJian_master149)]
    public partial class C_BattleMaster_DanShouJian_master149 : C_BattleMaster
    {
    ...
    /// 单手剑精通
    /// </summary>
    public partial class C_BattleMaster_DanShouJian_master149
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.DanShouJian_master149] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
