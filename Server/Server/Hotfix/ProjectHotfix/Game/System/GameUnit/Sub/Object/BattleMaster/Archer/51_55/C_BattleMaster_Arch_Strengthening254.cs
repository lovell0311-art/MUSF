...
namespace ETHotfix
{
    ...
    /// 弓类强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Arch_Strengthening254)]
    public partial class C_BattleMaster_Arch_Strengthening254 : C_BattleMaster
    {
    ...
    /// 弓类强化
    /// </summary>
    public partial class C_BattleMaster_Arch_Strengthening254
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Arch_Strengthening254] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
