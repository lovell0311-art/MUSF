...
namespace ETHotfix
{
    ...
    /// 火焰领域强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_HuoYanLingYuMaster344)]
    public partial class C_BattleMaster_Skill_HuoYanLingYuMaster344 : C_BattleMaster
    {
    ...
    /// 火焰领域强化
    /// </summary>
    public partial class C_BattleMaster_Skill_HuoYanLingYuMaster344
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用3次双手剑系列的技能时额外增加1个剑气爆发伤害

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HuoYanLingYuMaster344] = 1;
