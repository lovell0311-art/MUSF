...
namespace ETHotfix
{
    ...
    /// 杀怪时魔力回复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BeCommon3028)]
    public partial class C_BattleMaster_BeCommon3028 : C_BattleMaster
    {
    ...
    /// 杀怪时魔力回复
    /// </summary>
    public partial class C_BattleMaster_BeCommon3028
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BeCommon3028] = (int)(1f / mConfig.OtherDataDic[mMasterLevel] * 10000 * 10000);
