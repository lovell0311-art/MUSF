...
namespace ETHotfix
{
    ...
    /// 坚固的庇护
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.JiGuDeBiHu)]
    public partial class C_HeroSkill_JiGuDeBiHu115 : C_HeroSkillSource
    {
    ...
    /// 坚固的庇护
    /// </summary>
    public partial class C_HeroSkill_JiGuDeBiHu115
    {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
                {
                    ...
                    mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                    {
                        ...
                        b_CombatSource.RemoveHealthState(E_BattleSkillStats.JiGuDeBiHu115, b_BattleComponent);
                    ...
                    mBattleSyncTimer.SyncAction = (b_CombatSource, b_BattleComponent, b_TimerTask, b_TimeTick) =>
                    {
                        ...
                        if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.JiGuDeBiHu115, out var hp_Curse) == false)
                        {
                ...
                b_Attacker.AddHealthState(E_BattleSkillStats.JiGuDeBiHu115, mConfig.OtherDataDic[0], mConfig.PersistentTime, 0, mCreateFunc, b_BattleComponent);
