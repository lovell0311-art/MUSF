...
namespace ETHotfix
{
    ...
    /// 聚灵强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_JuLing_Strengthen525)]
    public partial class C_BattleMaster_Skill_JuLing_Strengthen525 : C_BattleMaster
    {
    ...
    /// 聚灵强化
    /// </summary>
    public partial class C_BattleMaster_Skill_JuLing_Strengthen525
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_JuLing_Strengthen525] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
