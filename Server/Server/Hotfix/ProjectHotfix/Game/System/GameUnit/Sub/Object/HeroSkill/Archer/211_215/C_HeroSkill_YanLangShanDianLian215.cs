...
namespace ETHotfix
{
    ...
    /// 炎狼闪电链
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.YanLangShanDianLian215)]
    public partial class C_HeroSkill_YanLangShanDianLian215 : C_HeroSkillSource
    {
    ...
    /// 炎狼闪电链
    /// </summary>
    public partial class C_HeroSkill_YanLangShanDianLian215
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                var mAppendValue = b_Attacker.GetNumerialFunc(E_GameProperty.Property_Agility) / mConfig.OtherDataDic[10];
