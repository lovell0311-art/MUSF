...
namespace ETHotfix
{
    ...
    /// 致命圣印强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ZhiMingShengYinStrengthen429)]
    public partial class C_BattleMaster_Skill_ZhiMingShengYinStrengthen429 : C_BattleMaster
    {
    ...
    /// 致命圣印强化
    /// </summary>
    public partial class C_BattleMaster_Skill_ZhiMingShengYinStrengthen429
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 致命圣印技能使用时幸运一击伤害提高{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ZhiMingShengYinStrengthen429] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
