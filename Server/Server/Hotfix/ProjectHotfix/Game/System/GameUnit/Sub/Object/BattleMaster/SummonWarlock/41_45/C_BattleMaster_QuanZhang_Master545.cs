...
namespace ETHotfix
{
    ...
    /// 权杖强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.QuanZhang_Master545)]
    public partial class C_BattleMaster_QuanZhang_Master545 : C_BattleMaster
    {
    ...
    /// 权杖强化
    /// </summary>
    public partial class C_BattleMaster_QuanZhang_Master545
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 装备法杖时对目标的攻击力追加增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.QuanZhang_Master545] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
