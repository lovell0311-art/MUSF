...
namespace ETHotfix
{
    ...
    /// Sd 回复   杀怪后
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.KillRecoverySD261)]
    public partial class C_BattleMaster_KillRecoverySD261 : C_BattleMaster
    {
    ...
    /// Sd 回复   杀怪后
    /// </summary>
    public partial class C_BattleMaster_KillRecoverySD261
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.KillRecoverySD261] = (int)(1f / mConfig.OtherDataDic[mMasterLevel] * 10000 * 10000);
