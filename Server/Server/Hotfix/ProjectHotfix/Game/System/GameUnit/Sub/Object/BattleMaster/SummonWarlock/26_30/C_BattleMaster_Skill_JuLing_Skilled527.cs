...
namespace ETHotfix
{
    ...
    /// 聚灵熟悉
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_JuLing_Skilled527)]
    public partial class C_BattleMaster_Skill_JuLing_Skilled527 : C_BattleMaster
    {
    ...
    /// 聚灵熟悉
    /// </summary>
    public partial class C_BattleMaster_Skill_JuLing_Skilled527
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 聚灵技能的范围增加1格，技能攻击力增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_JuLing_Skilled527] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
