...
namespace ETHotfix
{
    ...
    /// 杀怪时魔力恢复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute957)]
    public partial class C_BattleMaster_MasterAttribute957 : C_BattleMaster
    {
    ...
    /// 杀怪时魔力恢复
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute957
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute957] = 1;//base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
