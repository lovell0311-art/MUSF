...
namespace ETHotfix
{
    ...
    /// 血腥风暴强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_XueXingFengBao_Strengthening350)]
    public partial class C_BattleMaster_Skill_XueXingFengBao_Strengthening350 : C_BattleMaster
    {
    ...
    /// 血腥风暴强化
    /// </summary>
    public partial class C_BattleMaster_Skill_XueXingFengBao_Strengthening350
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 血腥风暴技能的伤害提高{0:F}，重新使用时间变为3秒。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XueXingFengBao_Strengthening350] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
