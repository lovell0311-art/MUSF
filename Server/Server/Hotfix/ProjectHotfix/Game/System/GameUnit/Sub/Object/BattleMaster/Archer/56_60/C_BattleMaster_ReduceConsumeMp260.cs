...
namespace ETHotfix
{
    ...
    /// 技能蓝耗减少
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ReduceConsumeMp260)]
    public partial class C_BattleMaster_ReduceConsumeMp260 : C_BattleMaster
    {
    ...
    /// 技能蓝耗减少
    /// </summary>
    public partial class C_BattleMaster_ReduceConsumeMp260
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ReduceConsumeMp260] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
