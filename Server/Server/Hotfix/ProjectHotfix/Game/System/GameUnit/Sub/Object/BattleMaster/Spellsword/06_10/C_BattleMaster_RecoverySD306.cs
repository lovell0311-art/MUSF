...
namespace ETHotfix
{
    ...
    /// SD恢复速度提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.RecoverySD306)]
    public partial class C_BattleMaster_RecoverySD306 : C_BattleMaster
    {
    ...
    /// SD恢复速度提高
    /// </summary>
    public partial class C_BattleMaster_RecoverySD306
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.RecoverySD306] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
