...
namespace ETHotfix
{
    ...
    /// 权杖精通PVP
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.PVPQuanZhang_Master449)]
    public partial class C_BattleMaster_PVPQuanZhang_Master449 : C_BattleMaster
    {
    ...
    /// 权杖精通PVP
    /// </summary>
    public partial class C_BattleMaster_PVPQuanZhang_Master449
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 装备权杖时对目标的攻击力追加增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.PVPQuanZhang_Master449] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
