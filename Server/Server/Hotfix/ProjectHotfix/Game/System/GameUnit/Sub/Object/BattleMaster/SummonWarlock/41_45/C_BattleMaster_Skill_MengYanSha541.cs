...
namespace ETHotfix
{
    ...
    /// 蒙眼煞
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_MengYanSha541)]
    public partial class C_BattleMaster_Skill_MengYanSha541 : C_BattleMaster
    {
    ...
    /// 蒙眼煞
    /// </summary>
    public partial class C_BattleMaster_Skill_MengYanSha541
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 学习蒙眼煞技能。以一定几率给目标伤害的同时失明，减少视野，大幅减少攻击成功率。5秒后可重新使用。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_MengYanSha541] = 1;

            var mStudySkillId = (int)E_HeroSkillId.MengYanSha526;
            var mReadConfigComponent = Root.MainFactory.GetCustomComponent<CustomFrameWork.Component.ReadConfigComponent>();
            ...
            if (b_Attacker.SkillGroup.ContainsKey(mStudySkillId) == false)
            {
                ...
                if (mSkillInstance == null) return false;
