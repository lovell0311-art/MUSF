...
namespace ETHotfix
{
    ...
    /// 守护盾
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.GuardianShield220)]
    public partial class C_BattleMaster_GuardianShield220 : C_BattleMaster
    {
    ...
    /// 守护盾
    /// </summary>
    public partial class C_BattleMaster_GuardianShield220
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.GuardianShield220] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
