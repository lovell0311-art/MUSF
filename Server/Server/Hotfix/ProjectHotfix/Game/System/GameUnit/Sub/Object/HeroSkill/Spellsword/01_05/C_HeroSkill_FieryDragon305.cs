...
namespace ETHotfix
{
    ...
    /// 火龙
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.FieryDragon305)]
    public partial class C_HeroSkill_FieryDragon305 : C_HeroSkillSource
    {
    ...
    /// 火龙
    /// </summary>
    public partial class C_HeroSkill_FieryDragon305
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_HuoLongStrengthen330))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HuoLongStrengthen330];
