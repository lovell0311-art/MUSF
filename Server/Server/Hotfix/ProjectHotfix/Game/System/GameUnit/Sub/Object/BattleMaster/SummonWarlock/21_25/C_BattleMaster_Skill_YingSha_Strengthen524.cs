...
namespace ETHotfix
{
    ...
    /// 影煞强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_YingSha_Strengthen524)]
    public partial class C_BattleMaster_Skill_YingSha_Strengthen524 : C_BattleMaster
    {
    ...
    /// 影煞强化
    /// </summary>
    public partial class C_BattleMaster_Skill_YingSha_Strengthen524
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_YingSha_Strengthen524] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
