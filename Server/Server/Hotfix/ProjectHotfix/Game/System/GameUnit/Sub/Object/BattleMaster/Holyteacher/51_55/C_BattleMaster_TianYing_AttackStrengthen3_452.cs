...
namespace ETHotfix
{
    ...
    /// 天鹰强化(3)
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.TianYing_AttackStrengthen3_452)]
    public partial class C_BattleMaster_TianYing_AttackStrengthen3_452 : C_BattleMaster
    {
    ...
    /// 天鹰强化(3)
    /// </summary>
    public partial class C_BattleMaster_TianYing_AttackStrengthen3_452
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.TianYing_AttackStrengthen3_452] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
