...
namespace ETHotfix
{
    ...
    /// 黑龙波
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.HeiLongBo308)]
    public partial class C_HeroSkill_HeiLongBo308 : C_HeroSkillSource
    {
    ...
    /// 黑龙波
    /// </summary>
    public partial class C_HeroSkill_HeiLongBo308
    {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Action<long, long, long> mSyncActionChild = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
                {
                    ...
                    int GetHurtValue(E_GameProperty b_SpecialAttack)
                    {
                        ...
                        if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_HeiLongBoStrengthen334))
                        {
                            int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HeiLongBoStrengthen334];
