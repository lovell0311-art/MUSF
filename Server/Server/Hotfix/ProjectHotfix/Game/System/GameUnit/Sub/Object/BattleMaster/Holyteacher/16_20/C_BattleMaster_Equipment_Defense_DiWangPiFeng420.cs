...
namespace ETHotfix
{
    ...
    /// 帝王披风防御强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Equipment_Defense_DiWangPiFeng420)]
    public partial class C_BattleMaster_Equipment_Defense_DiWangPiFeng420 : C_BattleMaster
    {
    ...
    /// 帝王披风防御强化
    /// </summary>
    public partial class C_BattleMaster_Equipment_Defense_DiWangPiFeng420
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Equipment_Defense_DiWangPiFeng420] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
