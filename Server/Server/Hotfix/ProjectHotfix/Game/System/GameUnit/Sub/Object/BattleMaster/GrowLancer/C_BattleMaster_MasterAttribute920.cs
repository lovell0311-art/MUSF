...
namespace ETHotfix
{
    ...
    /// 防盾
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute920)]
    public partial class C_BattleMaster_MasterAttribute920 : C_BattleMaster
    {
    ...
    /// 防盾
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute920
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute920] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
