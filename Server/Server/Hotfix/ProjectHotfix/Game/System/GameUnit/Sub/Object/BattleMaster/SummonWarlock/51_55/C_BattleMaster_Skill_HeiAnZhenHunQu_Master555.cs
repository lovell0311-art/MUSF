...
namespace ETHotfix
{
    ...
    /// 黑暗镇魂曲精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_HeiAnZhenHunQu_Master555)]
    public partial class C_BattleMaster_Skill_HeiAnZhenHunQu_Master555 : C_BattleMaster
    {
    ...
    /// 黑暗镇魂曲精通
    /// </summary>
    public partial class C_BattleMaster_Skill_HeiAnZhenHunQu_Master555
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用黑暗镇魂曲技能时防御力追加提高{0:F}，去除HP降低效果。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HeiAnZhenHunQu_Master555] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
