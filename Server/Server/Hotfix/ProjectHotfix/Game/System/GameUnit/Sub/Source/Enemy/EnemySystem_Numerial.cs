...
namespace ETHotfix
{
    ...
    {
        public static int GetNumerial(this Enemy b_Component, E_GameProperty b_GameProperty, bool b_HasTemporary = true)
        {
        ...
        public static void ChangeNumerialType(this Enemy b_Component, E_GameProperty b_GameProperty)
        {
        ...
        public static int GetNumerialSpecial(this Enemy b_Component, E_GameProperty b_GameProperty)
        {
            int mResult = 0;
