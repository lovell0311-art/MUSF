...
namespace ETHotfix
{
    ...
    /// 闪电轰顶强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ShanDianHongDingStrengthen338)]
    public partial class C_BattleMaster_Skill_ShanDianHongDingStrengthen338 : C_BattleMaster
    {
    ...
    /// 闪电轰顶强化
    /// </summary>
    public partial class C_BattleMaster_Skill_ShanDianHongDingStrengthen338
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ShanDianHongDingStrengthen338] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
