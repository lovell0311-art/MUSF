...
namespace ETHotfix
{
    ...
    /// 受伤生命力完全回复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Injure_RecoveryAllHp64)]
    public partial class C_BattleMaster_Injure_RecoveryAllHp64 : C_BattleMaster
    {
    ...
    /// 受伤生命力完全回复
    /// </summary>
    public partial class C_BattleMaster_Injure_RecoveryAllHp64
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 受到伤害时，{0:F}%的几率生命力完全恢复。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Injure_RecoveryAllHp64] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
