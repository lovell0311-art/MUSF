...
namespace ETHotfix
{
    ...
    /// 毒箭
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_DuJian_247)]
    public partial class C_BattleMaster_Skill_DuJian_247 : C_BattleMaster
    {
    ...
    /// 毒箭
    /// </summary>
    public partial class C_BattleMaster_Skill_DuJian_247
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 以一定的概率给目标造成毒伤害。毒效果每秒（最小攻击力/5）受到伤害

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DuJian_247] = 1;

            var mStudySkillId = (int)E_HeroSkillId.Curse225;
            var mReadConfigComponent = Root.MainFactory.GetCustomComponent<CustomFrameWork.Component.ReadConfigComponent>();
