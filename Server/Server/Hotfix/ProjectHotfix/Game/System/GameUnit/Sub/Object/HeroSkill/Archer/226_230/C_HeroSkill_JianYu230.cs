...
namespace ETHotfix
{
    ...
    /// 剑雨
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.JianYu230)]
    public partial class C_HeroSkill_JianYu230 : C_HeroSkillSource
    {
    ...
    /// 剑雨
    /// </summary>
    public partial class C_HeroSkill_JianYu230
    {
        ...
        public override bool TryUse(CombatSource b_Attacker, CombatSource b_BeAttacker, C_FindTheWay2D b_Cell, BattleComponent b_BattleComponent, IActorResponse b_Response)
        {
            ...
            if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Common2011) == false)
            {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Vector2 mCenterPos = b_BattleComponent.Parent.GetFindTheWay2D(b_BeAttacker).Vector2Pos;
