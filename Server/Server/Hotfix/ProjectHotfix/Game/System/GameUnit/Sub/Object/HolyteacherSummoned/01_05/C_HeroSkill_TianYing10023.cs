...
namespace ETHotfix
{
    ...
    /// 群体攻击
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.TianYing10023)]
    public partial class C_HeroSkill_TianYing10023 : C_HeroSkillSource
    {
    ...
    public partial class C_HeroSkill_TianYing10023
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int mMinAtteck = b_Attacker.GetNumerialFunc(E_GameProperty.TianYingMinAtteck);
                int mMaxAtteck = b_Attacker.GetNumerialFunc(E_GameProperty.TianYingMaxAtteck);
                ...
                {
                    var mTeamComponent = (b_Attacker as HolyteacherSummoned).GamePlayer.Player.GetCustomComponent<TeamComponent>();
                        ...
                        for (int j = 0, jlen = mFieldEnemylist.Length; j < jlen; j++)
                        {
                            ...
                            //if (Vector2.Distance(mSelfPos, new Vector2(mCurrentTemp.UnitData.X, mCurrentTemp.UnitData.Y)) < mRadius)
                            {
                                ...
                                if (IsHit)
                                {
                                    ...
                                    // mCurrentTemp.CurrentSkill = this;
