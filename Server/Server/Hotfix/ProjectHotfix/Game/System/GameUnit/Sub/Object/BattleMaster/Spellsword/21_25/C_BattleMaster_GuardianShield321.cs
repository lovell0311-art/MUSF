...
namespace ETHotfix
{
    ...
    /// 守护盾
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.GuardianShield321)]
    public partial class C_BattleMaster_GuardianShield321 : C_BattleMaster
    {
    ...
    /// 守护盾
    /// </summary>
    public partial class C_BattleMaster_GuardianShield321
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.GuardianShield321] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
