...
namespace ETHotfix
{
    ...
    /// 减少耐久
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Reduce_Durable3_511)]
    public partial class C_BattleMaster_ReduceDurable3_511 : C_BattleMaster
    {
    ...
    /// 减少耐久
    /// </summary>
    public partial class C_BattleMaster_ReduceDurable3_511
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Reduce_Durable3_511] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
