...
namespace ETHotfix
{
    ...
    /// 霹雳回旋斩
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.XuanFengHuiXuanZhan320)]
    public partial class C_HeroSkill_XuanFengHuiXuanZhan320 : C_HeroSkillSource
    {
    ...
    /// 霹雳回旋斩
    /// </summary>
    public partial class C_HeroSkill_XuanFengHuiXuanZhan320
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    // 大师技能 霹雳回旋斩强化
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_LeiTingHuiXuanZhanStrengthen328))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_LeiTingHuiXuanZhanStrengthen328];
