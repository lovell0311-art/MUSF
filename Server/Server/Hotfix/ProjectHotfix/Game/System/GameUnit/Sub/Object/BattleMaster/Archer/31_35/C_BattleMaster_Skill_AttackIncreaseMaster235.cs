...
namespace ETHotfix
{
    ...
    /// 攻击力提高精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_AttackIncreaseMaster235)]
    public partial class C_BattleMaster_Skill_AttackIncreaseMaster235 : C_BattleMaster
    {
    ...
    /// 攻击力提高精通
    /// </summary>
    public partial class C_BattleMaster_Skill_AttackIncreaseMaster235
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 战神之力效果提高{0:F}%，持续时间阶段性增加

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_AttackIncreaseMaster235] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
