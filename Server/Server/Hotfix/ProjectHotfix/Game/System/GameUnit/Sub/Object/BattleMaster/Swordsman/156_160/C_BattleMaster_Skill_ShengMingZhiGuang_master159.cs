...
namespace ETHotfix
{
    ...
    /// 生命之光精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ShengMingZhiGuang_master159)]
    public partial class C_BattleMaster_Skill_ShengMingZhiGuang_master159 : C_BattleMaster
    {
    ...
    /// 生命之光精通
    /// </summary>
    public partial class C_BattleMaster_Skill_ShengMingZhiGuang_master159
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 生命之光技能使用时追加最大AG提高{0:F}%。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ShengMingZhiGuang_master159] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
