...
namespace ETHotfix
{
    ...
    /// 冲击波强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ChongJiBoStrengthen427)]
    public partial class C_BattleMaster_Skill_ChongJiBoStrengthen427 : C_BattleMaster
    {
    ...
    /// 冲击波强化
    /// </summary>
    public partial class C_BattleMaster_Skill_ChongJiBoStrengthen427
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ChongJiBoStrengthen427] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
