...
namespace ETHotfix
{
    ...
    /// 无视防御几率提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IgnoreDefenseRate71)]
    public partial class C_BattleMaster_IgnoreDefenseRate71 : C_BattleMaster
    {
    ...
    /// 无视防御几率提高
    /// </summary>
    public partial class C_BattleMaster_IgnoreDefenseRate71
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IgnoreDefenseRate71] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
