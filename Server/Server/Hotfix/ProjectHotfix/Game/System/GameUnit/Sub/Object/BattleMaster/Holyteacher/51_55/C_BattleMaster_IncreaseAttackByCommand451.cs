...
namespace ETHotfix
{
    ...
    /// 统率攻击力 增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseAttackByCommand451)]
    public partial class C_BattleMaster_IncreaseAttackByCommand451 : C_BattleMaster
    {
    ...
    /// 统率攻击力 增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseAttackByCommand451
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseAttackByCommand451] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
