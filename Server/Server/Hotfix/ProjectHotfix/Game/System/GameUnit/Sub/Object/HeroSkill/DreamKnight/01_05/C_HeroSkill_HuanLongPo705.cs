...
namespace ETHotfix
{
    ...
    /// 幻龙破
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.HuanLongPo705)]
    public partial class C_HeroSkill_HuanLongPo705 : C_HeroSkillSource
    {
    ...
    /// 幻龙破
    /// </summary>
    public partial class C_HeroSkill_HuanLongPo705
    {
        ...
        public override bool TryUse(CombatSource b_Attacker, CombatSource b_BeAttacker, C_FindTheWay2D b_Cell, BattleComponent b_BattleComponent, IActorResponse b_Response)
        {
            ...
            if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute933))
            {
                int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute933];
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                if (Vector2.Distance(mFindTheWaySource.Vector2Pos, b_Cell.Vector2Pos) > Distance)
                {
                    G2C_AttackResult_notice mAttackResultNotice = new G2C_AttackResult_notice();
                    mAttackResultNotice.HurtValueType = 6;
                    mAttackResultNotice.AttackTarget = mBeAttacker.InstanceId;
                ...
                b_BattleComponent.WaitSync(200, b_AttackerId, b_BeAttackerId, mSyncActionChild);
            };
