...
namespace ETHotfix
{
    ...
    /// 攻击速度增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BeCommon3013)]
    public partial class C_BattleMaster_BeCommon3013 : C_BattleMaster
    {
    ...
    /// 攻击速度增加
    /// </summary>
    public partial class C_BattleMaster_BeCommon3013
    {
        #region try
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BeCommon3013] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
