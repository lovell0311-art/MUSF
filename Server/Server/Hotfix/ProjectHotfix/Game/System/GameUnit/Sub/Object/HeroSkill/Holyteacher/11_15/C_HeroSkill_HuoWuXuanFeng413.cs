...
namespace ETHotfix
{
    ...
    /// 火舞旋风
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.HuoWuXuanFeng413)]
    public partial class C_HeroSkill_HuoWuXuanFeng413 : C_HeroSkillSource
    {
    ...
    /// 火舞旋风
    /// </summary>
    public partial class C_HeroSkill_HuoWuXuanFeng413
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                var mAgility = b_Attacker.GetNumerialFunc(E_GameProperty.Property_Strength) / mConfig.OtherDataDic[10];
                ...
                {// 随机魔法伤害
                    ...
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_HuoWuXuanFengMaster438))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HuoWuXuanFengMaster438];
                        mAddScale += mMasteryValue;
                    }
                    if (mAddScale != 100)
                        mHurtValue = (int)(mHurtValue * mAddScale * 0.01f);

                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_HuoWuXuanFengStrengthen435))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HuoWuXuanFengStrengthen435];
