...
namespace ETHotfix
{
    ...
    /// 精神之王
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.JingShenZhiWang460)]
    public partial class C_BattleMaster_JingShenZhiWang460 : C_BattleMaster
    {
    ...
    /// 精神之王
    /// </summary>
    public partial class C_BattleMaster_JingShenZhiWang460
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 天鹰攻击时无视防御伤害几率追加提高{0:F}%。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.JingShenZhiWang460] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
