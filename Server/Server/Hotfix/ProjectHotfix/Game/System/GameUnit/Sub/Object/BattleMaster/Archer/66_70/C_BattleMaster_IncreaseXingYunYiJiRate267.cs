...
namespace ETHotfix
{
    ...
    /// 幸运一击几率提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseXingYunYiJiRate267)]
    public partial class C_BattleMaster_IncreaseXingYunYiJiRate267 : C_BattleMaster
    {
    ...
    /// 幸运一击几率提高
    /// </summary>
    public partial class C_BattleMaster_IncreaseXingYunYiJiRate267
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseXingYunYiJiRate267] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0) /** 100*/;
