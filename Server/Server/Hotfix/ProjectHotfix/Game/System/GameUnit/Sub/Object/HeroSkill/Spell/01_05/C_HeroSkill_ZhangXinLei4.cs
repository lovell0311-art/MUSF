...
namespace ETHotfix
{
    ...
    /// 掌心雷
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.ZHANG_XIN_LEI)]
    public partial class C_HeroSkill_ZhangXinLei4 : C_HeroSkillSource
    {
    ...
    /// 掌心雷
    /// </summary>
    public partial class C_HeroSkill_ZhangXinLei4
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_ZhuangXinLeiStrengthen26))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ZhuangXinLeiStrengthen26];
