...
namespace ETHotfix
{
    ...
    /// 虚弱阵强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_XuRuoZhen_Strengthen535)]
    public partial class C_BattleMaster_Skill_XuRuoZhen_Strengthen535 : C_BattleMaster
    {
    ...
    /// 虚弱阵强化
    /// </summary>
    public partial class C_BattleMaster_Skill_XuRuoZhen_Strengthen535
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用虚弱阵技能时攻击力降低效果增加{0:F}，持续时间也按阶段性增加。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XuRuoZhen_Strengthen535] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
