...
namespace ETHotfix
{
    ...
    /// 最大生命增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseHpMax42)]
    public partial class C_BattleMaster_IncreaseHpMax42 : C_BattleMaster
    {
    ...
    /// 最大生命增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseHpMax42
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseHpMax42] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
