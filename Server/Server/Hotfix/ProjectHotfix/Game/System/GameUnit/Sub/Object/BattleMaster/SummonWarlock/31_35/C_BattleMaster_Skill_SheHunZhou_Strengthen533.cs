...
namespace ETHotfix
{
    ...
    /// 摄魂咒强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_SheHunZhou_Strengthen533)]
    public partial class C_BattleMaster_Skill_SheHunZhou_Strengthen533 : C_BattleMaster
    {
    ...
    /// 摄魂咒强化
    /// </summary>
    public partial class C_BattleMaster_Skill_SheHunZhou_Strengthen533
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_SheHunZhou_Strengthen533] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
