...
namespace ETHotfix
{
    ...
    /// 黑暗之力强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_HeiAnZhiLiStrengthen441)]
    public partial class C_BattleMaster_Skill_HeiAnZhiLiStrengthen441 : C_BattleMaster
    {
    ...
    /// 黑暗之力强化
    /// </summary>
    public partial class C_BattleMaster_Skill_HeiAnZhiLiStrengthen441
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HeiAnZhiLiStrengthen441] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
