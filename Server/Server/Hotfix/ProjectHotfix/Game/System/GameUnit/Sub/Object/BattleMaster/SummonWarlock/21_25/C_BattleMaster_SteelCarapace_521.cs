...
namespace ETHotfix
{
    ...
    /// 钢铁铠甲
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.SteelCarapace_521)]
    public partial class C_BattleMaster_SteelCarapace_521 : C_BattleMaster
    {
    ...
    /// 钢铁铠甲
    /// </summary>
    public partial class C_BattleMaster_SteelCarapace_521
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.SteelCarapace_521] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
