...
namespace ETHotfix
{
    ...
    /// 杀怪时生命力恢复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.KillRecoveryHp155)]
    public partial class C_BattleMaster_KillRecoveryHp155 : C_BattleMaster
    {
    ...
    /// 杀怪时生命力恢复
    /// </summary>
    public partial class C_BattleMaster_KillRecoveryHp155
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 杀死怪物后，恢复生命力{0:F}的生命值。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.KillRecoveryHp155] = (int)(1f / mConfig.OtherDataDic[mMasterLevel] * 10000 * 10000);
