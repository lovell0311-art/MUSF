...
namespace ETHotfix
{
    ...
    /// 反伤
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute614)]
    public partial class C_BattleMaster_MasterAttribute614 : C_BattleMaster
    {
    ...
    /// 反伤
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute614
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute614] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
