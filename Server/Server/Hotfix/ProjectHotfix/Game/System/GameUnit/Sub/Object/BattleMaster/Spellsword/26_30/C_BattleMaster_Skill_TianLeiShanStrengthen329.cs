...
namespace ETHotfix
{
    ...
    /// 天雷闪强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_TianLeiShanStrengthen329)]
    public partial class C_BattleMaster_Skill_TianLeiShanStrengthen329 : C_BattleMaster
    {
    ...
    /// 天雷闪强化
    /// </summary>
    public partial class C_BattleMaster_Skill_TianLeiShanStrengthen329
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_TianLeiShanStrengthen329] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
