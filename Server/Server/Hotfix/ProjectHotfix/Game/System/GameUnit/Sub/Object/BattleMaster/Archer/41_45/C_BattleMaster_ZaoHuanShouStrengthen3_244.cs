...
namespace ETHotfix
{
    ...
    /// 召唤兽强化3
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ZaoHuanShouStrengthen3_244)]
    public partial class C_BattleMaster_ZaoHuanShouStrengthen3_244 : C_BattleMaster
    {
    ...
    /// 召唤兽强化3
    /// </summary>
    public partial class C_BattleMaster_ZaoHuanShouStrengthen3_244
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ZaoHuanShouStrengthen3_244] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
