...
namespace ETHotfix
{
    ...
    /// 烈光闪
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.LieGuangShan508)]
    public partial class C_HeroSkill_LieGuangShan508 : C_HeroSkillSource
    {
    ...
    /// 烈光闪
    /// </summary>
    public partial class C_HeroSkill_LieGuangShan508
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_LieGuangShan_Strengthen529))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_LieGuangShan_Strengthen529];
