...
namespace ETHotfix
{
    ...
    /// hp 回复  杀怪后
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.KillRecoveryHp455)]
    public partial class C_BattleMaster_KillRecoveryHp455 : C_BattleMaster
    {
    ...
    /// hp 回复  杀怪后
    /// </summary>
    public partial class C_BattleMaster_KillRecoveryHp455
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.KillRecoveryHp455] = (int)(1f / mConfig.OtherDataDic[mMasterLevel] * 10000 * 10000);
