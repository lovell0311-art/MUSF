...
namespace ETHotfix
{
    ...
    /// 多重箭
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.DuoChongJian)]
    public partial class C_HeroSkill_DuoChongJian201 : C_HeroSkillSource
    {
    ...
    /// 多重箭
    /// </summary>
    public partial class C_HeroSkill_DuoChongJian201
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    if (b_Attacker.BattleMasteryDic.TryGetValue(E_BattleMasteryState.Skill_DuoChongJianStrengthen226, out var mMasteryValue))
                    {
