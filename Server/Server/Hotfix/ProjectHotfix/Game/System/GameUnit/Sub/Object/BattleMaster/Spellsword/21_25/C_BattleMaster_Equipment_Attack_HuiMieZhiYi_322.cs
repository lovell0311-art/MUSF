...
namespace ETHotfix
{
    ...
    /// 毁灭之翼攻击强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Equipment_Attack_HuiMieZhiYi_322)]
    public partial class C_BattleMaster_Equipment_Attack_HuiMieZhiYi_322 : C_BattleMaster
    {
    ...
    /// 毁灭之翼攻击强化
    /// </summary>
    public partial class C_BattleMaster_Equipment_Attack_HuiMieZhiYi_322
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 破灭之翼装备时，攻击力和魔力增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Equipment_Attack_HuiMieZhiYi_322] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
