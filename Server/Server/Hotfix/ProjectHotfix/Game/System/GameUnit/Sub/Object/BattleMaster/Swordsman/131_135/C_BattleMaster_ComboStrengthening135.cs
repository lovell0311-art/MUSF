...
namespace ETHotfix
{
    ...
    /// 连击强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ComboStrengthening135)]
    public partial class C_BattleMaster_ComboStrengthening135 : C_BattleMaster
    {
    ...
    /// 连击强化
    /// </summary>
    public partial class C_BattleMaster_ComboStrengthening135
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ComboStrengthening135] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
