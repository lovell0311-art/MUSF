...
namespace ETHotfix
{
    ...
    /// 吸收增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BeCommon3021)]
    public partial class C_BattleMaster_BeCommon3021 : C_BattleMaster
    {
    ...
    /// 吸收增加
    /// </summary>
    public partial class C_BattleMaster_BeCommon3021
    {
        #region try
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BeCommon3021] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
