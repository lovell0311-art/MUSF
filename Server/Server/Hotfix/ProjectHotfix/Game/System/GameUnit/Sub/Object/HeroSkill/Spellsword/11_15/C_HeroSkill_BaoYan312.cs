...
namespace ETHotfix
{
    ...
    /// 爆炎
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.BaoYan312)]
    public partial class C_HeroSkill_BaoYan312 : C_HeroSkillSource
    {
    ...
    /// 爆炎
    /// </summary>
    public partial class C_HeroSkill_BaoYan312
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    else if (b_SpecialAttack == E_GameProperty.LucklyAttackRate)
                    {
                    ...
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_BaoYanStrengthen331))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_BaoYanStrengthen331];
