...
namespace ETHotfix
{
    ...
    /// 神射手
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ShenSheShou272)]
    public partial class C_BattleMaster_ShenSheShou272 : C_BattleMaster
    {
    ...
    /// 神射手
    /// </summary>
    public partial class C_BattleMaster_ShenSheShou272
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 攻击4格以外的目标时，攻击力增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ShenSheShou272] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
