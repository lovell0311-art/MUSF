...
namespace ETHotfix
{
    ...
    /// 坚强的信念
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.JiQiangDeXinNian)]
    public partial class C_HeroSkill_JiQiangDeXinNian114 : C_HeroSkillSource
    {
    ...
    /// 坚强的信念
    /// </summary>
    public partial class C_HeroSkill_JiQiangDeXinNian114
    {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
                {
                    ...
                    mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                    {
                        ...
                        b_CombatSource.RemoveHealthState(E_BattleSkillStats.JiQiangDeXinNian114, b_BattleComponent);
                    ...
                    mBattleSyncTimer.SyncAction = (b_CombatSource, b_BattleComponent, b_TimerTask, b_TimeTick) =>
                    {
                        ...
                        if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.JiQiangDeXinNian114, out var hp_Curse) == false)
                        {
                ...
                b_Attacker.AddHealthState(E_BattleSkillStats.JiQiangDeXinNian114, 0, mConfig.PersistentTime, 0, mCreateFunc, b_BattleComponent);
