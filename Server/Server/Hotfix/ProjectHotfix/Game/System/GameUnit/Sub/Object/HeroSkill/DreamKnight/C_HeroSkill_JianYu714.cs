...
namespace ETHotfix
{
    ...
    /// 陨星雨
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.JianYu714)]
    public partial class C_HeroSkill_JianYu714 : C_HeroSkillSource
    {
    ...
    /// 陨星雨
    /// </summary>
    public partial class C_HeroSkill_JianYu714
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int mMinAtteck = mConfig.OtherDataDic[1] + b_Attacker.GetNumerialFunc(E_GameProperty.MinAtteck) + b_Attacker.GetNumerialFunc(E_GameProperty.DreamRiderPenalize) + b_Attacker.GetNumerialFunc(E_GameProperty.DreamRiderIrritate); ;
                int mMaxAtteck = (int)(mConfig.OtherDataDic[1] * 1.5f) + b_Attacker.GetNumerialFunc(E_GameProperty.MaxAtteck) + b_Attacker.GetNumerialFunc(E_GameProperty.AdvanceAttackPower) + b_Attacker.GetNumerialFunc(E_GameProperty.RangeAttack) + b_Attacker.GetNumerialFunc(E_GameProperty.SacredBeast);
