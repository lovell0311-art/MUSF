...
namespace ETHotfix
{
    ...
    /// 对人防御率提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute902)]
    public partial class C_BattleMaster_MasterAttribute902 : C_BattleMaster
    {
    ...
    /// 对人防御率提高
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute902
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute902] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
