...
namespace ETHotfix
{
    ...
    /// 聚灵精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_JuLing_Master530)]
    public partial class C_BattleMaster_Skill_JuLing_Master530 : C_BattleMaster
    {
    ...
    /// 聚灵精通
    /// </summary>
    public partial class C_BattleMaster_Skill_JuLing_Master530
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 聚灵技能的目标增加1个，技能攻击力增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_JuLing_Master530] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
