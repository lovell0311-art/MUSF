...
namespace ETHotfix
{
    ...
    /// 
    /// </summary>
    [PropertyNumerialAttribute(BindId = (int)E_GameProperty.MinMagicAtteckPct)]
    public partial class C_PropertyNumerial_MinMagicAtteckPct : C_PropertyNumerial
    {
        ...
        {
            int mResult = 0;
            var mGameProperty = E_GameProperty.MinMagicAtteckPct;
