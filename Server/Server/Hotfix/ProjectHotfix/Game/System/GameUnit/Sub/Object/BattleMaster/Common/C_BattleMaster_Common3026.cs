...
namespace ETHotfix
{
    ...
    /// 最小魔力提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BeCommon3026)]
    public partial class C_BattleMaster_BeCommon3026 : C_BattleMaster
    {
    ...
    /// 最小魔力提高
    /// </summary>
    public partial class C_BattleMaster_BeCommon3026
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BeCommon3026] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
