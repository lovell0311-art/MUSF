...
namespace ETHotfix
{
    ...
    /// 地牢术强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_DiLaoShuStrengthen45)]
    public partial class C_BattleMaster_Skill_DiLaoShuStrengthen45 : C_BattleMaster
    {
    ...
    /// 地牢术强化
    /// </summary>
    public partial class C_BattleMaster_Skill_DiLaoShuStrengthen45
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 地牢术技能的伤害增加{0:F}，冷却时间变更为3秒。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DiLaoShuStrengthen45] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
