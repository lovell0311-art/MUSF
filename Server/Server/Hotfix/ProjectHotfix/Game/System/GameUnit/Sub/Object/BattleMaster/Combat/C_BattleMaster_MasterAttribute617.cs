...
namespace ETHotfix
{
    ...
    /// 敏捷属性增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute617)]
    public partial class C_BattleMaster_MasterAttribute617 : C_BattleMaster
    {
    ...
    /// 敏捷属性增加
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute617
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute617] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
