...
namespace ETHotfix
{
    ...
    /// 毒咒 Curse
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.Curse10004)]
    public partial class C_HeroSkill_Curse10004 : C_HeroSkillSource
    {
    ...
    /// 毒咒
    /// </summary>
    public partial class C_HeroSkill_Curse10004
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                else if (mSpecialAttack == E_GameProperty.LucklyAttackRate)
                {
                ...
                {
                    mBeAttacker.AddHealthState(E_BattleSkillStats.Curse, (int)(mHurtValue * 0.5f), mConfig.PersistentTime, 0, mCreateFunc, b_BattleComponent);
