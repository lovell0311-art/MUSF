...
namespace ETHotfix
{
    ...
    /// 咒诅的痛苦
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ZuZhouDeTongKu_Master562)]
    public partial class C_BattleMaster_Skill_ZuZhouDeTongKu_Master562 : C_BattleMaster
    {
    ...
    /// 咒诅的痛苦
    /// </summary>
    public partial class C_BattleMaster_Skill_ZuZhouDeTongKu_Master562
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 攻击4格以外的目标时，魔力和咒诅力增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ZuZhouDeTongKu_Master562] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
