...
namespace ETHotfix
{
    ...
    /// 敏捷属性增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseAgility17)]
    public partial class C_BattleMaster_IncreaseAgility17 : C_BattleMaster
    {
    ...
    /// 敏捷属性增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseAgility17
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseAgility17] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
