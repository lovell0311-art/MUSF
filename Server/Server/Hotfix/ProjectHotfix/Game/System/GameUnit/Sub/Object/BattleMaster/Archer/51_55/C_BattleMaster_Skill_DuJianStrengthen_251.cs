...
namespace ETHotfix
{
    ...
    /// 毒箭强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_DuJianStrengthen_251)]
    public partial class C_BattleMaster_Skill_DuJianStrengthen_251 : C_BattleMaster
    {
    ...
    /// 毒箭强化
    /// </summary>
    public partial class C_BattleMaster_Skill_DuJianStrengthen_251
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DuJianStrengthen_251] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
