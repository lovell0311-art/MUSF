...
namespace ETHotfix
{
    ...
    /// 冰箭强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_BingJianStrengthen_237)]
    public partial class C_BattleMaster_Skill_BingJianStrengthen_237 : C_BattleMaster
    {
    ...
    /// 冰箭强化
    /// </summary>
    public partial class C_BattleMaster_Skill_BingJianStrengthen_237
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_BingJianStrengthen_237] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
