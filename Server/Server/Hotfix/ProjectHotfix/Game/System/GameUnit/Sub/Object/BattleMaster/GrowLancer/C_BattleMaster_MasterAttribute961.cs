...
namespace ETHotfix
{
    ...
    /// 受伤生命力回复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute961)]
    public partial class C_BattleMaster_MasterAttribute961 : C_BattleMaster
    {
    ...
    /// 受伤生命力回复
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute961
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute961] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
