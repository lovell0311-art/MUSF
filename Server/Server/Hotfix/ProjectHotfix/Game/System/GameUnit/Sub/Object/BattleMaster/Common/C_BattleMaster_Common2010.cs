...
namespace ETHotfix
{
    ...
    /// 陨石雨
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Common2010)]
    public partial class C_BattleMaster_Common2010 : C_BattleMaster
    {
    ...
    /// 陨石雨
    /// </summary>
    public partial class C_BattleMaster_Common2010
    {
        #region try
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Common2010] = 1;

            var mStudySkillId = (int)E_HeroSkillId.JianYu126;
            if (b_Attacker.Data.PlayerTypeId == (int)E_GameOccupation.Spell)
            {
                mStudySkillId = (int)E_HeroSkillId.YunXingYu30;
            ...
            {
                mStudySkillId = (int)E_HeroSkillId.YunXingYu336;
