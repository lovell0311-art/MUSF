...
namespace ETHotfix
{
    ...
    /// 
    /// </summary>
    [PropertyNumerialAttribute(BindId = (int)E_GameProperty.LucklyAttackHurtValueIncrease)]
    public partial class C_PropertyNumerial_LucklyAttackHurtValueIncrease : C_PropertyNumerial
    {
