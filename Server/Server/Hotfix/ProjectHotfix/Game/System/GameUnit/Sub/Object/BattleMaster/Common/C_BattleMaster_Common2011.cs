...
namespace ETHotfix
{
    ...
    /// 陨石雨
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Common2011)]
    public partial class C_BattleMaster_Common2011 : C_BattleMaster
    {
    ...
    /// 陨石雨
    /// </summary>
    public partial class C_BattleMaster_Common2011
    {
        #region try
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Common2011] = 1;

            var mStudySkillId = (int)E_HeroSkillId.JianYu230;
            var mReadConfigComponent = Root.MainFactory.GetCustomComponent<CustomFrameWork.Component.ReadConfigComponent>();
