...
namespace ETHotfix
{
    ...
    /// 
    /// </summary>
    [PropertyNumerialAttribute(BindId = (int)E_GameProperty.ExcellentAttackHurtValueIncrease)]
    public partial class C_PropertyNumerial_ExcellentAttackHurtValueIncrease : C_PropertyNumerial
    {
