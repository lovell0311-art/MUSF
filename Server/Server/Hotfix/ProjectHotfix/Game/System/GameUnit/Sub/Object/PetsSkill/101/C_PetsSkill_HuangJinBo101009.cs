...
namespace ETHotfix
{
    ...
    /// 黑龙波
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_Pets_SKILL_Id.HuangJinBo)]
    public partial class C_PetsSkill_HuangJinBo101009 : C_HeroSkillSource
    {
    ...
    /// 黑龙波
    /// </summary>
    public partial class C_PetsSkill_HuangJinBo101009
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                var mCenterPos = b_BattleComponent.Parent.GetFindTheWay2D(b_Attacker).Vector2Pos;
                ...
                for (int i = 0, len = mMapFieldlist.Length; i < len; i++)
                {
                    ...
                    if (false && mMapField.FieldPetsDic.Count > 0)
                    {
                        ...
                        for (int j = 0, jlen = mFieldPetslist.Length; j < jlen; j++)
                        {
                            ...
                            if(mCurrentTemp.GamePlayer.Player == null) continue;
