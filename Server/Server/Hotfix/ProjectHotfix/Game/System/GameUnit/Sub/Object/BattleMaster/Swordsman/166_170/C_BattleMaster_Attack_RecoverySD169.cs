...
namespace ETHotfix
{
    ...
    /// 防御恢复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Attack_RecoverySD169)]
    public partial class C_BattleMaster_Attack_RecoverySD169 : C_BattleMaster
    {
    ...
    /// 防御恢复
    /// </summary>
    public partial class C_BattleMaster_Attack_RecoverySD169
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Attack_RecoverySD169] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
