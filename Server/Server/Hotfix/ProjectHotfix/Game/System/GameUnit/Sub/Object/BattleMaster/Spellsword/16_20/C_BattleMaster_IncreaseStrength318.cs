...
namespace ETHotfix
{
    ...
    /// 力量属性增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseStrength318)]
    public partial class C_BattleMaster_IncreaseStrength318 : C_BattleMaster
    {
    ...
    /// 力量属性增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseStrength318
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseStrength318] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
