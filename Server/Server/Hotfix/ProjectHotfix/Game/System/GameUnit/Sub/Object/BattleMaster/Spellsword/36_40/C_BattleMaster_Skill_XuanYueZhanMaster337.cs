...
namespace ETHotfix
{
    ...
    /// 玄月斩精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_XuanYueZhanMaster337)]
    public partial class C_BattleMaster_Skill_XuanYueZhanMaster337 : C_BattleMaster
    {
    ...
    /// 玄月斩精通
    /// </summary>
    public partial class C_BattleMaster_Skill_XuanYueZhanMaster337
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 玄月斩技能使用时防御力减少效果提高{0:F}%

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XuanYueZhanMaster337] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
