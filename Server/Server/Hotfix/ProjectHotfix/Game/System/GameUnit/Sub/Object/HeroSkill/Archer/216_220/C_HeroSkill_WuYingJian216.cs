...
namespace ETHotfix
{
    ...
    /// 无影箭
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.WuYingJian)]
    public partial class C_HeroSkill_WuYingJian216 : C_HeroSkillSource
    {
    ...
    /// 无影箭
    /// </summary>
    public partial class C_HeroSkill_WuYingJian216
    {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
                {
                    ...
                    mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                    {
                        ...
                        b_CombatSource.RemoveHealthState(E_BattleSkillStats.WuYingJian216, b_BattleComponent);
                    ...
                    mBattleSyncTimer.SyncAction = (b_CombatSource, b_BattleComponent, b_TimerTask, b_TimeTick) =>
                    {
                        ...
                        if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.WuYingJian216, out var hp_Curse) == false)
                        {
                ...
                mBeAttacker.AddHealthState(E_BattleSkillStats.WuYingJian216, 0, mConfig.PersistentTime, 0, mCreateFunc, b_BattleComponent);
