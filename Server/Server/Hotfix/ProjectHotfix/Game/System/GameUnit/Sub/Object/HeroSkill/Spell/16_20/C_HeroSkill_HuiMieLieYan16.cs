...
namespace ETHotfix
{
    ...
    /// 毁灭烈焰
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.HuiMieLieYan)]
    public partial class C_HeroSkill_HuiMieLieYan16 : C_HeroSkillSource
    {
    ...
    /// 毁灭烈焰
    /// </summary>
    public partial class C_HeroSkill_HuiMieLieYan16
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_HuiMieLieYanStrengthen28))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HuiMieLieYanStrengthen28];
