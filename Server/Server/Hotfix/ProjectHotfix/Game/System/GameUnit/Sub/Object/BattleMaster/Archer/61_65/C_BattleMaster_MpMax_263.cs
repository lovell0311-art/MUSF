...
namespace ETHotfix
{
    ...
    /// 魔法值增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_MpMax_263)]
    public partial class C_BattleMaster_MpMax_263 : C_BattleMaster
    {
    ...
    /// 魔法值增加
    /// </summary>
    public partial class C_BattleMaster_MpMax_263
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_MpMax_263] = 100;
