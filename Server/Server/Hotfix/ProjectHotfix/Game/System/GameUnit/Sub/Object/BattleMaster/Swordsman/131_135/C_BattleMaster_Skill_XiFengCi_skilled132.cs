...
namespace ETHotfix
{
    ...
    /// 袭风刺熟练
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_XiFengCi_skilled132)]
    public partial class C_BattleMaster_Skill_XiFengCi_skilled132 : C_BattleMaster
    {
    ...
    /// 袭风刺熟练
    /// </summary>
    public partial class C_BattleMaster_Skill_XiFengCi_skilled132
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XiFengCi_skilled132] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
