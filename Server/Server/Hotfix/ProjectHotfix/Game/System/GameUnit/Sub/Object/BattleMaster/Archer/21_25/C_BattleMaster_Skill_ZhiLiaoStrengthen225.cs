...
namespace ETHotfix
{
    ...
    /// 治疗强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ZhiLiaoStrengthen225)]
    public partial class C_BattleMaster_Skill_ZhiLiaoStrengthen225 : C_BattleMaster
    {
    ...
    /// 治疗强化
    /// </summary>
    public partial class C_BattleMaster_Skill_ZhiLiaoStrengthen225
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ZhiLiaoStrengthen225] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
