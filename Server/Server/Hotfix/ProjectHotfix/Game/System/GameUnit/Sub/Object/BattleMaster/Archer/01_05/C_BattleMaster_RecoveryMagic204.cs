...
namespace ETHotfix
{
    ...
    /// 自动魔力恢复力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.RecoveryMagic204)]
    public partial class C_BattleMaster_RecoveryMagic204 : C_BattleMaster
    {
    ...
    /// 自动魔力恢复力增加
    /// </summary>
    public partial class C_BattleMaster_RecoveryMagic204
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.RecoveryMagic204] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
