...
namespace ETHotfix
{
    ...
    /// 昏睡术强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_HunShuiShu_Strengthen528)]
    public partial class C_BattleMaster_Skill_HunShuiShu_Strengthen528 : C_BattleMaster
    {
    ...
    /// 昏睡术强化
    /// </summary>
    public partial class C_BattleMaster_Skill_HunShuiShu_Strengthen528
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HunShuiShu_Strengthen528] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
