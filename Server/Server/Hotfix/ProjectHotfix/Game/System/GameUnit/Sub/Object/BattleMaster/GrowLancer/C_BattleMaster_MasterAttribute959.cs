...
namespace ETHotfix
{
    ...
    /// 幸运一击几率提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute959)]
    public partial class C_BattleMaster_MasterAttribute959 : C_BattleMaster
    {
    ...
    /// 幸运一击几率提高
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute959
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute959] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
