...
namespace ETHotfix
{
    ...
    /// 魔法领域强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_MoFaLingYuMaster346)]
    public partial class C_BattleMaster_Skill_MoFaLingYuMaster346 : C_BattleMaster
    {
    ...
    /// 魔法领域强化
    /// </summary>
    public partial class C_BattleMaster_Skill_MoFaLingYuMaster346
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_MoFaLingYuMaster346] = 1;
