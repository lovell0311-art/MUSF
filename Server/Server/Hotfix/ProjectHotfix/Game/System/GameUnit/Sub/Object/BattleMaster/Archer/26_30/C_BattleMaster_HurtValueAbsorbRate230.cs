...
namespace ETHotfix
{
    ...
    /// 吸收伤害
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.HurtValueAbsorbRate230)]
    public partial class C_BattleMaster_HurtValueAbsorbRate230 : C_BattleMaster
    {
    ...
    /// 吸收伤害
    /// </summary>
    public partial class C_BattleMaster_HurtValueAbsorbRate230
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.HurtValueAbsorbRate230] = 500;
