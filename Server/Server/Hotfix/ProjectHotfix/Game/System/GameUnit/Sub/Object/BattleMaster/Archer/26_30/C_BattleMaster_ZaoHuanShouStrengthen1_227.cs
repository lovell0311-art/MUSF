...
namespace ETHotfix
{
    ...
    /// 召唤兽强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ZaoHuanShouStrengthen1_227)]
    public partial class C_BattleMaster_ZaoHuanShouStrengthen1_227 : C_BattleMaster
    {
    ...
    /// 召唤兽强化
    /// </summary>
    public partial class C_BattleMaster_ZaoHuanShouStrengthen1_227
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ZaoHuanShouStrengthen1_227] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
