...
namespace ETHotfix
{
    ...
    /// 最大生命力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseHpMax531)]
    public partial class C_BattleMaster_IncreaseHpMax531 : C_BattleMaster
    {
    ...
    /// 最大生命力增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseHpMax531
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseHpMax531] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
            if (b_AddPoint)
            {
