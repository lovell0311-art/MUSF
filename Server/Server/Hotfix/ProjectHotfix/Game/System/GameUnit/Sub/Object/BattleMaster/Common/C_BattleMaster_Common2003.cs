...
namespace ETHotfix
{
    ...
    /// 血量增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Common2003)]
    public partial class C_BattleMaster_Common2003 : C_BattleMaster
    {
    ...
    /// 血量增加
    /// </summary>
    public partial class C_BattleMaster_Common2003
    {
        #region try
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Common2003] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
