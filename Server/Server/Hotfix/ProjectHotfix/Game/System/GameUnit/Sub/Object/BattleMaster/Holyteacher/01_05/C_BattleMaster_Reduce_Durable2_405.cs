...
namespace ETHotfix
{
    ...
    /// 减少耐久2
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Reduce_Durable2_405)]
    public partial class C_BattleMaster_Reduce_Durable2_405 : C_BattleMaster
    {
    ...
    /// 减少耐久2
    /// </summary>
    public partial class C_BattleMaster_Reduce_Durable2_405
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Reduce_Durable2_405] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
