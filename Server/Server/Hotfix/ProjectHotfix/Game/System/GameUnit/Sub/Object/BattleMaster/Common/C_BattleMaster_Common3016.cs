...
namespace ETHotfix
{
    ...
    /// 最大魔力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BeCommon3016)]
    public partial class C_BattleMaster_BeCommon3016 : C_BattleMaster
    {
    ...
    /// 最大魔力增加
    /// </summary>
    public partial class C_BattleMaster_BeCommon3016
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BeCommon3016] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
