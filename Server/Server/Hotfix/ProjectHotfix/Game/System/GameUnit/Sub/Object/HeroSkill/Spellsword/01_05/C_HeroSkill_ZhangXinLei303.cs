...
namespace ETHotfix
{
    ...
    /// 掌心雷
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.ZhangXinLei303)]
    public partial class C_HeroSkill_ZhangXinLei303 : C_HeroSkillSource
    {
    ...
    /// 掌心雷
    /// </summary>
    public partial class C_HeroSkill_ZhangXinLei303
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int mHurtValue = mVirtualHurtValue + mWillpower;
                var mAddScale = mConfig.OtherDataDic[11];
                if (mAddScale != 100)
                    mHurtValue = (int)(mHurtValue * mAddScale * 0.01f);

                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_ZhuangXinLeiStrengthen327))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ZhuangXinLeiStrengthen327];
