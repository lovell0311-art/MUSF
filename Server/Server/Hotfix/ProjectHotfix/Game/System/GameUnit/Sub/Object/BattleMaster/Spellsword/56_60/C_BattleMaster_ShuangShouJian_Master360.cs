...
namespace ETHotfix
{
    ...
    /// 双手杖精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ShuangShouJian_Master360)]
    public partial class C_BattleMaster_ShuangShouJian_Master360 : C_BattleMaster
    {
    ...
    /// 双手杖精通
    /// </summary>
    public partial class C_BattleMaster_ShuangShouJian_Master360
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ShuangShouJian_Master360] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
