...
namespace ETHotfix
{
    ...
    /// 杀怪时SD恢复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.KillRecoverySD154)]
    public partial class C_BattleMaster_KillRecoverySD154 : C_BattleMaster
    {
    ...
    /// 杀怪时SD恢复
    /// </summary>
    public partial class C_BattleMaster_KillRecoverySD154
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.KillRecoverySD154] = (int)(1f / mConfig.OtherDataDic[mMasterLevel] * 10000 * 10000);
