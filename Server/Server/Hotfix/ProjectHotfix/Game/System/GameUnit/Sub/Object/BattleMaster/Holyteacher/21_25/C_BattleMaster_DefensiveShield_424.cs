...
namespace ETHotfix
{
    ...
    /// 防盾
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.DefensiveShield_424)]
    public partial class C_BattleMaster_DefensiveShield_424 : C_BattleMaster
    {
    ...
    /// 防盾
    /// </summary>
    public partial class C_BattleMaster_DefensiveShield_424
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.DefensiveShield_424] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
