...
namespace ETHotfix
{
    ...
    /// 次元之翼攻击强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Equipment_Attack_ChiYuanZhiYi_520)]
    public partial class C_BattleMaster_Equipment_Attack_ChiYuanZhiYi_520 : C_BattleMaster
    {
    ...
    /// 次元之翼攻击强化
    /// </summary>
    public partial class C_BattleMaster_Equipment_Attack_ChiYuanZhiYi_520
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 次元之翼装备时,魔力和诅咒力增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Equipment_Attack_ChiYuanZhiYi_520] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
