...
namespace ETHotfix
{
    ...
    /// 三重箭
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_SanChongJian_242)]
    public partial class C_BattleMaster_Skill_SanChongJian242 : C_BattleMaster
    {
    ...
    /// 三重箭
    /// </summary>
    public partial class C_BattleMaster_Skill_SanChongJian242
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_SanChongJian242] = 1;

            var mStudySkillId = (int)E_HeroSkillId.SanChongJian229;
            var mReadConfigComponent = Root.MainFactory.GetCustomComponent<CustomFrameWork.Component.ReadConfigComponent>();
