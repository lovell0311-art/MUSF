...
namespace ETHotfix
{
    ...
    /// 破御阵精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_PoYuZhen_Master539)]
    public partial class C_BattleMaster_Skill_PoYuZhen_Master539 : C_BattleMaster
    {
    ...
    /// 破御阵精通
    /// </summary>
    public partial class C_BattleMaster_Skill_PoYuZhen_Master539
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用破御阵时属性防御力降低效果追加适用 {0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_PoYuZhen_Master539] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
