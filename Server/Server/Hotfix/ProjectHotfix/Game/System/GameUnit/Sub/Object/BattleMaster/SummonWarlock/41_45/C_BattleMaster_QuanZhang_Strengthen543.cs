...
namespace ETHotfix
{
    ...
    /// 权杖强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.QuanZhang_Strengthen543)]
    public partial class C_BattleMaster_QuanZhang_Strengthen543 : C_BattleMaster
    {
    ...
    /// 权杖强化
    /// </summary>
    public partial class C_BattleMaster_QuanZhang_Strengthen543
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.QuanZhang_Strengthen543] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
