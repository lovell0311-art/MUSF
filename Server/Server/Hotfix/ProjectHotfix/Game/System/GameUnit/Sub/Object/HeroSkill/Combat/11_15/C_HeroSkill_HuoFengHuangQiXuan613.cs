...
namespace ETHotfix
{
    ...
    /// 火凤凰气旋
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.HuoFengHuangQiXuan613)]
    public partial class C_HeroSkill_HuoFengHuangQiXuan613 : C_HeroSkillSource
    {
    ...
    /// 火凤凰气旋
    /// </summary>
    public partial class C_HeroSkill_HuoFengHuangQiXuan613
    {
                ...
                for (int i = 0, len = mMapFieldlist.Length; i < len; i++)
                {
                    ...
                    if (mMapField.FieldEnemyDic.Count > 0)
                    {
                        ...
                        for (int j = 0, jlen = mFieldEnemylist.Length; j < jlen; j++)
                        {
                            ...
                            for (int zUse = 0; zUse < mUseCount; zUse++)
                            {
                                // 是否命中
