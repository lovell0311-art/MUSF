...
namespace ETHotfix
{
    ...
    /// 剑之愤怒精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.SKill_JianZhiFenNu_master123)]
    public partial class C_BattleMaster_SKill_JianZhiFenNu_master123 : C_BattleMaster
    {
    ...
    /// 剑之愤怒精通
    /// </summary>
    public partial class C_BattleMaster_SKill_JianZhiFenNu_master123
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用剑之愤怒时 袭风刺系的攻击技能使用距离追加增加1点。

            b_Attacker.BattleMasteryDic[E_BattleMasteryState.SKill_JianZhiFenNu_master123] = 1;
