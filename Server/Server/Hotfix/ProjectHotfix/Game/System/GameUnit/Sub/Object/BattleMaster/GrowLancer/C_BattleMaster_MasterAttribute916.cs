...
namespace ETHotfix
{
    ...
    /// 体力属性增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute916)]
    public partial class C_BattleMaster_MasterAttribute916 : C_BattleMaster
    {
    ...
    /// 体力属性增加
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute916
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute916] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
