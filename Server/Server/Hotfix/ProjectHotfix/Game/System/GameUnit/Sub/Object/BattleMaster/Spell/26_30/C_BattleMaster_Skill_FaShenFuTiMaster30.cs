...
namespace ETHotfix
{
    ...
    /// 法神附体精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_FaShenFuTiMaster30)]
    public partial class C_BattleMaster_Skill_FaShenFuTiMaster30 : C_BattleMaster
    {
    ...
    /// 法神附体精通
    /// </summary>
    public partial class C_BattleMaster_Skill_FaShenFuTiMaster30
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_FaShenFuTiMaster30] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
