...
namespace ETHotfix
{
    ...
    /// 幸运一击几率提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseXingYunYiJiRate463)]
    public partial class C_BattleMaster_IncreaseXingYunYiJiRate463 : C_BattleMaster
    {
    ...
    /// 幸运一击几率提高
    /// </summary>
    public partial class C_BattleMaster_IncreaseXingYunYiJiRate463
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseXingYunYiJiRate463] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0) /** 100*/;
