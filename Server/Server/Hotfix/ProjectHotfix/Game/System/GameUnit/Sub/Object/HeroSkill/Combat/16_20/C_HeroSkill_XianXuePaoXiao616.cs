...
namespace ETHotfix
{
    ...
    /// 鲜血咆哮
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.XianXuePaoXiao616)]
    public partial class C_HeroSkill_XianXuePaoXiao616 : C_HeroSkillSource
    {
    ...
    /// 鲜血咆哮
    /// </summary>
    public partial class C_HeroSkill_XianXuePaoXiao616
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int mMagicHurtValue =200;
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute640))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute640];
                    mMagicHurtValue += mMasteryValue;
                }
                Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
                {
                    ...
                    mBattleSyncTimer.SyncWaitTime = 500;
                    ...
                    mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                    {
                        ...
                        b_CombatSource.RemoveHealthState(E_BattleSkillStats.XianXuePaoXiao616, b_BattleComponent);
                    ...
                    mBattleSyncTimer.SyncAction = (b_CombatSource, b_BattleComponent, b_TimerTask, b_TimeTick) =>
                    {
                        ...
                        if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.XianXuePaoXiao616, out var hp_Curse) == false)
                        {
                ...
                mBeAttacker.AddHealthState(E_BattleSkillStats.XianXuePaoXiao616, mMagicHurtValue, 10*1000, 0, mCreateFunc, b_BattleComponent);
