...
namespace ETHotfix
{
    ...
    /// 嗜血之龙
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.ShiXueZhiLong606)]
    public partial class C_HeroSkill_ShiXueZhiLong606 : C_HeroSkillSource
    {
    ...
    /// 嗜血之龙
    /// </summary>
    public partial class C_HeroSkill_ShiXueZhiLong606
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute638))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute639];
                ...
                var mRandomResult = Help_RandomHelper.Range(0, 100);
                if (mRandomResult < 50)
                {
