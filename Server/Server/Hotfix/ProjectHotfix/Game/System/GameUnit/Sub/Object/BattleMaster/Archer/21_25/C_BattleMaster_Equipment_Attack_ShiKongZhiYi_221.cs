...
namespace ETHotfix
{
    ...
    /// 时空之翼攻击强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Equipment_Attack_ShiKongZhiYi_221)]
    public partial class C_BattleMaster_Equipment_Attack_ShiKongZhiYi_221 : C_BattleMaster
    {
    ...
    /// 时空之翼攻击强化
    /// </summary>
    public partial class C_BattleMaster_Equipment_Attack_ShiKongZhiYi_221
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Equipment_Attack_ShiKongZhiYi_221] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
