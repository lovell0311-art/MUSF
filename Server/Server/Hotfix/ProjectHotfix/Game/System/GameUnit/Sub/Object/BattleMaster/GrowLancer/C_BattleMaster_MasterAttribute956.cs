...
namespace ETHotfix
{
    ...
    /// 杀怪时魔力恢复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute956)]
    public partial class C_BattleMaster_MasterAttribute956 : C_BattleMaster
    {
    ...
    /// 杀怪时魔力恢复
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute956
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 杀死怪物后，恢复最大魔力/{0:F}的魔力值。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute956] = (int)(1f / mConfig.OtherDataDic[mMasterLevel] * 10000 * 10000);
