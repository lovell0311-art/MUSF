...
namespace ETHotfix
{
    ...
    /// 闪电轰顶
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.ShanDianHongDing324)]
    public partial class C_HeroSkill_ShanDianHongDing324 : C_HeroSkillSource
    {
    ...
    /// 闪电轰顶
    /// </summary>
    public partial class C_HeroSkill_ShanDianHongDing324
    {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Action<long, long, long> mSyncActionChild = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
                {
                    ...
                    int GetHurtValue(E_GameProperty b_SpecialAttack)
                    {
                        ...
                        if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_ShanDianHongDingStrengthen338))
                        {
                            int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ShanDianHongDingStrengthen338];
