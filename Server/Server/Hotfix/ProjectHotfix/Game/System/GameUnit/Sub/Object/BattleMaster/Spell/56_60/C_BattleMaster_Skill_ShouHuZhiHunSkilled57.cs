...
namespace ETHotfix
{
    ...
    /// 守护之魂熟练
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ShouHuZhiHunSkilled57)]
    public partial class C_BattleMaster_Skill_ShouHuZhiHunSkilled57 : C_BattleMaster
    {
    ...
    /// 守护之魂熟练
    /// </summary>
    public partial class C_BattleMaster_Skill_ShouHuZhiHunSkilled57
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ShouHuZhiHunSkilled57] = mConfig.OtherDataDic[mMasterLevel] / 10;
