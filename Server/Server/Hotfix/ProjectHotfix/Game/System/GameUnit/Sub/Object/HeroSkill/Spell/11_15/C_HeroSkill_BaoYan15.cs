...
namespace ETHotfix
{
    ...
    /// 爆炎
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.BaoYan)]
    public partial class C_HeroSkill_BaoYan15 : C_HeroSkillSource
    {
    ...
    /// 爆炎
    /// </summary>
    public partial class C_HeroSkill_BaoYan15
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_BaoYanStrengthen29))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_BaoYanStrengthen29];
