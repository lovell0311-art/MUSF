...
namespace ETHotfix
{
    ...
    /// 法神附体强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_FaShenFuTiStrengthen27)]
    public partial class C_BattleMaster_Skill_FaShenFuTiStrengthen27 : C_BattleMaster
    {
    ...
    /// 法神附体强化
    /// </summary>
    public partial class C_BattleMaster_Skill_FaShenFuTiStrengthen27
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 法神附体技能使用时最大魔法攻击力提高{0:F}%。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_FaShenFuTiStrengthen27] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
