...
namespace ETHotfix
{
    ...
    /// 召唤兽强化2
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ZaoHuanShouStrengthen2_231)]
    public partial class C_BattleMaster_ZaoHuanShouStrengthen2_231 : C_BattleMaster
    {
    ...
    /// 召唤兽强化2
    /// </summary>
    public partial class C_BattleMaster_ZaoHuanShouStrengthen2_231
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ZaoHuanShouStrengthen2_231] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
