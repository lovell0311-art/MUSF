...
namespace ETHotfix
{
    ...
    /// 幻影移行
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_HuanYingYiXing_249)]
    public partial class C_BattleMaster_Skill_HuanYingYiXing_249 : C_BattleMaster
    {
    ...
    /// 幻影移行
    /// </summary>
    public partial class C_BattleMaster_Skill_HuanYingYiXing_249
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用技能时，往选择的方向5个迅速移动。3秒冷却时间。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HuanYingYiXing_249] = 1;

            var mStudySkillId = (int)E_HeroSkillId.ShunJianYiDong227;
            var mReadConfigComponent = Root.MainFactory.GetCustomComponent<CustomFrameWork.Component.ReadConfigComponent>();
