...
namespace ETHotfix
{
    ...
    /// 血腥风暴强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_XueXingFengBao_Strengthening142)]
    public partial class C_BattleMaster_Skill_XueXingFengBao_Strengthening142 : C_BattleMaster
    {
    ...
    /// 血腥风暴强化
    /// </summary>
    public partial class C_BattleMaster_Skill_XueXingFengBao_Strengthening142
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XueXingFengBao_Strengthening142] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
