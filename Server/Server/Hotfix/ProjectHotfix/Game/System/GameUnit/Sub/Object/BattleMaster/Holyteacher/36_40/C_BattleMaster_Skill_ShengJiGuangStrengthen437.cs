...
namespace ETHotfix
{
    ...
    /// 圣极光强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ShengJiGuangStrengthen437)]
    public partial class C_BattleMaster_Skill_ShengJiGuangStrengthen437 : C_BattleMaster
    {
    ...
    /// 圣极光强化
    /// </summary>
    public partial class C_BattleMaster_Skill_ShengJiGuangStrengthen437
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ShengJiGuangStrengthen437] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
