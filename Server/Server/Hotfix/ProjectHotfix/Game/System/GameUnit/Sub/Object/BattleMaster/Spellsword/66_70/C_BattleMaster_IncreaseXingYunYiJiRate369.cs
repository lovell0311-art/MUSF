...
namespace ETHotfix
{
    ...
    /// 幸运一击几率提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseXingYunYiJiRate369)]
    public partial class C_BattleMaster_IncreaseXingYunYiJiRate369 : C_BattleMaster
    {
    ...
    /// 幸运一击几率提高
    /// </summary>
    public partial class C_BattleMaster_IncreaseXingYunYiJiRate369
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseXingYunYiJiRate369] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0) /** 100*/;
