...
namespace ETHotfix
{
    ...
    /// 
    /// </summary>
    [PropertyNumerialAttribute(BindId = (int)E_GameProperty.MinMagicAtteck)]
    public partial class C_PropertyNumerial_MinMagicAtteck : C_PropertyNumerial
    {
        public override int Run(GamePlayer b_Component, bool b_HasTemporary = true)
        {
            int mResult = 0;
            var mGameProperty = E_GameProperty.MinMagicAtteck;
            ...
            if (b_Component.BattleMasteryDic.TryGetValue(E_BattleMasteryState.BeCommon3026, out var mMasteryValue1))
            {
                    ...
                    case E_GameOccupation.Spell:
                        {
                            ...
                            if (b_Component.BattleMasteryDic.TryGetValue(E_BattleMasteryState.IncreaseMinMagic58, out mMasteryValue))
                            {
                                mResult += mMasteryValue;
                            }
                    ...
                    case E_GameOccupation.Spellsword:
                        {
                            ...
                            if (b_Component.BattleMasteryDic.TryGetValue(E_BattleMasteryState.IncreaseMinMagic364, out mMasteryValue))
                            {
                                mResult += mMasteryValue;
                            }
                    ...
                    case E_GameOccupation.SummonWarlock:
                        {
                            ...
                            if (b_Component.BattleMasteryDic.TryGetValue(E_BattleMasteryState.IncreaseMinMagicAndDamnation552, out mMasteryValue))
                            {
                                mResult += mMasteryValue;
                            }
