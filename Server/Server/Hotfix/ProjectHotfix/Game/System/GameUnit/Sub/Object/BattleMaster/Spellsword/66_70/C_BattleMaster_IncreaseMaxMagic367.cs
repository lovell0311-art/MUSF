...
namespace ETHotfix
{
    ...
    /// 最大魔力提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseMaxMagic367)]
    public partial class C_BattleMaster_IncreaseMaxMagic367 : C_BattleMaster
    {
    ...
    /// 最大魔力提高
    /// </summary>
    public partial class C_BattleMaster_IncreaseMaxMagic367
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseMaxMagic367] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
