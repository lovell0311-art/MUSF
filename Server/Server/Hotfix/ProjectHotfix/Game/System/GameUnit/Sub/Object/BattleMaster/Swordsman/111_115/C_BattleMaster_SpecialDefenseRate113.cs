...
namespace ETHotfix
{
    ...
    /// 整套防御力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.SpecialDefenseRate113)]
    public partial class C_BattleMaster_SpecialDefenseRate113 : C_BattleMaster
    {
    ...
    /// 整套防御力增加
    /// </summary>
    public partial class C_BattleMaster_SpecialDefenseRate113
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.SpecialDefenseRate113] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
