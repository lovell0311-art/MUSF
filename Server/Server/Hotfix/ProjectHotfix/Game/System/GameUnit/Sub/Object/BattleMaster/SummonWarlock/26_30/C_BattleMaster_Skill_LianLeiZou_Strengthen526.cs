...
namespace ETHotfix
{
    ...
    /// 链雷咒强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_LianLeiZou_Strengthen526)]
    public partial class C_BattleMaster_Skill_LianLeiZou_Strengthen526 : C_BattleMaster
    {
    ...
    /// 链雷咒强化
    /// </summary>
    public partial class C_BattleMaster_Skill_LianLeiZou_Strengthen526
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_LianLeiZou_Strengthen526] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
