...
namespace ETHotfix
{
    ...
    /// 天堂之光
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_Pets_SKILL_Id.HeavenlyLight)]
    public partial class C_PetsSkill_HeavenlyLight101005 : C_HeroSkillSource
    {
    ...
    /// 天堂之光
    /// </summary>
    public partial class C_PetsSkill_HeavenlyLight101005
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            {
                //b_Attacker.GamePropertyDic[E_GameProperty.InjuryValueRate_Reduce] += mConfig.OtherDataDic[2];
                b_Attacker.GamePropertyDic[E_GameProperty.Defense] += mConfig.OtherDataDic[2];
