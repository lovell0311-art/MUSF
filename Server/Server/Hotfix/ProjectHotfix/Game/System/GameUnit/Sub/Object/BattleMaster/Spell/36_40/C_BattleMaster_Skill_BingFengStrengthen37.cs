...
namespace ETHotfix
{
    ...
    /// 冰封强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_BingFengStrengthen37)]
    public partial class C_BattleMaster_Skill_BingFengStrengthen37 : C_BattleMaster
    {
    ...
    /// 冰封强化
    /// </summary>
    public partial class C_BattleMaster_Skill_BingFengStrengthen37
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_BingFengStrengthen37] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
