...
namespace ETHotfix
{
    ...
    /// 飓风刺
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.JuFengCi708)]
    public partial class C_HeroSkill_JuFengCi708 : C_HeroSkillSource
    {
    ...
    /// 飓风刺
    /// </summary>
    public partial class C_HeroSkill_JuFengCi708
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute937))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute937];
