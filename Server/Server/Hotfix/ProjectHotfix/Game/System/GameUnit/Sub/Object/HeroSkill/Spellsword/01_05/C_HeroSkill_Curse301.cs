...
namespace ETHotfix
{
    ...
    /// 毒咒 Curse
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.Curse_301)]
    public partial class C_HeroSkill_Curse_301 : C_HeroSkillSource
    {
    ...
    /// 毒咒
    /// </summary>
    public partial class C_HeroSkill_Curse_301
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                else if (mSpecialAttack == E_GameProperty.ExcellentAttackRate)
                {
                    ...
                    mMagicHurtValue += mMaxMagicAtteckIncrease + b_Attacker.GetNumerialFunc(E_GameProperty.EmbedGreatShotAttack);
                }
                else
                {
                    // 随机魔力伤害
