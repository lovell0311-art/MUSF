...
namespace ETHotfix
{
    ...
    /// 虚弱阵精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_XuRuoZhen_Master538)]
    public partial class C_BattleMaster_Skill_XuRuoZhen_Master538 : C_BattleMaster
    {
    ...
    /// 虚弱阵精通
    /// </summary>
    public partial class C_BattleMaster_Skill_XuRuoZhen_Master538
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用虚弱阵时属性攻击力降低效果追加适用{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XuRuoZhen_Master538] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
