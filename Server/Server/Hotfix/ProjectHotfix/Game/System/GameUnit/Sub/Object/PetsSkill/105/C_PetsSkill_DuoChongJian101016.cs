...
namespace ETHotfix
{
    ...
    /// 多重箭
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_Pets_SKILL_Id.DongChongJian)]
    public partial class C_HeroSkill_DongChongJian101016 : C_HeroSkillSource
    {
    ...
    /// 多重箭
    /// </summary>
    public partial class C_HeroSkill_DongChongJian101016
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Pets mGamePlayer = b_Attacker as Pets;
            int mDamageWait = b_Attacker.GetSkillDamageWait(mConfig.DamageWait);
            //int mAttackTime = (int)(b_Attacker.GetAttackSpeed(true, (E_GameOccupation)mGamePlayer.Data.PlayerTypeId));
            int mAttackTime = (int)(b_Attacker.GetAttackSpeed(true));
