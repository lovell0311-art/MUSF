...
namespace ETHotfix
{
    ...
    /// 防御力提高强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_DefenseIncreaseStrengthen229)]
    public partial class C_BattleMaster_Skill_DefenseIncreaseStrengthen229 : C_BattleMaster
    {
    ...
    /// 防御力提高强化
    /// </summary>
    public partial class C_BattleMaster_Skill_DefenseIncreaseStrengthen229
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DefenseIncreaseStrengthen229] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
