...
namespace ETHotfix
{
    ...
    /// 幻兽
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.HuanShou507)]
    public partial class C_HeroSkill_HuanShou507 : C_HeroSkillSource
    {
    ...
    /// 幻兽
    /// </summary>
    public partial class C_HeroSkill_HuanShou507
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                b_BattleComponent.WaitSync(1500, b_AttackerId, b_BeAttackerId, mSyncActionChild);
                b_BattleComponent.WaitSync(2000, b_AttackerId, b_BeAttackerId, mSyncActionChild);
