...
namespace ETHotfix
{
    ...
    /// 受伤生命力回复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Injure_RecoveryAllHp465)]
    public partial class C_BattleMaster_Injure_RecoveryAllHp465 : C_BattleMaster
    {
    ...
    /// 受伤生命力回复
    /// </summary>
    public partial class C_BattleMaster_Injure_RecoveryAllHp465
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Injure_RecoveryAllHp465] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
