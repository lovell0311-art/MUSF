...
namespace ETHotfix
{
    ...
    /// 智力属性增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseWillpower416)]
    public partial class C_BattleMaster_IncreaseWillpower416 : C_BattleMaster
    {
    ...
    /// 智力属性增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseWillpower416
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseWillpower416] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
