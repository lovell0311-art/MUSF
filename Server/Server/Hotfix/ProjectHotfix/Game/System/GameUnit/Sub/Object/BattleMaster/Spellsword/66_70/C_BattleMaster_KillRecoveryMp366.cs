...
namespace ETHotfix
{
    ...
    /// 杀怪时魔力回复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.KillRecoveryMp366)]
    public partial class C_BattleMaster_KillRecoveryMp366 : C_BattleMaster
    {
    ...
    /// 杀怪时魔力回复
    /// </summary>
    public partial class C_BattleMaster_KillRecoveryMp366
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 杀死怪物后，恢复最大魔力/{0:F}f的魔力值。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.KillRecoveryMp366] = (int)(1f / mConfig.OtherDataDic[mMasterLevel] * 10000 * 10000);
