...
namespace ETHotfix
{
    ...
    /// 天鹰强化(5)
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.TianYing_AttackStrengthen5_456)]
    public partial class C_BattleMaster_TianYing_AttackStrengthen5_456 : C_BattleMaster
    {
    ...
    /// 天鹰强化(5)
    /// </summary>
    public partial class C_BattleMaster_TianYing_AttackStrengthen5_456
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.TianYing_AttackStrengthen5_456] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
