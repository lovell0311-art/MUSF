...
namespace ETHotfix
{
    ...
    /// 陨星雨
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.YunXingYu336)]
    public partial class C_HeroSkill_YunXingYu336 : C_HeroSkillSource
    {
    ...
    /// 陨星雨
    /// </summary>
    public partial class C_HeroSkill_YunXingYu336
    {
        ...
        public override bool TryUse(CombatSource b_Attacker, CombatSource b_BeAttacker, C_FindTheWay2D b_Cell, BattleComponent b_BattleComponent, IActorResponse b_Response)
        {
            ...
            if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Common2010) == false)
            {
