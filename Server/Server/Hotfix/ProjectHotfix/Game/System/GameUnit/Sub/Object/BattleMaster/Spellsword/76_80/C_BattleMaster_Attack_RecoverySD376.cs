...
namespace ETHotfix
{
    ...
    /// sd 防御恢复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Attack_RecoverySD376)]
    public partial class C_BattleMaster_Attack_RecoverySD376 : C_BattleMaster
    {
    ...
    /// sd 防御恢复
    /// </summary>
    public partial class C_BattleMaster_Attack_RecoverySD376
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Attack_RecoverySD376] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
