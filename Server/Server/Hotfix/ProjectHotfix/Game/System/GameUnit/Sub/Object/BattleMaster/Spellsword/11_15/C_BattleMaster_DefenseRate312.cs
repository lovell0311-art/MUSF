...
namespace ETHotfix
{
    ...
    /// 防御成功率提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.DefenseRate312)]
    public partial class C_BattleMaster_DefenseRate312 : C_BattleMaster
    {
    ...
    /// 防御成功率提高
    /// </summary>
    public partial class C_BattleMaster_DefenseRate312
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.DefenseRate312] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
