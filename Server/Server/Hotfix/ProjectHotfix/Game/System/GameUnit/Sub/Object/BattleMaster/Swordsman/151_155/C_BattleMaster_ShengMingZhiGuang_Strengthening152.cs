...
namespace ETHotfix
{
    ...
    /// 生命之光强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ShengMingZhiGuang_Strengthening152)]
    public partial class C_BattleMaster_ShengMingZhiGuang_Strengthening152 : C_BattleMaster
    {
    ...
    /// 生命之光强化
    /// </summary>
    public partial class C_BattleMaster_ShengMingZhiGuang_Strengthening152
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ShengMingZhiGuang_Strengthening152] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
