...
namespace ETHotfix
{
    ...
    /// 体力属性增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseBoneGas16)]
    public partial class C_BattleMaster_IncreaseBoneGas16 : C_BattleMaster
    {
    ...
    /// 体力属性增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseBoneGas16
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseBoneGas16] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
