...
namespace ETHotfix
{
    ...
    /// 破御阵强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_PoYuZhen_Strengthen536)]
    public partial class C_BattleMaster_Skill_PoYuZhen_Strengthen536 : C_BattleMaster
    {
    ...
    /// 破御阵强化
    /// </summary>
    public partial class C_BattleMaster_Skill_PoYuZhen_Strengthen536
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 破御阵技能使用时防御力降低效果提高{0:F}, 持续时间也阶段性增加。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_PoYuZhen_Strengthen536] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
