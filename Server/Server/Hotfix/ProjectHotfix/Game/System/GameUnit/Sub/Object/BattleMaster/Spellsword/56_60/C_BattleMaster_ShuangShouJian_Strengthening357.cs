...
namespace ETHotfix
{
    ...
    /// 双手剑精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ShuangShouJian_Strengthening357)]
    public partial class C_BattleMaster_ShuangShouJian_Strengthening357 : C_BattleMaster
    {
    ...
    /// 双手剑精通
    /// </summary>
    public partial class C_BattleMaster_ShuangShouJian_Strengthening357
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ShuangShouJian_Strengthening357] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
