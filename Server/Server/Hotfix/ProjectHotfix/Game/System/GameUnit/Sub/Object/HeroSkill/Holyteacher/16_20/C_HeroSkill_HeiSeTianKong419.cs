...
namespace ETHotfix
{
    ...
    /// 黑色天空
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.HeiSeTianKong419)]
    public partial class C_HeroSkill_HeiSeTianKong419 : C_HeroSkillSource
    {
    ...
    /// 黑色天空
    /// </summary>
    public partial class C_HeroSkill_HeiSeTianKong419
    {
        ...
        public override bool TryUse(CombatSource b_Attacker, CombatSource b_BeAttacker, C_FindTheWay2D b_Cell, BattleComponent b_BattleComponent, IActorResponse b_Response)
        {
            ...
            if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Common2012) == false)
            {
