...
namespace ETHotfix
{
    ...
    /// 陨星雨
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.JianYu618)]
    public partial class C_HeroSkill_JianYu618 : C_HeroSkillSource
    {
    ...
    /// 陨星雨
    /// </summary>
    public partial class C_HeroSkill_JianYu618
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                var mAppendValue = b_Attacker.GetNumerialFunc(E_GameProperty.SacredBeast) / mConfig.OtherDataDic[10];
