...
namespace ETHotfix
{
    ...
    /// 月神祝福
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_Pets_SKILL_Id.MoonGodBless)]
    public partial class C_PetsSkill_MoonGodBless101007 : C_HeroSkillSource
    {
    ...
    /// 月神祝福
    /// </summary>
    public partial class C_PetsSkill_MoonGodBless101007
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            {
                //b_Attacker.GamePropertyDic[E_GameProperty.ExcellentAttackRate] += mConfig.OtherDataDic[2];
                b_Attacker.GamePropertyDic[E_GameProperty.MinAtteck] += mConfig.OtherDataDic[2];
                b_Attacker.GamePropertyDic[E_GameProperty.MaxAtteck] += mConfig.OtherDataDic[2];
