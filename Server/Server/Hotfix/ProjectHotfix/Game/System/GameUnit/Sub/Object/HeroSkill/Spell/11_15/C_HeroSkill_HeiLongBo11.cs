...
namespace ETHotfix
{
    ...
    /// 黑龙波
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.HeiLongBo)]
    public partial class C_HeroSkill_HeiLongBo11 : C_HeroSkillSource
    {
    ...
    /// 黑龙波
    /// </summary>
    public partial class C_HeroSkill_HeiLongBo11
    {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Action<long, long, long> mSyncActionChild = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
                {
                    ...
                    int GetHurtValue(E_GameProperty b_SpecialAttack)
                    {
                        ...
                        if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_HeiLongBoStrengthen31))
                        {
                            int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HeiLongBoStrengthen31];
                    ...
                    int mRadius = mConfig.OtherDataDic[2];
                    int mRadiusMax = mRadius * 2;
                    // 目标范围
                    ...
                    for (int i = 0; i <= mRadiusMax; i++)
                    {
                        for (int j = 0; j <= mRadiusMax; j++)
                        {
                            ...
                            if (Vector2.Distance(mCenterPos, mCurrentTemp.Vector2Pos) < mRadius)
                            {
