...
namespace ETHotfix
{
    ...
    /// 玄月斩强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_XuanYueZhanStrengthen333)]
    public partial class C_BattleMaster_Skill_XuanYueZhanStrengthen333 : C_BattleMaster
    {
    ...
    /// 玄月斩强化
    /// </summary>
    public partial class C_BattleMaster_Skill_XuanYueZhanStrengthen333
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XuanYueZhanStrengthen333] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
