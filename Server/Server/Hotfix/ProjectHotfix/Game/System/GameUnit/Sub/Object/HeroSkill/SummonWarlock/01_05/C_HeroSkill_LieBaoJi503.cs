...
namespace ETHotfix
{
    ...
    /// 爆裂击
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.LieBaoJi503)]
    public partial class C_HeroSkill_LieBaoJi503 : C_HeroSkillSource
    {
    ...
    /// 爆裂击
    /// </summary>
    public partial class C_HeroSkill_LieBaoJi503
    {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
                {
                    ...
                    mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                    {
                        ...
                        b_CombatSource.RemoveHealthState(E_BattleSkillStats.LieBaoJi503, b_BattleComponent);
                    ...
                    mBattleSyncTimer.SyncAction = (b_CombatSource, b_BattleComponent, b_TimerTask, b_TimeTick) =>
                    {
                        ...
                        if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.LieBaoJi503, out var hp_Curse) == false)
                        {
                        ...
                        for (int j = 0, jlen = mFieldEnemylist.Length; j < jlen; j++)
                        {
                            ...
                            //if (Vector2.Distance(mSelfPos, new Vector2(mCurrentTemp.UnitData.X, mCurrentTemp.UnitData.Y)) < mRadius)
                            {
                                ...
                                if (IsHit)
                                {
                                    ...
                                    mCurrentTemp.AddHealthState(E_BattleSkillStats.LieBaoJi503, mBufferHurtValue, mConfig.PersistentTime, 0, mCreateFunc, b_BattleComponent);
