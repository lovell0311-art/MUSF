...
namespace ETHotfix
{
    ...
    /// 狂暴术强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_KuangBaoShu_Strengthen550)]
    public partial class C_BattleMaster_Skill_KuangBaoShu_Strengthen550 : C_BattleMaster
    {
    ...
    /// 狂暴术强化
    /// </summary>
    public partial class C_BattleMaster_Skill_KuangBaoShu_Strengthen550
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用狂暴术技能时魔法攻击力追加提高{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_KuangBaoShu_Strengthen550] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
