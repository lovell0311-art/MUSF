...
namespace ETHotfix
{
    ...
    /// 地裂
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.DiLie408)]
    public partial class C_HeroSkill_DiLie408 : C_HeroSkillSource
    {
    ...
    /// 地裂
    /// </summary>
    public partial class C_HeroSkill_DiLie408
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_DiLieShengYinStrengthen430))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DiLieShengYinStrengthen430];
                ...
                //// 大师技能 雷霆裂闪强化:致命一击伤害增加{0:F}。
                //if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_LeiTingLieShan126))
                //{
                //    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_LeiTingLieShan126];
                //    mHurtValue += mMasteryValue;
                //}
