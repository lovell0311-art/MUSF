...
namespace ETHotfix
{
    ...
    /// 对人防御率提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.PVPDefenseRate402)]
    public partial class C_BattleMaster_PVPDefenseRate402 : C_BattleMaster
    {
    ...
    /// 对人防御率提高
    /// </summary>
    public partial class C_BattleMaster_PVPDefenseRate402
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.PVPDefenseRate402] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
