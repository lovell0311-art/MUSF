...
namespace ETHotfix
{
    ...
    /// 战斗意志
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ZhanDouYiZhi166)]
    public partial class C_BattleMaster_ZhanDouYiZhi166 : C_BattleMaster
    {
    ...
    /// 战斗意志
    /// </summary>
    public partial class C_BattleMaster_ZhanDouYiZhi166
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 攻击2个以内的目标时，攻击力增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ZhanDouYiZhi166] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
