...
namespace ETHotfix
{
    ...
    /// 守护之魂精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ShouHuZhiHunMaster60)]
    public partial class C_BattleMaster_Skill_ShouHuZhiHunMaster60 : C_BattleMaster
    {
    ...
    /// 守护之魂精通
    /// </summary>
    public partial class C_BattleMaster_Skill_ShouHuZhiHunMaster60
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 守护之魂技能上使用时最大魔力{0:F}%追加增加。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ShouHuZhiHunMaster60] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
