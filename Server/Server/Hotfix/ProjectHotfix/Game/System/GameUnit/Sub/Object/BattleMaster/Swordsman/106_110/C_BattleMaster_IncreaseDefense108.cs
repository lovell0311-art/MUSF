...
namespace ETHotfix
{
    ...
    /// 防御力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseDefense108)]
    public partial class C_BattleMaster_IncreaseDefense108 : C_BattleMaster
    {
    ...
    /// 防御力增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseDefense108
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseDefense108] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
