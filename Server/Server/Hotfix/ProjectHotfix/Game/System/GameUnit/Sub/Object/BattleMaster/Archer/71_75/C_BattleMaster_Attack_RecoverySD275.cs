...
namespace ETHotfix
{
    ...
    /// 攻击时sd 防御恢复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Attack_RecoverySD275)]
    public partial class C_BattleMaster_Attack_RecoverySD275 : C_BattleMaster
    {
    ...
    /// 攻击时sd 防御恢复
    /// </summary>
    public partial class C_BattleMaster_Attack_RecoverySD275
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Attack_RecoverySD275] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
