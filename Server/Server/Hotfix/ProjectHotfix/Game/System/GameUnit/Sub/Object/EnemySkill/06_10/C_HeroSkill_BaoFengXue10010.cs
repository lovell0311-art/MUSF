...
namespace ETHotfix
{
    ...
    /// 暴风雪
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.BaoFengXue10010)]
    public partial class C_HeroSkill_BaoFengXue10010 : C_HeroSkillSource
    {
    ...
    /// 暴风雪
    /// </summary>
    public partial class C_HeroSkill_BaoFengXue10010
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                if (mIceResistance == 0)
                {
                    b_Attacker.AddHealthState(E_BattleSkillStats.BingFeng, 0, mConfig.PersistentTime, 0, mCreateFunc, b_BattleComponent);
