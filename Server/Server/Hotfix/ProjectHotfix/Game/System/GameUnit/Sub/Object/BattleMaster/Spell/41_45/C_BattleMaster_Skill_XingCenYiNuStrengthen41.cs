...
namespace ETHotfix
{
    ...
    /// 星辰一怒强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_XingCenYiNuStrengthen41)]
    public partial class C_BattleMaster_Skill_XingCenYiNuStrengthen41 : C_BattleMaster
    {
    ...
    /// 星辰一怒强化
    /// </summary>
    public partial class C_BattleMaster_Skill_XingCenYiNuStrengthen41
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XingCenYiNuStrengthen41] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
