...
namespace ETHotfix
{
    ...
    /// 吸收增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Common2007)]
    public partial class C_BattleMaster_Common2007 : C_BattleMaster
    {
    ...
    /// 吸收增加
    /// </summary>
    public partial class C_BattleMaster_Common2007
    {
        #region try
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Common2007] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
