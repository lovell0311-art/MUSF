...
namespace ETHotfix
{
    ...
    /// 霹雳回旋斩强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_LeiTingHuiXuanZhan124)]
    public partial class C_BattleMaster_Skill_LeiTingHuiXuanZhan124 : C_BattleMaster
    {
    ...
    /// 霹雳回旋斩强化
    /// </summary>
    public partial class C_BattleMaster_Skill_LeiTingHuiXuanZhan124
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_LeiTingHuiXuanZhan124] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
