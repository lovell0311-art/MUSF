...
namespace ETHotfix
{
    ...
    /// 弩类精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Crossbow_Master258)]
    public partial class C_BattleMaster_Crossbow_Master258 : C_BattleMaster
    {
    ...
    /// 弩类精通
    /// </summary>
    public partial class C_BattleMaster_Crossbow_Master258
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Crossbow_Master258] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
