...
namespace ETHotfix
{
    ...
    /// 提高最大SD
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseSDMax503)]
    public partial class C_BattleMaster_IncreaseSDMax503 : C_BattleMaster
    {
    ...
    /// 提高最大SD
    /// </summary>
    public partial class C_BattleMaster_IncreaseSDMax503
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseSDMax503] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
            if (b_AddPoint)
            {
