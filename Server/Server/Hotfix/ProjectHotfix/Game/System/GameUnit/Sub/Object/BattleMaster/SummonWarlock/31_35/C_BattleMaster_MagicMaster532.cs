...
namespace ETHotfix
{
    ...
    /// 魔法精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MagicMaster532)]
    public partial class C_BattleMaster_MagicMaster532 : C_BattleMaster
    {
    ...
    /// 魔法精通
    /// </summary>
    public partial class C_BattleMaster_MagicMaster532
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MagicMaster532] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
