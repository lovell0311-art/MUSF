...
namespace ETHotfix
{
    ...
    /// 血腥风暴
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_XueXingFengBao_141)]
    public partial class C_BattleMaster_Skill_XueXingFengBao_141 : C_BattleMaster
    {
    ...
    /// 血腥风暴
    /// </summary>
    public partial class C_BattleMaster_Skill_XueXingFengBao_141
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XueXingFengBao_141] = 1;

            var mStudySkillId = (int)E_HeroSkillId.XueXingFengBao125;
            var mReadConfigComponent = Root.MainFactory.GetCustomComponent<CustomFrameWork.Component.ReadConfigComponent>();
