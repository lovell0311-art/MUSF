...
namespace ETHotfix
{
    ...
    /// 爆炎强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_BaoYanStrengthen331)]
    public partial class C_BattleMaster_Skill_BaoYanStrengthen331 : C_BattleMaster
    {
    ...
    /// 爆炎强化
    /// </summary>
    public partial class C_BattleMaster_Skill_BaoYanStrengthen331
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_BaoYanStrengthen331] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
