...
namespace ETHotfix
{
    ...
    /// 弓类精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Arch_Master257)]
    public partial class C_BattleMaster_Arch_Master257 : C_BattleMaster
    {
    ...
    /// 弓类精通
    /// </summary>
    public partial class C_BattleMaster_Arch_Master257
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Arch_Master257] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
