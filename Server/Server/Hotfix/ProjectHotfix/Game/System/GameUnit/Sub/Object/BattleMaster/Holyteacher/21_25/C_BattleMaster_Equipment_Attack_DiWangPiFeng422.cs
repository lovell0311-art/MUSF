...
namespace ETHotfix
{
    ...
    /// 帝王披风攻击强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Equipment_Attack_DiWangPiFeng422)]
    public partial class C_BattleMaster_Equipment_Attack_DiWangPiFeng422 : C_BattleMaster
    {
    ...
    /// 帝王披风攻击强化
    /// </summary>
    public partial class C_BattleMaster_Equipment_Attack_DiWangPiFeng422
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Equipment_Attack_DiWangPiFeng422] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
