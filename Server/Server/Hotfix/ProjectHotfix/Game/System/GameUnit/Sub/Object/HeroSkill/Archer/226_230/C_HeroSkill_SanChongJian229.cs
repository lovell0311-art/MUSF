...
namespace ETHotfix
{
    ...
    /// 三重箭
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.SanChongJian229)]
    public partial class C_HeroSkill_SanChongJian229 : C_HeroSkillSource
    {
    ...
    /// 三重箭
    /// </summary>
    public partial class C_HeroSkill_SanChongJian229
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                {// 随机魔法伤害
                    ...
                    if (b_Attacker.BattleMasteryDic.TryGetValue(E_BattleMasteryState.Skill_SanChongJianStrengthen_245, out var mMasteryValue))
                    {
