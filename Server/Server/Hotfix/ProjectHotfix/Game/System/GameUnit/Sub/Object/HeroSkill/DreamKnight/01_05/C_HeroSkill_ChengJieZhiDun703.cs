...
namespace ETHotfix
{
    ...
    /// 惩戒之盾
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.ChengJieZhiDun703)]
    public partial class C_HeroSkill_ChengJieZhiDun703 : C_HeroSkillSource
    {
    ...
    /// 惩戒之盾
    /// </summary>
    public partial class C_HeroSkill_ChengJieZhiDun703
    {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
                {
                    ...
                    mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                    {
                        ...
                        b_CombatSource.RemoveHealthState(E_BattleSkillStats.ChengJieZhiDun703, b_BattleComponent);
                    ...
                    mBattleSyncTimer.SyncAction = (b_CombatSource, b_BattleComponent, b_TimerTask, b_TimeTick) =>
                    {
                        ...
                        if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.ChengJieZhiDun703, out var hp_Curse) == false)
                        {
                ...
                b_Attacker.AddHealthState(E_BattleSkillStats.ChengJieZhiDun703, 0, mConfig.PersistentTime, 0, mCreateFunc, b_BattleComponent);
