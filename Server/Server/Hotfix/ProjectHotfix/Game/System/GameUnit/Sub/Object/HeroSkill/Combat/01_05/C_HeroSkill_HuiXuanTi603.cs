...
namespace ETHotfix
{
    ...
    /// 回旋踢
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.HuiXuanTi603)]
    public partial class C_HeroSkill_HuiXuanTi603 : C_HeroSkillSource
    {
    ...
    /// 回旋踢
    /// </summary>
    public partial class C_HeroSkill_HuiXuanTi603
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute631))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute631];
                ...
                b_BattleComponent.WaitSync(400, b_AttackerId, b_BeAttackerId, mSyncActionChild);
                b_BattleComponent.WaitSync(500, b_AttackerId, b_BeAttackerId, mSyncActionChild);
                b_BattleComponent.WaitSync(600, b_AttackerId, b_BeAttackerId, mSyncActionChild);
                b_BattleComponent.WaitSync(700, b_AttackerId, b_BeAttackerId, mSyncActionChild);
