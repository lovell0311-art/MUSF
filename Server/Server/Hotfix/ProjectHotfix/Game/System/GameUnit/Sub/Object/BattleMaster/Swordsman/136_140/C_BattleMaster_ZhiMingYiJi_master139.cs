...
namespace ETHotfix
{
    ...
    /// 致命一击精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ZhiMingYiJi_master139)]
    public partial class C_BattleMaster_ZhiMingYiJi_master139 : C_BattleMaster
    {
    ...
    /// 致命一击精通
    /// </summary>
    public partial class C_BattleMaster_ZhiMingYiJi_master139
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 致命一击的伤害范围增加，去除冰冻效果。技能攻击力增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ZhiMingYiJi_master139] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
