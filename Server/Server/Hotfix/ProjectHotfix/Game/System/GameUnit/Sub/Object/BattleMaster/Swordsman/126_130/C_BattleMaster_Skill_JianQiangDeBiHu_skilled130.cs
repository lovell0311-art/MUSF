...
namespace ETHotfix
{
    ...
    /// 坚强的庇护熟练
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_JianQiangDeBiHu_skilled130)]
    public partial class C_BattleMaster_Skill_JianQiangDeBiHu_skilled130 : C_BattleMaster
    {
    ...
    /// 坚强的庇护熟练
    /// </summary>
    public partial class C_BattleMaster_Skill_JianQiangDeBiHu_skilled130
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用坚固的庇护时代替承受的伤害（伤害装换率）追加增加{0:F}%。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_JianQiangDeBiHu_skilled130] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
