...
namespace ETHotfix
{
    ...
    /// 宠物耐久度强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.PetsDurableStrengthen457)]
    public partial class C_BattleMaster_PetsDurableStrengthen457 : C_BattleMaster
    {
    ...
    /// 宠物耐久度强化
    /// </summary>
    public partial class C_BattleMaster_PetsDurableStrengthen457
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.PetsDurableStrengthen457] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
