...
namespace ETHotfix
{
    ...
    /// PVP攻击成功率
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute948)]
    public partial class C_BattleMaster_MasterAttribute948 : C_BattleMaster
    {
    ...
    /// PVP攻击成功率
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute948
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute948] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
