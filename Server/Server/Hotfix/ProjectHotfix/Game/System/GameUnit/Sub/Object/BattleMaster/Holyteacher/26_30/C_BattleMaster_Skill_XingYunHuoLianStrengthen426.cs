...
namespace ETHotfix
{
    ...
    /// 星云火链强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_XingYunHuoLianStrengthen426)]
    public partial class C_BattleMaster_Skill_XingYunHuoLianStrengthen426 : C_BattleMaster
    {
    ...
    /// 星云火链强化
    /// </summary>
    public partial class C_BattleMaster_Skill_XingYunHuoLianStrengthen426
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XingYunHuoLianStrengthen426] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
