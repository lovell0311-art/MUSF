...
namespace ETHotfix
{
    ...
    /// 星云火链
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.XingYunHuoLian407)]
    public partial class C_HeroSkill_XingYunHuoLian407 : C_HeroSkillSource
    {
    ...
    /// 星云火链
    /// </summary>
    public partial class C_HeroSkill_XingYunHuoLian407
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    // 大师技能 星云火链技能的伤害提高 {0:F}。
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_XingYunHuoLianStrengthen426))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XingYunHuoLianStrengthen426];
