...
namespace ETHotfix
{
    ...
    /// 生命之光熟练
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ShengMingZhiGuang_skilled156)]
    public partial class C_BattleMaster_Skill_ShengMingZhiGuang_skilled156 : C_BattleMaster
    {
    ...
    /// 生命之光熟练
    /// </summary>
    public partial class C_BattleMaster_Skill_ShengMingZhiGuang_skilled156
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 生命之光技能使用时追加最大魔法值提高{0:F}%。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ShengMingZhiGuang_skilled156] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
