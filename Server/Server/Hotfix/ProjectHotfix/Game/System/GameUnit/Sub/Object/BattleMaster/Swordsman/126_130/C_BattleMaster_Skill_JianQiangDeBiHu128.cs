...
namespace ETHotfix
{
    ...
    /// 坚强的庇护
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_JianQiangDeBiHu128)]
    public partial class C_BattleMaster_Skill_JianQiangDeBiHu128 : C_BattleMaster
    {
    ...
    /// 坚强的庇护
    /// </summary>
    public partial class C_BattleMaster_Skill_JianQiangDeBiHu128
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_JianQiangDeBiHu128] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
