...
namespace ETHotfix
{
    ...
    /// 守护盾
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.GuardianShield421)]
    public partial class C_BattleMaster_GuardianShield421 : C_BattleMaster
    {
    ...
    /// 守护盾
    /// </summary>
    public partial class C_BattleMaster_GuardianShield421
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 装备盾牌时以 {0:F}%的概率减少盾牌中显示的盾牌防御率 1000%%的伤害。
            // 发动技能时如果减少所有伤害会以Absorb（吸收）显示。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.GuardianShield421] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
