...
namespace ETHotfix
{
    ...
    /// 攻击时sd 防御恢复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute660)]
    public partial class C_BattleMaster_MasterAttribute660 : C_BattleMaster
    {
    ...
    /// 攻击时sd 防御恢复
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute660
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute660] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
