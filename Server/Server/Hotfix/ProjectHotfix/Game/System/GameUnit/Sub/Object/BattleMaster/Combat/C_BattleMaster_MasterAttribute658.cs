...
namespace ETHotfix
{
    ...
    /// sd 完全回复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute658)]
    public partial class C_BattleMaster_MasterAttribute658 : C_BattleMaster
    {
    ...
    /// sd 完全回复
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute658
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute658] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
