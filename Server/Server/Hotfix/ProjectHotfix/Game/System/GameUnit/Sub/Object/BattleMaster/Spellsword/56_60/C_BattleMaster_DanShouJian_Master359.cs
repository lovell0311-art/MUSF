...
namespace ETHotfix
{
    ...
    /// 单手杖精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.DanShouJian_Master359)]
    public partial class C_BattleMaster_DanShouJian_Master359 : C_BattleMaster
    {
    ...
    /// 单手杖精通
    /// </summary>
    public partial class C_BattleMaster_DanShouJian_Master359
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.DanShouJian_Master359] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
