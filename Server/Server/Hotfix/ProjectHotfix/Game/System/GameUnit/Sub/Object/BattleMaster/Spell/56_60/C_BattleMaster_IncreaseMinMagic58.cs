...
namespace ETHotfix
{
    ...
    /// 最小魔力提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseMinMagic58)]
    public partial class C_BattleMaster_IncreaseMinMagic58 : C_BattleMaster
    {
    ...
    /// 最小魔力提高
    /// </summary>
    public partial class C_BattleMaster_IncreaseMinMagic58
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseMinMagic58] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
