...
namespace ETHotfix
{
    ...
    /// 双手杖精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ShuangShouJian_Master51)]
    public partial class C_BattleMaster_ShuangShouJian_Master51 : C_BattleMaster
    {
    ...
    /// 双手杖精通
    /// </summary>
    public partial class C_BattleMaster_ShuangShouJian_Master51
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 装备双手杖时对PVP攻击力追加增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ShuangShouJian_Master51] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
