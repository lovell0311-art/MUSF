...
namespace ETHotfix
{
    ...
    /// 幽冥光速拳
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.YouMingGuangSuQuan604)]
    public partial class C_HeroSkill_YouMingGuangSuQuan604 : C_HeroSkillSource
    {
    ...
    /// 幽冥光速拳
    /// </summary>
    public partial class C_HeroSkill_YouMingGuangSuQuan604
    {
        ...
        public override bool TryUse(CombatSource b_Attacker, CombatSource b_BeAttacker, C_FindTheWay2D b_Cell, BattleComponent b_BattleComponent, IActorResponse b_Response)
        {
            ...
            int mRate = mConfig.Distance;
            if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute636))
            {
                int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute636];
                mRate += mMasteryValue;
            }
            if (Vector2.Distance(b_BattleComponent.Parent.GetFindTheWay2D(b_Attacker).Vector2Pos, b_Cell.Vector2Pos) > mRate)
            {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute632))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute632];
