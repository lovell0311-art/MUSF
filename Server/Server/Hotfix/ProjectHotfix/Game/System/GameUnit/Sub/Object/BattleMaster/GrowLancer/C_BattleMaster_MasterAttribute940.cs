...
namespace ETHotfix
{
    ...
    /// 最大生命增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute940)]
    public partial class C_BattleMaster_MasterAttribute940 : C_BattleMaster
    {
    ...
    /// 最大生命增加
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute940
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 扩大生命力，追加持有{0:F}的最大生命力。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute940] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
            if (b_AddPoint)
            {
