...
namespace ETHotfix
{
    ...
    /// SD恢复速度提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BeCommon3006)]
    public partial class C_BattleMaster_BeCommon3006 : C_BattleMaster
    {
    ...
    /// SD恢复速度提高
    /// </summary>
    public partial class C_BattleMaster_BeCommon3006
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BeCommon3006] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
