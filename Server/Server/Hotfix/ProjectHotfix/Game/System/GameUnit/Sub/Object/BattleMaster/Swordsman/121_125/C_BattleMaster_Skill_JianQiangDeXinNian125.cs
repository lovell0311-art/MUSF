...
namespace ETHotfix
{
    ...
    /// 坚强的信念强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_JianQiangDeXinNian125)]
    public partial class C_BattleMaster_Skill_JianQiangDeXinNian125 : C_BattleMaster
    {
    ...
    /// 坚强的信念强化
    /// </summary>
    public partial class C_BattleMaster_Skill_JianQiangDeXinNian125
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用坚强的信念是基本防御力追加增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_JianQiangDeXinNian125] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
