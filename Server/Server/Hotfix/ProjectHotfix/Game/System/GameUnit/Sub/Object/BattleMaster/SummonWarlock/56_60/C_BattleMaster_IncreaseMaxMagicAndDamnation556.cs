...
namespace ETHotfix
{
    ...
    /// 最大魔力/诅咒力提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseMaxMagicAndDamnation556)]
    public partial class C_BattleMaster_IncreaseMaxMagicAndDamnation556 : C_BattleMaster
    {
    ...
    /// 最大魔力/诅咒力提高
    /// </summary>
    public partial class C_BattleMaster_IncreaseMaxMagicAndDamnation556
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseMaxMagicAndDamnation556] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
