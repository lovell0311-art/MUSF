...
namespace ETHotfix
{
    ...
    /// 生命吸收
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute962)]
    public partial class C_BattleMaster_MasterAttribute962 : C_BattleMaster
    {
    ...
    /// 生命吸收
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute962
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 攻击敌人时每次攻击成功，以50%的概率生命恢复{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute962] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
