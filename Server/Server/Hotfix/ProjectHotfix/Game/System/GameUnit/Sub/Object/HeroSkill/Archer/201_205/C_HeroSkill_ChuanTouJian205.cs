...
namespace ETHotfix
{
    ...
    /// 穿透箭
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.ChuanTouJian)]
    public partial class C_HeroSkill_ChuanTouJian205 : C_HeroSkillSource
    {
    ...
    /// 穿透箭
    /// </summary>
    public partial class C_HeroSkill_ChuanTouJian205
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    if (b_Attacker.BattleMasteryDic.TryGetValue(E_BattleMasteryState.Skill_ChuanTouJianStrengthen228, out var mMasteryValue))
                    {
