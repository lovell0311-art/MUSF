...
namespace ETHotfix
{
    ...
    /// 守护之魂强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ShouHuZhiHunStrengthen53)]
    public partial class C_BattleMaster_Skill_ShouHuZhiHunStrengthen53 : C_BattleMaster
    {
    ...
    /// 守护之魂强化
    /// </summary>
    public partial class C_BattleMaster_Skill_ShouHuZhiHunStrengthen53
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ShouHuZhiHunStrengthen53] = mConfig.OtherDataDic[mMasterLevel];
