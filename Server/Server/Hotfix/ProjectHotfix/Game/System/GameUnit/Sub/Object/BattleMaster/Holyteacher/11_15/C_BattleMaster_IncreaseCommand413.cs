...
namespace ETHotfix
{
    ...
    /// 统率属性增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseCommand413)]
    public partial class C_BattleMaster_IncreaseCommand413 : C_BattleMaster
    {
    ...
    /// 统率属性增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseCommand413
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseCommand413] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
