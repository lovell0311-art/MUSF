...
namespace ETHotfix
{
    ...
    /// 权杖精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.QuanZhang_Master447)]
    public partial class C_BattleMaster_QuanZhang_Master447 : C_BattleMaster
    {
    ...
    /// 权杖精通
    /// </summary>
    public partial class C_BattleMaster_QuanZhang_Master447
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.QuanZhang_Master447] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
