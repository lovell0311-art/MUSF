...
namespace ETHotfix
{
    ...
    /// 生命增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.AddHpMax239)]
    public partial class C_BattleMaster_AddHpMax239 : C_BattleMaster
    {
    ...
    /// 生命增加
    /// </summary>
    public partial class C_BattleMaster_AddHpMax239
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 目标的异常状态效果解除。2秒后可重新使用

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.AddHpMax239] = 30;
