...
namespace ETHotfix
{
    ...
    /// 防御力提高强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_DefenseIncreaseMaster236)]
    public partial class C_BattleMaster_Skill_DefenseIncreaseMaster236 : C_BattleMaster
    {
    ...
    /// 防御力提高强化
    /// </summary>
    public partial class C_BattleMaster_Skill_DefenseIncreaseMaster236
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 守护之光效果提高{0:F}%，持续时间阶段性增加

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DefenseIncreaseMaster236] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
