...
namespace ETHotfix
{
    ...
    /// 黑暗之力
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.HeiAnZhiLi414)]
    public partial class C_HeroSkill_HeiAnZhiLi414 : C_HeroSkillSource
    {
    ...
    /// 黑暗之力
    /// </summary>
    public partial class C_HeroSkill_HeiAnZhiLi414
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                {// 随机魔法伤害
                    ...
                    if (b_Attacker.BattleMasteryDic.TryGetValue(E_BattleMasteryState.Skill_HeiAnZhiLiStrengthen441, out var mMasteryValue))
                    {
