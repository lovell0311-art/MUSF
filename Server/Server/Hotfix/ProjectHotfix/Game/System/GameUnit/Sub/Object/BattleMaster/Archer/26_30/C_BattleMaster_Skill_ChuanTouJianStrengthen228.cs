...
namespace ETHotfix
{
    ...
    /// 穿透箭强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ChuanTouJianStrengthen228)]
    public partial class C_BattleMaster_Skill_ChuanTouJianStrengthen228 : C_BattleMaster
    {
    ...
    /// 穿透箭强化
    /// </summary>
    public partial class C_BattleMaster_Skill_ChuanTouJianStrengthen228
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ChuanTouJianStrengthen228] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
