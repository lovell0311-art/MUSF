...
namespace ETHotfix
{
    ...
    /// 萨迪洛斯召唤
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_ShaDiLuoShi_248)]
    public partial class C_BattleMaster_Skill_ShaDiLuoShi_248 : C_BattleMaster
    {
    ...
    /// 萨迪洛斯召唤
    /// </summary>
    public partial class C_BattleMaster_Skill_ShaDiLuoShi_248
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ShaDiLuoShi_248] = 1;

            var mStudySkillId = (int)E_HeroSkillId.Call_226;
            var mReadConfigComponent = Root.MainFactory.GetCustomComponent<CustomFrameWork.Component.ReadConfigComponent>();
