...
namespace ETHotfix
{
    ...
    /// 减少耐久
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Reduce_Durable2_205)]
    public partial class C_BattleMaster_ReduceDurable2_205 : C_BattleMaster
    {
    ...
    /// 减少耐久
    /// </summary>
    public partial class C_BattleMaster_ReduceDurable2_205
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Reduce_Durable2_205] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
