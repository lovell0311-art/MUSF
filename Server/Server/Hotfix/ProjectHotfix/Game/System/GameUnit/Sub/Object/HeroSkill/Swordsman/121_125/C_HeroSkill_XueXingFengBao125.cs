...
namespace ETHotfix
{
    ...
    /// 血腥风暴
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.XueXingFengBao125)]
    public partial class C_HeroSkill_XueXingFengBao125 : C_HeroSkillSource
    {
    ...
    /// 血腥风暴
    /// </summary>
    public partial class C_HeroSkill_XueXingFengBao125
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.ZhiMingYiJi_Strengthening136))
            {
                mAttackTime = (int)(mAttackTime * 0.6f);
            }
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.ZhiMingYiJi_master139))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.ZhiMingYiJi_master139];
