...
namespace ETHotfix
{
    ...
    /// 减少伤害
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Common2008)]
    public partial class C_BattleMaster_Common2008 : C_BattleMaster
    {
    ...
    /// 减少伤害
    /// </summary>
    public partial class C_BattleMaster_Common2008
    {
        #region try
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Common2008] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
