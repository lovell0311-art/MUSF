...
namespace ETHotfix
{
    ...
    /// 剑之愤怒
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.JianZhiFenNu)]
    public partial class C_HeroSkill_JianZhiFenNu112 : C_HeroSkillSource
    {
    ...
    /// 剑之愤怒
    /// </summary>
    public partial class C_HeroSkill_JianZhiFenNu112
    {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
                {
                    ...
                    mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                    {
                        ...
                        b_CombatSource.RemoveHealthState(E_BattleSkillStats.JianZhiFenNu112, b_BattleComponent);
                    ...
                    mBattleSyncTimer.SyncAction = (b_CombatSource, b_BattleComponent, b_TimerTask, b_TimeTick) =>
                    {
                        ...
                        if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.JianZhiFenNu112, out var hp_Curse) == false)
                        {
                ...
                b_Attacker.AddHealthState(E_BattleSkillStats.JianZhiFenNu112, 0, mConfig.PersistentTime, 0, mCreateFunc, b_BattleComponent);
