...
namespace ETHotfix
{
    ...
    /// 最大魔力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseMagicPowerMax134)]
    public partial class C_BattleMaster_IncreaseMagicPowerMax134 : C_BattleMaster
    {
    ...
    /// 最大魔力增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseMagicPowerMax134
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseMagicPowerMax134] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
            if (b_AddPoint)
            {
