...
namespace ETHotfix
{
    ...
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.GroundFissureChop10028)]
    public partial class C_HeroSkill_GroundFissureChop10028 : C_HeroSkillSource
    {
    ...
    /// 地裂斩 Ground fissure chop
    /// </summary>
    public partial class C_HeroSkill_GroundFissureChop10028
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                {
                    case E_Identity.Enemy:
                        if (b_Attacker.Identity != E_Identity.Enemy) (mBeAttacker as Enemy).InjureSkill(b_Attacker, E_BattleHurtType.MAGIC, mSpecialAttack, Id, mHurtValue, b_BattleComponent);
                        break;
                    case E_Identity.Summoned:
