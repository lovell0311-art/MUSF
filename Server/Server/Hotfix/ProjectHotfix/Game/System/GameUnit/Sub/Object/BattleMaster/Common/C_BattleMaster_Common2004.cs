...
namespace ETHotfix
{
    ...
    /// 蓝量增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Common2004)]
    public partial class C_BattleMaster_Common2004 : C_BattleMaster
    {
    ...
    /// 蓝量增加
    /// </summary>
    public partial class C_BattleMaster_Common2004
    {
        #region try
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Common2004] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
