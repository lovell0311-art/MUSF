...
namespace ETHotfix
{
    ...
    /// 锤类强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Hammers_Strengthening146)]
    public partial class C_BattleMaster_Hammers_Strengthening146 : C_BattleMaster
    {
    ...
    /// 锤类强化
    /// </summary>
    public partial class C_BattleMaster_Hammers_Strengthening146
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Hammers_Strengthening146] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
