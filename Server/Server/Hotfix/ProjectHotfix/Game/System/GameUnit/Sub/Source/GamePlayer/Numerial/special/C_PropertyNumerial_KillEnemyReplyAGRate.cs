...
namespace ETHotfix
{
    ...
    /// 
    /// </summary>
    [PropertyNumerialAttribute(BindId = (int)E_GameProperty.KillEnemyReplyAGRate)]
    public partial class C_PropertyNumerial_KillEnemyReplyAGRate : C_PropertyNumerial
    {
