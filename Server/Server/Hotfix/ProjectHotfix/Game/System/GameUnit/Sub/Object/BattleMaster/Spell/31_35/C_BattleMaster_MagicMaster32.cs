...
namespace ETHotfix
{
    ...
    /// 魔法精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MagicMaster32)]
    public partial class C_BattleMaster_MagicMaster32 : C_BattleMaster
    {
    ...
    /// 魔法精通
    /// </summary>
    public partial class C_BattleMaster_MagicMaster32
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MagicMaster32] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
