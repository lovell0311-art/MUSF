...
namespace ETHotfix
{
    ...
    /// 毒炎强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_DuYanStrengthen34)]
    public partial class C_BattleMaster_Skill_DuYanStrengthen34 : C_BattleMaster
    {
    ...
    /// 毒炎强化
    /// </summary>
    public partial class C_BattleMaster_Skill_DuYanStrengthen34
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DuYanStrengthen34] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
