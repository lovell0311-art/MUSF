...
namespace ETHotfix
{
    ...
    /// 最大AG增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseAGMax241)]
    public partial class C_BattleMaster_IncreaseAGMax241 : C_BattleMaster
    {
    ...
    /// 最大AG增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseAGMax241
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseAGMax241] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
