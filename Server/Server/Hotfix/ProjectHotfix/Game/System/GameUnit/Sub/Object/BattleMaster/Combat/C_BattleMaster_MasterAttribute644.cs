...
namespace ETHotfix
{
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute644)]
    public partial class C_BattleMaster_MasterAttribute644 : C_BattleMaster
    {
    ...
    /// 力量属性增加
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute644
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute644] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
