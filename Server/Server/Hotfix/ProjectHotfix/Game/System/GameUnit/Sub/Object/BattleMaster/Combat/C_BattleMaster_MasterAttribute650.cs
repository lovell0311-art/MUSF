...
namespace ETHotfix
{
    ...
    /// 最小攻击力提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute650)]
    public partial class C_BattleMaster_MasterAttribute650 : C_BattleMaster
    {
    ...
    /// 最小攻击力提高
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute650
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute650] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
