...
namespace ETHotfix
{
    ...
    /// 最大魔力提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BeCommon3029)]
    public partial class C_BattleMaster_BeCommon3029 : C_BattleMaster
    {
    ...
    /// 最大魔力提高
    /// </summary>
    public partial class C_BattleMaster_BeCommon3029
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BeCommon3029] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
