...
namespace ETHotfix
{
    ...
    /// 最大攻击力提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute958)]
    public partial class C_BattleMaster_MasterAttribute958 : C_BattleMaster
    {
    ...
    /// 最大攻击力提高
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute958
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute958] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
