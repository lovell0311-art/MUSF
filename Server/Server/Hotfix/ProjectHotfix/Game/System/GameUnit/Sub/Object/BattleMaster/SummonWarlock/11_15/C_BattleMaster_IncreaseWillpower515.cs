...
namespace ETHotfix
{
    ...
    /// 智力属性增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseWillpower515)]
    public partial class C_BattleMaster_IncreaseWillpower515 : C_BattleMaster
    {
    ...
    /// 智力属性增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseWillpower515
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseWillpower515] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
