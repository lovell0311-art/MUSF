...
namespace ETHotfix
{
    ...
    /// 陨石强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_YunShiStrengthen38)]
    public partial class C_BattleMaster_Skill_YunShiStrengthen38 : C_BattleMaster
    {
    ...
    /// 陨石强化
    /// </summary>
    public partial class C_BattleMaster_Skill_YunShiStrengthen38
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_YunShiStrengthen38] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
