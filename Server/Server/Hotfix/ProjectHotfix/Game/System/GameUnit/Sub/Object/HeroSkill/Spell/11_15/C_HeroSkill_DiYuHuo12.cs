...
namespace ETHotfix
{
    ...
    /// 地狱火
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.DiYuHuo)]
    public partial class C_HeroSkill_DiYuHuo12 : C_HeroSkillSource
    {
    ...
    /// 地狱火
    /// </summary>
    public partial class C_HeroSkill_DiYuHuo12
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_DiYuHuoStrengthen35))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DiYuHuoStrengthen35];
