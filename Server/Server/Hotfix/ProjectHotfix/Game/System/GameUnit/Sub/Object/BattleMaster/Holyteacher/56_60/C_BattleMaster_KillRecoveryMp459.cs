...
namespace ETHotfix
{
    ...
    /// 最小攻击力提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.KillRecoveryMp459)]
    public partial class C_BattleMaster_KillRecoveryMp459 : C_BattleMaster
    {
    ...
    /// 最小攻击力提高
    /// </summary>
    public partial class C_BattleMaster_KillRecoveryMp459
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.KillRecoveryMp459] = (int)(1f / mConfig.OtherDataDic[mMasterLevel] * 10000 * 10000);
