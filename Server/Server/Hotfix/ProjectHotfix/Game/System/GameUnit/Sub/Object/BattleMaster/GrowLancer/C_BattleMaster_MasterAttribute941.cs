...
namespace ETHotfix
{
    ...
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute941)]
    public partial class C_BattleMaster_MasterAttribute941 : C_BattleMaster
    {
    ...
    public partial class C_BattleMaster_MasterAttribute941
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute941] = 1;

            var mStudySkillId = (int)E_HeroSkillId.PoYuShengYan713;
            var mReadConfigComponent = Root.MainFactory.GetCustomComponent<CustomFrameWork.Component.ReadConfigComponent>();
