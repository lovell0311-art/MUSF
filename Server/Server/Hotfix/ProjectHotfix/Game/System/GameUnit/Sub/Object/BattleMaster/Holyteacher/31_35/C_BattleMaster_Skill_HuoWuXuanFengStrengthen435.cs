...
namespace ETHotfix
{
    ...
    /// 火舞旋风强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_HuoWuXuanFengStrengthen435)]
    public partial class C_BattleMaster_Skill_HuoWuXuanFengStrengthen435 : C_BattleMaster
    {
    ...
    /// 火舞旋风强化
    /// </summary>
    public partial class C_BattleMaster_Skill_HuoWuXuanFengStrengthen435
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HuoWuXuanFengStrengthen435] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
