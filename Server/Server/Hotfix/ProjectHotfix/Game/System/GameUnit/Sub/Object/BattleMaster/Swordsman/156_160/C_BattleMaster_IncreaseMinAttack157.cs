...
namespace ETHotfix
{
    ...
    /// 最小攻击力提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseMinAttack157)]
    public partial class C_BattleMaster_IncreaseMinAttack157 : C_BattleMaster
    {
    ...
    /// 最小攻击力提高
    /// </summary>
    public partial class C_BattleMaster_IncreaseMinAttack157
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseMinAttack157] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
