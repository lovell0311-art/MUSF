...
namespace ETHotfix
{
    ...
    /// 剑雨
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.JianYu126)]
    public partial class C_HeroSkill_JianYu126 : C_HeroSkillSource
    {
    ...
    /// 剑雨
    /// </summary>
    public partial class C_HeroSkill_JianYu126
    {
        ...
        public override bool TryUse(CombatSource b_Attacker, CombatSource b_BeAttacker, C_FindTheWay2D b_Cell, BattleComponent b_BattleComponent, IActorResponse b_Response)
        {
            ...
            if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Common2009) == false)
            {
