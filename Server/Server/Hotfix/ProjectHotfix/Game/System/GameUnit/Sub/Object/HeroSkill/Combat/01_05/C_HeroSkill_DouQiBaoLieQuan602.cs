...
namespace ETHotfix
{
    ...
    /// 斗气爆裂拳 fireball
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.DouQiBaoLieQuan602)]
    public partial class C_HeroSkill_DouQiBaoLieQuan602 : C_HeroSkillSource
    {
    ...
    /// 斗气爆裂拳
    /// </summary>
    public partial class C_HeroSkill_DouQiBaoLieQuan602
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute624))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute624];
                    mMaxAtteck += mMasteryValue;
                    mMinAtteck += mMasteryValue;
                }
                int mRate = 50;
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute627))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute627];
                    mRate += mMasteryValue;
                }
                ...
                Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
                {
                    ...
                    mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                    {
                        ...
                        b_CombatSource.RemoveHealthState(E_BattleSkillStats.DouQiBaoLieQuan602, b_BattleComponent);
                    ...
                    mBattleSyncTimer.SyncAction = (b_CombatSource, b_BattleComponent, b_TimerTask, b_TimeTick) =>
                    {
                        ...
                        if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.DouQiBaoLieQuan602, out var hp_Curse) == false)
                        {
                ...
                Action<long, long, long> mSyncActionChild = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
                {
                    ...
                    {
                        b_BeAttacker.AddHealthState(E_BattleSkillStats.DouQiBaoLieQuan602, 30, 3000, 0, mCreateFunc, b_BattleComponent);
