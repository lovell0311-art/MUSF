...
namespace ETHotfix
{
    ...
    /// 冰封领域强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_BingFengLingYuStrengthen341)]
    public partial class C_BattleMaster_Skill_BingFengLingYuStrengthen341 : C_BattleMaster
    {
    ...
    /// 冰封领域强化
    /// </summary>
    public partial class C_BattleMaster_Skill_BingFengLingYuStrengthen341
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用3次单手剑系列的技能时剑气爆发伤害增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_BingFengLingYuStrengthen341] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
