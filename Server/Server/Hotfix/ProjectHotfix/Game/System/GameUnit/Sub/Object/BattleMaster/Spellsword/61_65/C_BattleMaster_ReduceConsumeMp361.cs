...
namespace ETHotfix
{
    ...
    /// 魔力减少
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ReduceConsumeMp361)]
    public partial class C_BattleMaster_ReduceConsumeMp361 : C_BattleMaster
    {
    ...
    /// 魔力减少
    /// </summary>
    public partial class C_BattleMaster_ReduceConsumeMp361
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ReduceConsumeMp361] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
