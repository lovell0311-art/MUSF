...
namespace ETHotfix
{
    ...
    /// 多重箭强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_DuoChongJianStrengthen226)]
    public partial class C_BattleMaster_Skill_DuoChongJianStrengthen226 : C_BattleMaster
    {
    ...
    /// 多重箭强化
    /// </summary>
    public partial class C_BattleMaster_Skill_DuoChongJianStrengthen226
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DuoChongJianStrengthen226] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
