...
namespace ETHotfix
{
    ...
    /// 攻击成功率 （PVE）
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute929)]
    public partial class C_BattleMaster_MasterAttribute929 : C_BattleMaster
    {
    ...
    /// 攻击成功率 （PVE）
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute929
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute929] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
