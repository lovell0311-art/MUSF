...
namespace ETHotfix
{
    ...
    /// 破御圣言
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.PoYuShengYan713)]
    public partial class C_HeroSkill_PoYuShengYan713 : C_HeroSkillSource
    {
        ...
        {
            if (b_Attacker.BattleMasteryDic.TryGetValue(E_BattleMasteryState.MasterAttribute942,out var Value))
            {
    ...
    /// 破御圣言
    /// </summary>
    public partial class C_HeroSkill_PoYuShengYan713
    {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
                {
                    ...
                    mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                    {
                        ...
                        b_CombatSource.RemoveHealthState(E_BattleSkillStats.PoYuShengYan713, b_BattleComponent);
                    ...
                    mBattleSyncTimer.SyncAction = (b_CombatSource, b_BattleComponent, b_TimerTask, b_TimeTick) =>
                    {
                        ...
                        if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.PoYuShengYan713, out var hp_Curse) == false)
                        {
                ...
                b_Attacker.AddHealthState(E_BattleSkillStats.PoYuShengYan713,500 , mConfig.PersistentTime, 0, mCreateFunc, b_BattleComponent);
