...
namespace ETHotfix
{
    ...
    /// 星辰一怒
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.XingCenYiNu)]
    public partial class C_HeroSkill_XingCenYiNu21 : C_HeroSkillSource
    {
    ...
    /// 星辰一怒
    /// </summary>
    public partial class C_HeroSkill_XingCenYiNu21
    {
        ...
        public override bool TryUse(CombatSource b_Attacker, CombatSource b_BeAttacker, C_FindTheWay2D b_Cell, BattleComponent b_BattleComponent, IActorResponse b_Response)
        {
            ...
            var mResult = TryUseByUseStandard(b_Attacker, b_Response);

            if (b_Attacker.InCasting == false)
            {
                b_Attacker.InCasting = true;
                b_Attacker.InCastCombatRoundId = 21;
            }
            else
            {
                b_Attacker.InCasting = false;
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int GetHurtValue(E_GameProperty b_SpecialAttack)
                {
                    ...
                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_XingCenYiNuStrengthen41))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XingCenYiNuStrengthen41];
