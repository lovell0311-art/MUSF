...
namespace ETHotfix
{
    ...
    /// 双手杖强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.ShuangShouJian_Strengthening356)]
    public partial class C_BattleMaster_ShuangShouJian_Strengthening356 : C_BattleMaster
    {
    ...
    /// 双手杖强化
    /// </summary>
    public partial class C_BattleMaster_ShuangShouJian_Strengthening356
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.ShuangShouJian_Strengthening356] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
