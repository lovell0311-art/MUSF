...
namespace ETHotfix
{
    ...
    /// 生命吸收
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute656)]
    public partial class C_BattleMaster_MasterAttribute656 : C_BattleMaster
    {
    ...
    /// 生命吸收
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute656
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute656] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
