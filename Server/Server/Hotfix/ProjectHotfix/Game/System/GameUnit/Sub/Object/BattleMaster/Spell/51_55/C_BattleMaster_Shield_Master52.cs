...
namespace ETHotfix
{
    ...
    /// 盾牌强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Shield_Master52)]
    public partial class C_BattleMaster_Shield_Master52 : C_BattleMaster
    {
    ...
    /// 盾牌强化
    /// </summary>
    public partial class C_BattleMaster_Shield_Master52
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Shield_Master52] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
