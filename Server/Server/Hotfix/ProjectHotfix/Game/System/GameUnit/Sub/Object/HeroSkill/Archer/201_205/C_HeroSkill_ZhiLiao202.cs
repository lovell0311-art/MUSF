...
namespace ETHotfix
{
    ...
    /// 治疗
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.ZhiLiao)]
    public partial class C_HeroSkill_ZhiLiao202 : C_HeroSkillSource
    {
    ...
    /// 治疗
    /// </summary>
    public partial class C_HeroSkill_ZhiLiao202
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                try
                {
                    ...
                    int mStrengthValue = 5 + (int)(mWillpower * 0.25f);

                    if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_ZhiLiaoStrengthen225))
                    {
                        int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_ZhiLiaoStrengthen225];
                        mStrengthValue = (int)(mStrengthValue * (10000 + mMasteryValue) / 10000f);
                    }

                    void actionTemp(CombatSource b_BeAttacker)
                    {
                        b_BeAttacker.UnitData.Hp += mStrengthValue;
                        var mHpMax = b_BeAttacker.GetNumerialFunc(E_GameProperty.PROP_HP_MAX);
                        if (b_BeAttacker.UnitData.Hp >= mHpMax)
                        {
                            b_BeAttacker.UnitData.Hp = mHpMax;
                        }
                        ...
                        if (mGamePlayer != null && mGamePlayer.Summoned != null && mGamePlayer.Summoned.IsDeath == false && mGamePlayer.Summoned.IsDisposeable == false)
                        {
                            ...
                            if (mCenterPoint != null)
                            {
                                ...
                                if (mTargetFindTheWay != null)
                                {
                                    ...
                                    {
                                        actionTemp(mGamePlayer.Summoned);
                                    }
                                }
                            }
                        }
                                ...
                                if (mCurrentTemp.Data.PlayerTypeId == (int)E_GameOccupation.Archer)
                                {
                                    if (mCurrentTemp.Summoned != null && mCurrentTemp.Summoned.IsDeath == false && mCurrentTemp.Summoned.IsDisposeable == false)
                                    {
                                        ...
                                        if (mTargetFindTheWay != null)
                                        {
                                            if (10 * Vector2.Distance(mCenterPos, mTargetFindTheWay.Vector2Pos) <= mRadiusLen)
                                            {
                                                actionTemp(mCurrentTemp.Summoned);
                                            }
                                        }
                                    }
                                }
