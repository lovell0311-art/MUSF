...
namespace ETHotfix
{
    ...
    /// 对人防御率提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.PVPDefenseRate102)]
    public partial class C_BattleMaster_PVPDefenseRate102 : C_BattleMaster
    {
    ...
    /// 对人防御率提高
    /// </summary>
    public partial class C_BattleMaster_PVPDefenseRate102
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.PVPDefenseRate102] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
