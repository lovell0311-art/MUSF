...
namespace ETHotfix
{
    ...
    /// 狂暴精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.KuangBao_Master554)]
    public partial class C_BattleMaster_KuangBao_Master554 : C_BattleMaster
    {
    ...
    /// 狂暴精通
    /// </summary>
    public partial class C_BattleMaster_KuangBao_Master554
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用狂暴术技能时攻击速度追加提高{0:F}，去除HP及防御力降低效果。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.KuangBao_Master554] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
