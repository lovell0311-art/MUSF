...
namespace ETHotfix
{
    ...
    /// 一露斩
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_YiLuZhan44)]
    public partial class C_BattleMaster_Skill_YiLuZhan44 : C_BattleMaster
    {
    ...
    /// 一露斩
    /// </summary>
    public partial class C_BattleMaster_Skill_YiLuZhan44
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 造出与自身形同的幻影并一同攻击，以30%的概率吸收原生收到的伤害。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_YiLuZhan44] = 1;

            var mStudySkillId = (int)E_HeroSkillId.YiLuZhan29;
            var mReadConfigComponent = Root.MainFactory.GetCustomComponent<CustomFrameWork.Component.ReadConfigComponent>();
