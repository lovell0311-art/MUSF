...
namespace ETHotfix
{
    ...
    /// 最小魔力/诅咒力提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseMinMagicAndDamnation552)]
    public partial class C_BattleMaster_IncreaseMinMagicAndDamnation552 : C_BattleMaster
    {
    ...
    /// 最小魔力/诅咒力提高
    /// </summary>
    public partial class C_BattleMaster_IncreaseMinMagicAndDamnation552
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseMinMagicAndDamnation552] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
