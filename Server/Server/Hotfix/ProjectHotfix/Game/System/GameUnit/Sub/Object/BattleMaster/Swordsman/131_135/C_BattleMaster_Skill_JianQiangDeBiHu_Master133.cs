...
namespace ETHotfix
{
    ...
    /// 坚强的庇护精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_JianQiangDeBiHu_Master133)]
    public partial class C_BattleMaster_Skill_JianQiangDeBiHu_Master133 : C_BattleMaster
    {
    ...
    /// 坚强的庇护精通
    /// </summary>
    public partial class C_BattleMaster_Skill_JianQiangDeBiHu_Master133
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用坚固的庇护时队友的攻击力/魔法攻击增加效果追加增加{0:F}。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_JianQiangDeBiHu_Master133] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
