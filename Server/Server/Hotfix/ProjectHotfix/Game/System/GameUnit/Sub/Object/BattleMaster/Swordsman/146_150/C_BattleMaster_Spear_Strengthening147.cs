...
namespace ETHotfix
{
    ...
    /// 矛类强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Spear_Strengthening147)]
    public partial class C_BattleMaster_Spear_Strengthening147 : C_BattleMaster
    {
    ...
    /// 矛类强化
    /// </summary>
    public partial class C_BattleMaster_Spear_Strengthening147
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Spear_Strengthening147] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
