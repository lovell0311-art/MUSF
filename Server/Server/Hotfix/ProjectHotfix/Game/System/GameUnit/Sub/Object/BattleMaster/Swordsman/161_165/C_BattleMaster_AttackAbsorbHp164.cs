...
namespace ETHotfix
{
    ...
    /// 生命吸收
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.AttackAbsorbHp164)]
    public partial class C_BattleMaster_AttackAbsorbHp164 : C_BattleMaster
    {
    ...
    /// 生命吸收
    /// </summary>
    public partial class C_BattleMaster_AttackAbsorbHp164
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.AttackAbsorbHp164] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
