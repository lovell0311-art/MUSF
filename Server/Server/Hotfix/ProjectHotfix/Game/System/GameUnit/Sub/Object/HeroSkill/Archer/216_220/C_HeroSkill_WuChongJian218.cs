...
namespace ETHotfix
{
    ...
    /// 五重箭
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.WuChongJian)]
    public partial class C_HeroSkill_WuChongJian218 : C_HeroSkillSource
    {
    ...
    /// 五重箭
    /// </summary>
    public partial class C_HeroSkill_WuChongJian218
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                {// 随机魔法伤害
                    ...
                    if (b_Attacker.BattleMasteryDic.TryGetValue(E_BattleMasteryState.Skill_WuChongJianStrengthen_240, out var mMasteryValue))
                    {
