...
namespace ETHotfix
{
    ...
    /// 双手剑强化 pvp
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.PVPShuangShouJian_Strengthening148)]
    public partial class C_BattleMaster_PVPShuangShouJian_Strengthening148 : C_BattleMaster
    {
    ...
    /// 双手剑强化 pvp
    /// </summary>
    public partial class C_BattleMaster_PVPShuangShouJian_Strengthening148
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 装备双手剑时目标的攻击力追加增加{0:F}。PVP
            
            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.PVPShuangShouJian_Strengthening148] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
