...
namespace ETHotfix
{
    ...
    /// hp 回复  杀怪后
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute954)]
    public partial class C_BattleMaster_MasterAttribute954 : C_BattleMaster
    {
    ...
    /// hp 回复  杀怪后
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute954
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 杀死怪物后，恢复最大生命/{0:F}的生命值。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute954] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
