...
namespace ETHotfix
{
    ...
    /// 五重箭强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_WuChongJianStrengthen_240)]
    public partial class C_BattleMaster_Skill_WuChongJianStrengthen_240 : C_BattleMaster
    {
    ...
    /// 五重箭强化
    /// </summary>
    public partial class C_BattleMaster_Skill_WuChongJianStrengthen_240
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_WuChongJianStrengthen_240] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
