...
namespace ETHotfix
{
    ...
    /// 盾牌强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Shield_Strengthening49)]
    public partial class C_BattleMaster_Shield_Strengthening49 : C_BattleMaster
    {
    ...
    /// 盾牌强化
    /// </summary>
    public partial class C_BattleMaster_Shield_Strengthening49
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Shield_Strengthening49] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
