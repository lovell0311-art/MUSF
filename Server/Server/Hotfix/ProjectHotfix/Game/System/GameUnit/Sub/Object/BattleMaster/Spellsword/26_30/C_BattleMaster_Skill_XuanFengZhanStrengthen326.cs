...
namespace ETHotfix
{
    ...
    /// 旋风斩强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_XuanFengZhanStrengthen326)]
    public partial class C_BattleMaster_Skill_XuanFengZhanStrengthen326 : C_BattleMaster
    {
    ...
    /// 旋风斩强化
    /// </summary>
    public partial class C_BattleMaster_Skill_XuanFengZhanStrengthen326
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XuanFengZhanStrengthen326] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
