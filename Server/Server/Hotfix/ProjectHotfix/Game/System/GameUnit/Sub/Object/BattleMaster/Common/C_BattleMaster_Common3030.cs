...
namespace ETHotfix
{
    ...
    /// 卓越一击几率提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BeCommon3030)]
    public partial class C_BattleMaster_BeCommon3030 : C_BattleMaster
    {
    ...
    /// 卓越一击几率提高
    /// </summary>
    public partial class C_BattleMaster_BeCommon3030
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BeCommon3030] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
