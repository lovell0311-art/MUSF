...
namespace ETHotfix
{
    ...
    /// 攻击时sd 完全回复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BeCommon3035)]
    public partial class C_BattleMaster_BeCommon3035 : C_BattleMaster
    {
    ...
    /// 攻击时sd 完全回复
    /// </summary>
    public partial class C_BattleMaster_BeCommon3035
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BeCommon3035] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
