...
namespace ETHotfix
{
    ...
    /// 魔法领域
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MagicField67)]
    public partial class C_BattleMaster_MagicField67 : C_BattleMaster
    {
    ...
    /// 魔法领域
    /// </summary>
    public partial class C_BattleMaster_MagicField67
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MagicField67] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
