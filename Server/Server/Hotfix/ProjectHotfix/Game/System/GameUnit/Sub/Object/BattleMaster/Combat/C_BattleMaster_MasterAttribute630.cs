...
namespace ETHotfix
{
    ...
    /// 武器精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.MasterAttribute630)]
    public partial class C_BattleMaster_MasterAttribute630 : C_BattleMaster
    {
    ...
    /// 武器精通
    /// </summary>
    public partial class C_BattleMaster_MasterAttribute630
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute630] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
