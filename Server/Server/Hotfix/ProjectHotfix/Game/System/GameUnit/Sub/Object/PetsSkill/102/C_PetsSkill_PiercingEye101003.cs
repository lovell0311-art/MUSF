...
namespace ETHotfix
{
    ...
    /// 火眼金睛
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_Pets_SKILL_Id.PiercingEye)]
    public partial class C_PetsSkill_HeavenlyLight101003 : C_HeroSkillSource
    {
    ...
    /// 火眼金睛
    /// </summary>
    public partial class C_PetsSkill_HeavenlyLight101003
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            {
                //b_Attacker.GamePropertyDic[E_GameProperty.InjuryValueRate_3] += mConfig.OtherDataDic[2];
                int ValueA = (int)(b_Attacker.GamePropertyDic[E_GameProperty.MinAtteck] * mConfig.OtherDataDic[2] * 0.01f);
                int ValueB = (int)(b_Attacker.GamePropertyDic[E_GameProperty.MaxAtteck] * mConfig.OtherDataDic[2] * 0.01f);
                b_Attacker.GamePropertyDic[E_GameProperty.MinAtteck] += ValueA;
                b_Attacker.GamePropertyDic[E_GameProperty.MaxAtteck] += ValueB;
