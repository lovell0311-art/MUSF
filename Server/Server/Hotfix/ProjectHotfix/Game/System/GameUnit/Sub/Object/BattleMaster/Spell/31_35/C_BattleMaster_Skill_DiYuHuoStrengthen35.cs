...
namespace ETHotfix
{
    ...
    /// 地狱火强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_DiYuHuoStrengthen35)]
    public partial class C_BattleMaster_Skill_DiYuHuoStrengthen35 : C_BattleMaster
    {
    ...
    /// 地狱火强化
    /// </summary>
    public partial class C_BattleMaster_Skill_DiYuHuoStrengthen35
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_DiYuHuoStrengthen35] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
