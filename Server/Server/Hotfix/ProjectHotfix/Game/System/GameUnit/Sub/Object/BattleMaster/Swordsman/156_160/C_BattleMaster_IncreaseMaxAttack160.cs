...
namespace ETHotfix
{
    ...
    /// 最大攻击力提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseMaxAttack160)]
    public partial class C_BattleMaster_IncreaseMaxAttack160 : C_BattleMaster
    {
    ...
    /// 最大攻击力提高
    /// </summary>
    public partial class C_BattleMaster_IncreaseMaxAttack160
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseMaxAttack160] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
