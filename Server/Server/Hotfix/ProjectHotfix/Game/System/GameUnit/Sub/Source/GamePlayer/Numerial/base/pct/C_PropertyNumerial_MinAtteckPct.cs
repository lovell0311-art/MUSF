...
namespace ETHotfix
{
    ...
    /// 
    /// </summary>
    [PropertyNumerialAttribute(BindId = (int)E_GameProperty.MinAtteckPct)]
    public partial class C_PropertyNumerial_MinAtteckPct : C_PropertyNumerial
    {
        ...
        {
            int mResult = 0;
            var mGameProperty = E_GameProperty.MinAtteckPct;
