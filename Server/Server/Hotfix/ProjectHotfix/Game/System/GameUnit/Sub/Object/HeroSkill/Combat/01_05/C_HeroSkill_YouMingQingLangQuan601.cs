...
namespace ETHotfix
{
    ...
    /// 幽冥青狼拳 fireball
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.YouMingQingLangQuan601)]
    public partial class C_HeroSkill_YouMingQingLangQuan601 : C_HeroSkillSource
    {
    ...
    /// 幽冥青狼拳
    /// </summary>
    public partial class C_HeroSkill_YouMingQingLangQuan601
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute623))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute623];
                    mMaxAtteck += mMasteryValue;
                    mMinAtteck += mMasteryValue;
                }
                int mRate = 50;
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute626))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute626];
                    mRate += mMasteryValue;
                }
                ...
                Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
                {
                    ...
                    mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                    {
                        ...
                        b_CombatSource.RemoveHealthState(E_BattleSkillStats.YouMingQingLangQuan601, b_BattleComponent);
                    ...
                    mBattleSyncTimer.SyncAction = (b_CombatSource, b_BattleComponent, b_TimerTask, b_TimeTick) =>
                    {
                        ...
                        if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.YouMingQingLangQuan601, out var hp_Curse) == false)
                        {
                ...
                Action<long, long, long> mSyncActionChild = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
                {
                    ...
                    if (StrengthenItemSystem.StrengthenResult(mRate))
                    {
                        b_BeAttacker.AddHealthState(E_BattleSkillStats.YouMingQingLangQuan601, 30, 3000, 0, mCreateFunc, b_BattleComponent);
                        b_BeAttacker.UpdateHealthState();
                        b_BeAttacker.ChangeNumerialType(E_GameProperty.Property_Strength);
                    }
                };
                ...
                b_BattleComponent.WaitSync(300, b_AttackerId, b_BeAttackerId, mSyncActionChild);
