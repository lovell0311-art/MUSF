...
namespace ETHotfix
{
    ...
    /// 火龙强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_HuoLongStrengthen330)]
    public partial class C_BattleMaster_Skill_HuoLongStrengthen330 : C_BattleMaster
    {
    ...
    /// 火龙强化
    /// </summary>
    public partial class C_BattleMaster_Skill_HuoLongStrengthen330
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HuoLongStrengthen330] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
