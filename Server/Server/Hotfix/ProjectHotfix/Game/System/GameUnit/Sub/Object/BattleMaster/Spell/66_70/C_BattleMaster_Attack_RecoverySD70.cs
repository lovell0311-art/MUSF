...
namespace ETHotfix
{
    ...
    /// 攻击时概率sd恢复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Attack_RecoverySD70)]
    public partial class C_BattleMaster_Attack_RecoverySD70 : C_BattleMaster
    {
    ...
    /// 攻击时概率sd恢复
    /// </summary>
    public partial class C_BattleMaster_Attack_RecoverySD70
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Attack_RecoverySD70] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
