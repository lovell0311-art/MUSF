...
namespace ETHotfix
{
    ...
    /// hp 回复  杀怪后
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.KillRecoveryHp549)]
    public partial class C_BattleMaster_KillRecoveryHp549 : C_BattleMaster
    {
    ...
    /// hp 回复  杀怪后
    /// </summary>
    public partial class C_BattleMaster_KillRecoveryHp549
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.KillRecoveryHp549] = (int)(1f / mConfig.OtherDataDic[mMasterLevel] * 10000 * 10000);
