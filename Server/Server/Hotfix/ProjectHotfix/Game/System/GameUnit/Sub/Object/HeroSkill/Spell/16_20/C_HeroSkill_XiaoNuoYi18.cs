...
namespace ETHotfix
{
    ...
    /// 小挪移
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.XiaoNuoYi)]
    public partial class C_HeroSkill_XiaoNuoYi18 : C_HeroSkillSource
    {
    ...
    /// 小挪移
    /// </summary>
    public partial class C_HeroSkill_XiaoNuoYi18
    {
        ...
        public override CombatSource FindTarget(CombatSource b_Attacker, long b_BeAttackerId, C_FindTheWay2D b_Cell, BattleComponent b_BattleComponent, IActorResponse b_Response)
        {
            ...
            if (mCellField.FieldPlayerDic.TryGetValue(b_BeAttackerId, out var mTargetPlayer) == false)
            {
                if (b_Response != null) b_Response.Error = Root.MainFactory.GetCustomComponent<LanguageComponent>().GetMessageId(436);
                return null;
            }
