...
namespace ETHotfix
{
    ...
    /// 最大魔力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseMagicPowerMax436)]
    public partial class C_BattleMaster_IncreaseMagicPowerMax436 : C_BattleMaster
    {
    ...
    /// 最大魔力增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseMagicPowerMax436
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseMagicPowerMax436] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
