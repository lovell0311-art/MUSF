...
namespace ETHotfix
{
    ...
    /// 冰封
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.BingFeng)]
    public partial class C_HeroSkill_BingFeng7 : C_HeroSkillSource
    {
    ...
    /// 冰封
    /// </summary>
    public partial class C_HeroSkill_BingFeng7
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_BingFengStrengthen37))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_BingFengStrengthen37];
