...
namespace ETHotfix
{
    ...
    /// 双倍一击几率提高
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseShuangBeiYiJiRate469)]
    public partial class C_BattleMaster_IncreaseShuangBeiYiJiRate469 : C_BattleMaster
    {
    ...
    /// 双倍一击几率提高
    /// </summary>
    public partial class C_BattleMaster_IncreaseShuangBeiYiJiRate469
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseShuangBeiYiJiRate469] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
