...
namespace ETHotfix
{
    ...
    /// 敏捷属性增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseAgility117)]
    public partial class C_BattleMaster_IncreaseAgility117 : C_BattleMaster
    {
    ...
    /// 敏捷属性增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseAgility117
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseAgility117] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
