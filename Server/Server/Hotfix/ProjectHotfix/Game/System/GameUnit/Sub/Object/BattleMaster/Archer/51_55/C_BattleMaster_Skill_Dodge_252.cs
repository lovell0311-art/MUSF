...
namespace ETHotfix
{
    ...
    /// 闪避
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_Dodge_252)]
    public partial class C_BattleMaster_Skill_Dodge_252 : C_BattleMaster
    {
    ...
    /// 闪避
    /// </summary>
    public partial class C_BattleMaster_Skill_Dodge_252
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            // 使用技能时，自身基本防御成功率增加50%，持续7秒。60秒以后可重新使用。

            int mMasterLevel = Data.SkillId[this.Id];
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_Dodge_252] = 1;


            var mStudySkillId = (int)E_HeroSkillId.ShanBi228;
            var mReadConfigComponent = Root.MainFactory.GetCustomComponent<CustomFrameWork.Component.ReadConfigComponent>();
