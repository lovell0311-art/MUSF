...
namespace ETHotfix
{
    ...
    /// 旋风斩
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.XuanFengZhan318)]
    public partial class C_HeroSkill_XuanFengZhan318 : C_HeroSkillSource
    {
    ...
    /// 旋风斩
    /// </summary>
    public partial class C_HeroSkill_XuanFengZhan318
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                var mStrength = b_Attacker.GetNumerialFunc(E_GameProperty.Property_Strength) / mConfig.OtherDataDic[10];
                // 总伤害 = 魔法伤害 + 魔力伤害 + 魔杖魔力提升百分比
                int mHurtValue = mVirtualHurtValue + mStrength;
                var mAddScale = mConfig.OtherDataDic[11];
                if (mAddScale != 100)
                    mHurtValue = (int)(mHurtValue * mAddScale * 0.01f);

                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Skill_XuanFengZhanStrengthen326))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_XuanFengZhanStrengthen326];
                    mHurtValue += mMasteryValue;
                }

                //mBeAttacker.CurrentSkill = this;
