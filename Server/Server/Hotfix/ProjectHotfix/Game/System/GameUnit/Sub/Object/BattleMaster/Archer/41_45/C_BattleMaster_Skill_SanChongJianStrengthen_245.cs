...
namespace ETHotfix
{
    ...
    /// 三重箭强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_SanChongJianStrengthen_245)]
    public partial class C_BattleMaster_Skill_SanChongJianStrengthen_245 : C_BattleMaster
    {
    ...
    /// 三重箭强化
    /// </summary>
    public partial class C_BattleMaster_Skill_SanChongJianStrengthen_245
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_SanChongJianStrengthen_245] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
