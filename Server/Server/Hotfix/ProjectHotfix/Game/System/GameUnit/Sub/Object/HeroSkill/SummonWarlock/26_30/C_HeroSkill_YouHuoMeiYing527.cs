...
namespace ETHotfix
{
    ...
    /// 诱惑魅影
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.YouHuoMeiYing527)]
    public partial class C_HeroSkill_YouHuoMeiYing527 : C_HeroSkillSource
    {
    ...
    /// 诱惑魅影
    /// </summary>
    public partial class C_HeroSkill_YouHuoMeiYing527
    {
        ...
        public override bool TryUse(CombatSource b_Attacker, CombatSource b_BeAttacker, C_FindTheWay2D b_Cell, BattleComponent b_BattleComponent, IActorResponse b_Response)
        {
            ...
            if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.Common2013) == false)
            {
