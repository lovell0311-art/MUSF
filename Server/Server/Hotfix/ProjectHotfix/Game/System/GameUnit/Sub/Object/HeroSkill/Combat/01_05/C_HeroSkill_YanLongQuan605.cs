...
namespace ETHotfix
{
    ...
    /// 炎龙拳
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.YanLongQuan605)]
    public partial class C_HeroSkill_YanLongQuan605 : C_HeroSkillSource
    {
    ...
    /// 炎龙拳
    /// </summary>
    public partial class C_HeroSkill_YanLongQuan605
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                int mMinAtteck = mConfig.OtherDataDic[1] + b_Attacker.GetNumerialFunc(E_GameProperty.MinAtteck) + b_Attacker.GetNumerialFunc(E_GameProperty.SacredBeast) + b_Attacker.GetNumerialFunc(E_GameProperty.RangeAttack) + b_Attacker.GetNumerialFunc(E_GameProperty.AdvanceAttackPower); ;
                int mMaxAtteck = mConfig.OtherDataDic[1] + b_Attacker.GetNumerialFunc(E_GameProperty.MaxAtteck) + b_Attacker.GetNumerialFunc(E_GameProperty.SacredBeast) + b_Attacker.GetNumerialFunc(E_GameProperty.RangeAttack) + b_Attacker.GetNumerialFunc(E_GameProperty.AdvanceAttackPower); ;
                ...
                if (b_Attacker.BattleMasteryDic.ContainsKey(E_BattleMasteryState.MasterAttribute634))
                {
                    int mMasteryValue = b_Attacker.BattleMasteryDic[E_BattleMasteryState.MasterAttribute634];
