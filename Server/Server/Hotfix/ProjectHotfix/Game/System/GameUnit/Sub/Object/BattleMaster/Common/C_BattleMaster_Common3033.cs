...
namespace ETHotfix
{
    ...
    /// 受伤生命力回复
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.BeCommon3033)]
    public partial class C_BattleMaster_BeCommon3033 : C_BattleMaster
    {
    ...
    /// 受伤生命力回复
    /// </summary>
    public partial class C_BattleMaster_BeCommon3033
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.BeCommon3033] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
