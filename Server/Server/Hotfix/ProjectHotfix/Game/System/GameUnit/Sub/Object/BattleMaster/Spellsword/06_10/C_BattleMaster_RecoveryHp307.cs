...
namespace ETHotfix
{
    ...
    /// 自动生命恢复力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.RecoveryHp307)]
    public partial class C_BattleMaster_RecoveryHp307 : C_BattleMaster
    {
    ...
    /// 自动生命恢复力增加
    /// </summary>
    public partial class C_BattleMaster_RecoveryHp307
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.RecoveryHp307] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], 0);
