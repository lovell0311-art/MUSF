...
namespace ETHotfix
{
    ...
    /// 最大生命力增加
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.IncreaseHpMax131)]
    public partial class C_BattleMaster_IncreaseHpMax131 : C_BattleMaster
    {
    ...
    /// 最大生命力增加
    /// </summary>
    public partial class C_BattleMaster_IncreaseHpMax131
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.IncreaseHpMax131] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
            if (b_AddPoint)
            {
