...
namespace ETHotfix
{
    ...
    /// 法神附体
    /// </summary>
    [HeroSkillAttribute(BindId = (int)E_HeroSkillId.FaShenFuTi)]
    public partial class C_HeroSkill_FaShenFuTi23 : C_HeroSkillSource
    {
    ...
    /// 法神附体
    /// </summary>
    public partial class C_HeroSkill_FaShenFuTi23
    {
        ...
        public override bool UseSkill(CombatSource b_Attacker, CombatSource b_BeAttacker, BattleComponent b_BattleComponent)
        {
            ...
            Action<long, long, long> mSyncAction = (b_CombatRoundId, b_AttackerId, b_BeAttackerId) =>
            {
                ...
                // 提升最小魔力值=当前智力/25
                // 当增加的最小魔力超过最大魔力时，最小魔力取最大魔力的值。持续时间为10分钟。

                var mWillpower = b_Attacker.GetNumerialFunc(E_GameProperty.Property_Willpower);

                int mStrengthValue = (int)(mWillpower * 0.04f);
                ...
                Func<CombatSource.BattleSyncTimerTask> mCreateFunc = () =>
                {
                    ...
                    mBattleSyncTimer.DisposeAction = (b_CombatSource, b_BattleComponent, b_TimerTask) =>
                    {
                        ...
                        b_CombatSource.RemoveHealthState(E_BattleSkillStats.FaShenFuTi23, b_BattleComponent);
                    ...
                    mBattleSyncTimer.SyncAction = (b_CombatSource, b_BattleComponent, b_TimerTask, b_TimeTick) =>
                    {
                        ...
                        if (b_CombatSource.HealthStatsDic.TryGetValue(E_BattleSkillStats.FaShenFuTi23, out var hp_Curse) == false)
                        {
                ...
                b_Attacker.AddHealthState(E_BattleSkillStats.FaShenFuTi23, mStrengthValue, mConfig.PersistentTime, 0, mCreateFunc, b_BattleComponent);
