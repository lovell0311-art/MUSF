...
namespace ETHotfix
{
    ...
    /// 火舞旋风精通
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_HuoWuXuanFengMaster438)]
    public partial class C_BattleMaster_Skill_HuoWuXuanFengMaster438 : C_BattleMaster
    {
    ...
    /// 火舞旋风精通
    /// </summary>
    public partial class C_BattleMaster_Skill_HuoWuXuanFengMaster438
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_HuoWuXuanFengMaster438] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
