...
namespace ETHotfix
{
    ...
    /// 暴风雪强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Skill_BaoFengXueStrengthen40)]
    public partial class C_BattleMaster_Skill_BaoFengXueStrengthen40 : C_BattleMaster
    {
    ...
    /// 星辰一怒强化
    /// </summary>
    public partial class C_BattleMaster_Skill_BaoFengXueStrengthen40
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Skill_BaoFengXueStrengthen40] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
