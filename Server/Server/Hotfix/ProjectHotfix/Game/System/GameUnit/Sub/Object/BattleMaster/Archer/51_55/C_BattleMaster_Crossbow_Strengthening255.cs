...
namespace ETHotfix
{
    ...
    /// 弩类强化
    /// </summary>
    [BattleMasterAttribute(BindId = (int)E_BattleMaster_Id.Crossbow_Strengthening255)]
    public partial class C_BattleMaster_Crossbow_Strengthening255 : C_BattleMaster
    {
    ...
    /// 弩类强化
    /// </summary>
    public partial class C_BattleMaster_Crossbow_Strengthening255
    {
        ...
        public override bool UseSkill(GamePlayer b_Attacker, BattleComponent b_BattleComponent, bool b_AddPoint)
        {
            ...
            b_Attacker.BattleMasteryDic[E_BattleMasteryState.Crossbow_Strengthening255] = base.GetMasterValue(mConfig.OtherDataDic[mMasterLevel], mConfig.OtherDataUse);
