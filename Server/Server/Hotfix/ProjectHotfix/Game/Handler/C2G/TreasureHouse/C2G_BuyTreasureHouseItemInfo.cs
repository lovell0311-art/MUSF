...
namespace ETHotfix
{
    ...
    public class C2G_BuyTreasureHouseItemInfoHandler : AMActorRpcHandler<C2G_BuyTreasureHouseItemInfo, G2C_BuyTreasureHouseItemInfo>
    {
        protected override async Task<bool> BeforeCodeAsync(Session b_Connect, C2G_BuyTreasureHouseItemInfo b_Request, G2C_BuyTreasureHouseItemInfo b_Response, Action<IMessage> b_Reply)
        {
        ...
        protected override async Task<bool> Run(C2G_BuyTreasureHouseItemInfo b_Request, G2C_BuyTreasureHouseItemInfo b_Response, Action<IMessage> b_Reply)
        {
            ...
            G2M_DleTreasureHouseItemInfo g2M_DleTreasureHouseItemInfo = new G2M_DleTreasureHouseItemInfo
            {
                ...
                MaxTyp = 0,// ItemInfo.MaxType,
                MinTyp = 0//ItemInfo.MinType,
            };
            ...
            else
            {
                ...
                ETModel.EventType.EquipmentRelatedSettings.Instance.player = mPlayer;
