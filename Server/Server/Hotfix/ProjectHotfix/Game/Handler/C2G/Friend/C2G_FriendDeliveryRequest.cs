...
namespace ETHotfix
{
    ...
    public class C2G_FriendDeliveryHandler : AMActorRpcHandler<C2G_FriendDeliveryRequest, G2C_FriendDeliveryResponse>
    {
        protected override async Task<bool> BeforeCodeAsync(Session b_Connect, C2G_FriendDeliveryRequest b_Request, G2C_FriendDeliveryResponse b_Response, Action<IMessage> b_Reply)
        {
        ...
        protected override async Task<bool> Run(C2G_FriendDeliveryRequest b_Request, G2C_FriendDeliveryResponse b_Response, Action<IMessage> b_Reply)
        {
            ...
            {
                Log.PLog("RunCopyLog", "FriendDelivery");
