...
namespace ETHotfix
{
    [GameMasterCommandLine("获取魔晶")]
    public class GMCommandLine_获取魔晶 : C_GameMasterCommandLine<Player, IResponse>
    {
        public override async Task Run(Player b_Player, List<int> b_Parameter, IResponse b_Response)
        {
            ...
            mGamePlayer.UpdateCoin(E_GameProperty.YuanbaoCoin, b_Parameter[0], "GM设置");
            ...
            mBattleKVData.Value = mGamePlayer.Player.Data.YuanbaoCoin;
