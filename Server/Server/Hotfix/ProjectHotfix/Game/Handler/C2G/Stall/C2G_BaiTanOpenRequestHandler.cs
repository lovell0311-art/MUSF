...
namespace ETHotfix
{
    ...
    public class C2G_BaiTanOpenRequestHandler : AMActorRpcHandler<C2G_BaiTanOpenRequest, G2C_BaiTanOpenResponse>
    {
        protected override async Task<bool> BeforeCodeAsync(Session b_Connect, C2G_BaiTanOpenRequest b_Request, G2C_BaiTanOpenResponse b_Response, Action<IMessage> b_Reply)
        {
        ...
        protected override async Task<bool> Run(C2G_BaiTanOpenRequest b_Request, G2C_BaiTanOpenResponse b_Response, Action<IMessage> b_Reply)
        {
            ...
            if (mStall.StallName == null)
            {
                b_Response.Error = Root.MainFactory.GetCustomComponent<LanguageComponent>().GetMessageId(2121);
                //b_Response.Message = Root.MainFactory.GetCustomComponent<LanguageComponent>().GetMessage("位置区域数据异常y,不能攻击!");
                b_Reply(b_Response);
                return false;
            }
            ...
            if (mData.IsDispose == 0)
            {
                ...
                G2C_BaiTanInstance_notice mBaiTanInstance_notice = new G2C_BaiTanInstance_notice();
                C2G_BaiTanInfoMessage mBaiTanInfoMessage = new C2G_BaiTanInfoMessage();
                mBaiTanInfoMessage.BaiTanInstanceId = mData.GameUserId;
                mBaiTanInfoMessage.BaiTanName = mStall.StallName;
                ...
                mMapComponent.SendNotice(mGamePlayer, mBaiTanInstance_notice);
            }
