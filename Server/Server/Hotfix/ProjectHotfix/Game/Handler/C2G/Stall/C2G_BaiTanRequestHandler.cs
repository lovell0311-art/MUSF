...
namespace ETHotfix
{
    ...
    public class C2G_BaiTanRequestHandler : AMActorRpcHandler<C2G_BaiTanRequest, G2C_BaiTanResponse>
    {
        protected override async Task<bool> BeforeCodeAsync(Session b_Connect, C2G_BaiTanRequest b_Request, G2C_BaiTanResponse b_Response, Action<IMessage> b_Reply)
        {
        ...
        protected override async Task<bool> Run(C2G_BaiTanRequest b_Request, G2C_BaiTanResponse b_Response, Action<IMessage> b_Reply)
        {
            ...
            b_Response.BaiTanInstanceId = mData.GameUserId;
