...
namespace ETHotfix
{
    ...
    public class C2G_LoginSystemCreateGamePlayerRequestHandler2 : AMActorRpcHandler<C2G_LoginSystemCreateGamePlayerRequest, G2C_LoginSystemCreateGamePlayerResponse>
    {
        protected override async Task<bool> CodeAsync(Session session, C2G_LoginSystemCreateGamePlayerRequest b_Request, G2C_LoginSystemCreateGamePlayerResponse b_Response, Action<IMessage> b_Reply)
        {
