...
namespace ETHotfix
{
    ...
    public class C2G_DouYinCreateAnOrderRequestr2 : AMActorRpcHandler<C2G_DouYinCreateAnOrderRequest, C2G_DouYinCreateAnOrderResponse>
    {
        protected override Task<bool> BeforeCodeAsync(Session b_Connect, C2G_DouYinCreateAnOrderRequest b_Request, C2G_DouYinCreateAnOrderResponse b_Response, Action<IMessage> b_Reply)
        {
            return base.BeforeCodeAsync(b_Connect, b_Request, b_Response, b_Reply);
        }

        protected override async Task<bool> CodeAsync(Session session, C2G_DouYinCreateAnOrderRequest b_Request, C2G_DouYinCreateAnOrderResponse b_Response, Action<IMessage> b_Reply)
        {
