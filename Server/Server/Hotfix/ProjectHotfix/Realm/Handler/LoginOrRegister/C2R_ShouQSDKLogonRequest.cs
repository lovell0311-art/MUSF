...
namespace ETHotfix
{
    ...
    public class C2R_ShouQSDKLogonRequestHandler : AMRpcHandler<C2R_ShouQSDKLogonRequest, R2C_ShouQSDKLogonResponse>
    {
        protected override async Task<bool> CodeAsync(Session session, C2R_ShouQSDKLogonRequest request, R2C_ShouQSDKLogonResponse response, Action<IMessage> reply)
        {
