...
namespace ETModel
{
    public class BattleMasteryConstData
    {
        ...
        public const int MusketeerId = 700;
        public const int Windwarrior = 800;
        public const int GrowLancerId = 900;
        public const int CommonId = 2000;
        /// <summary>
        /// 2024.11.18大师通用
        /// </summary>
        public const int BeCommonId = 3000;
    }


    public enum E_BattleMasteryState
    {
        ...
        /// 三重箭
        /// </summary>
        Skill_SanChongJian242 = 42 + BattleMasteryConstData.ArcherId,
        /// <summary>
        /// 最大生命增加 234,243
        /// </summary>
