...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    map_regression.add_argument("--character-name", default="")
    map_regression.add_argument("--zone-id", type=int, default=1)
    map_regression.add_argument("--server-id", type=int, default=1)
