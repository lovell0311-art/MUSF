...
/* UNITY: Original start of shader */
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 tex2DNode10 = tex2D( _main_tex, ( uv_main_tex + ( tex2D( _noise_tex, panner5 ).r * _raodong_qiangdu ) ) );
			float2 uv_mask_tex = i.uv_texcoord * _mask_tex_ST.xy + _mask_tex_ST.zw;
			float4 tex2DNode17 = tex2D( _mask_tex, uv_mask_tex );
			o.Emission = ( ( tex2DNode10 * tex2DNode17 * i.vertexColor ) * _Color0 * i.vertexColor * i.vertexColor.a ).rgb;
			float clampResult23 = clamp( ( i.vertexColor.a * tex2DNode10.a * tex2DNode17.a * _Float0 ) , 0.0 , 1.0 );
