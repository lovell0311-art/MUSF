Shader "Waibao/Particles/AlphaBlend" {
Properties {
    ...
    [Toggle] _UseDissolveUvAni("======溶解UV滚动======", Float) = 0
...
Category {
    ...
    SubShader {
        Pass {
            ...
            #pragma shader_feature _USEDISSOLVEUVANI_ON
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                col.a = saturate(col.a)*_AlphaScale;
                	...
                	#if _USEDISSOLVEUVANI_ON
                    	i.texcoordDissolve += _Time.y * float2(_DissolveSpeedU, _DissolveSpeedV);
                    #endif
