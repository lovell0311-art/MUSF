...
namespace ETHotfix
{
	public sealed class EventSystem
	{
		...
		private Queue<long> fixeUpdates2 = new Queue<long>();
		...
		public void Update()
		{
			...
			//	Profiler.BeginSample("end");
                foreach (IUpdateSystem iUpdateSystem in iUpdateSystems)
				{
					try
					{
						// Log.DebugGreen($"component:{component.GetType().FullName}");
						//Profiler.BeginSample($"component:{component.GetType().FullName}");
        ...
        public void FixedUpdate()
        {
            while (this.fixedUpdates.Count > 0)
            {
                ...
                this.fixeUpdates2.Enqueue(instanceId);
            ...
            ObjectHelper.Swap(ref this.fixedUpdates, ref this.fixeUpdates2);
        }
