...
namespace ETHotfix
{
    ...
    /// </summary>
    [MergerSystem(309)]
    public class SiWangPiFengMerger : MergerMethod
    {
        /// <summary>
        /// 二代翅膀、披风
        /// </summary>
        ...
        public override bool CanUserThisMergerMethod()
        {
            ...
            MaxSuccessRate = 70;
            FailedDelete = true;
            mergerMethodId = 10010;
            mergerMethod = "SiWangPiFengSynthesis";
            ...
            AddMustItemInfoText("骷髅王骨头\t\tx1", MustItem.IsHaveChiYanMoDeLinHun = IsHaveItem(itemConfigId: 320199));
