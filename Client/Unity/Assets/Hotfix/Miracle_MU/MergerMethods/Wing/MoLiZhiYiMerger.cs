...
{
    [MergerSystem(308)]
    public class MoLiZhiYiMerger : MergerMethod
    {
        /// <summary>
        /// 魔力之翼合成
        /// </summary>
        ...
        public override bool CanUserThisMergerMethod()
        {
            ...
            MaxSuccessRate = 70;
            FailedDelete = true;
            mergerMethodId = 10009;
            mergerMethod = "MoLiWingSynthesis";
            (bool IsHaveWing_2, bool IsHaveChiYanMoDeLinHun, bool IsHaveCreatStone, bool IsHaveMayaStone) MustItem;
            Log.DebugGreen($"魔力之翼合成：{CheckItems.Count}");
            //标题
            AddTextTitle("魔力之翼合成");
            ///必须材料
            AddMustItemInfoText("二代翅膀/披风\t\tx1", MustItem.IsHaveWing_2 = IsHaveWing_2());
            AddMustItemInfoText("天魔菲尼斯的火花\t\tx1", MustItem.IsHaveChiYanMoDeLinHun = IsHaveItem(itemConfigId: 320201));
