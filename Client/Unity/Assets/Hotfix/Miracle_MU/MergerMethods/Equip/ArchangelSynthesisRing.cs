...
namespace ETHotfix
{
    ...
    /// </summary>
    [MergerSystem(603)]
    public class ArchangelSynthesisRing : MergerMethod
    {
        /// <summary>
        ///套装指向合成符咒
        /// </summary>
        ...
        public override bool CanUserThisMergerMethod()
        {
           ...
           // AddMustItemInfoText("普通品质防具装备\t\tx1", MustItem.IsHaveNormalWeaponItem = IsHaveFangJuZhuangBei());
            ...
            AddMustItemInfoText(isHave: MustItem.IsHaveShengMingGem = IsHaveItem(itemConfigId: 320459, 20, out int linghuncount), isEnough: linghuncount >= 20, str: $"大天使戒指碎片\t\tx20({linghuncount})");
