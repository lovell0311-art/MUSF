...
namespace ETHotfix
{
    ...
    /// </summary>
    [MergerSystem(604)]
    public class ArchangelSynthesisBracelet : MergerMethod
    {    /// <summary>
         ///套装指向合成符咒
         /// </summary>
        ...
        public override bool CanUserThisMergerMethod()
        {
           ...
           // AddMustItemInfoText("普通品质防具装备\t\tx1", MustItem.IsHaveNormalWeaponItem = IsHaveFangJuZhuangBei());
            ...
            AddMustItemInfoText(isHave: MustItem.IsHaveShengMingGem = IsHaveItem(itemConfigId: 320460, 20, out int linghuncount), isEnough: linghuncount >= 20, str: $"大天使手环碎片\t\tx20({linghuncount})");
