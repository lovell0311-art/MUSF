...
namespace ETHotfix
{
    ...
    /// </summary>
    [MergerSystem(707)]
    public class ZhuFuDaTianShiZhiJueDuiQuanRenMerger : MergerMethod
    {
        public override bool CanUserThisMergerMethod()
        {
            ...
            MaxSuccessRate = 50;
            FailedDelete = true;
            mergerMethodId = 10028;
            mergerMethod = "BlessingScepterSynthesis";
            (bool IsDaTianShiZhiJueDuiQuanRen, bool IsDaTianShiDeTieChui, bool IsHaveZhuFuBaoShi, bool IsHaveLingHunBaoShi, bool IsHaveShengMingBaoShi, bool IsHaveMayaStone) MustItem;
            Log.DebugGreen($"祝福大天使之绝对拳刃合成：{CheckItems.Count}");
            //标题
            AddTextTitle("祝福大天使之绝对拳刃合成");
            ///必须材料
            AddMustItemInfoText(isHave: MustItem.IsDaTianShiZhiJueDuiQuanRen = IsHaveYouLingZhanMa(out int lev, out int optLevel), str: $"大天使之绝对拳刃(+{lev})追{optLevel}\t\tx1");
          ...
          //  AddSubItemInfoText("保护符咒\t\tx1", IsHaveItem(itemConfigId: 320318));
            ...
            bool IsHaveYouLingZhanMa(out int lev, out int optLevel)
            {
                ...
                {
                    if (CheckItems[i].ConfigId == 120003)
                    {
