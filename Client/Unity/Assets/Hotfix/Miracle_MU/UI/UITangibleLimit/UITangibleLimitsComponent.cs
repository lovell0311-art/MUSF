...
namespace ETHotfix
{
    ...
    [ObjectSystem]
    public class UITangibleLimitsComponentAwake : AwakeSystem<UITangibleLimitsComponent>
    {
        public override void Awake(UITangibleLimitsComponent self)
        {
    ...
    public partial class UITangibleLimitsComponent : Component
    {
