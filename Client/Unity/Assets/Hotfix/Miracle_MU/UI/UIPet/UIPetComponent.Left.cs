...
{
    [ObjectSystem]
    public class UIPetComponentUpdate : UpdateSystem<UIPetComponent>
    {
        public override void Update(UIPetComponent self)
        {
    ...
    public partial class UIPetComponent
    {
        ...
        public void ShowPetModel(GameObject item, UIPetInfo PetInfo)
        {
            ...
            if (PetInfo.petId != 0)
            {
                ...
                infoConfig = ConfigComponent.Instance.GetItem<Pets_InfoConfig>((int)PetInfo.petsConfigID);
        ...
        public void PetClickEvent(GameObject item = null, UIPetInfo PetInfo = null)
        {
            ...
            //设置宠物名字
            PetNameTxt.text = PetInfo.petName;
            //设置宠物等级
            PetLevelTxt.text = "LV:" + PetInfo.petLevel.ToString();
            //设置宠物经验条
