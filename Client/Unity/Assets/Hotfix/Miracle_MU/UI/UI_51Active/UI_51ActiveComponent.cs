...
{
    [ObjectSystem]
    public class UI_51ActiveComponentAwake : AwakeSystem<UI_51ActiveComponent>
    {
        //龙王旗帜  赤焰兽
        public override void Awake(UI_51ActiveComponent self)
        {
            self.collectorData = self.GetParent<UI>().GameObject.GetReferenceCollector();
            self.collectorData.GetButton("CloseBtn").onClick.AddSingleListener(() => UIComponent.Instance.Remove(UIType.UI_51Active));
            self.collectorData.GetButton("topUp_1").onClick.AddSingleListener(() => self.TopUp(688).Coroutine());
            self.collectorData.GetButton("topUp_2").onClick.AddSingleListener(() => self.TopUp(888).Coroutine());
    ...
    /// 五一充值活动
    /// </summary>
    public class UI_51ActiveComponent : Component
    {
        ...
        public void InitItem()
        {
          ...
          //  GameObject fenghuang=  ResourcesComponent.Instance.LoadGameObject("Shop_fenghuang".StringToAB(), "Shop_fenghuang");
            GameObject fenghuang=  ResourcesComponent.Instance.LoadGameObject("shop_LongWangQiZhi".StringToAB(), "shop_LongWangQiZhi");
            ...
            target_1.GetComponent<UGUITriggerProxy>().OnPointerClickEvent=()=>
            {
               ...
               KnapsackDataItem.ConfigId = 340002;
                diratr.Add("合成说明");
                diratr.Add("");
