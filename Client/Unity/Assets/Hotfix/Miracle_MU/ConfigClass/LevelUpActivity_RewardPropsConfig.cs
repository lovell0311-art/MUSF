...
namespace ETHotfix
{
	...
	public partial class LevelUpActivity_RewardPropsConfigCategory : ACategory<LevelUpActivity_RewardPropsConfig>
	{
	}

	///<summary>等级奖励物品 </summary>
	public class LevelUpActivity_RewardPropsConfig: IConfig
	{
