...
namespace ETHotfix
{
	...
	public partial class BattleMaster_SpellswordConfigCategory : ACategory<BattleMaster_SpellswordConfig>
	{
	}

	///<summary>大师-魔剑士 </summary>
	public class BattleMaster_SpellswordConfig: IConfig
	{
