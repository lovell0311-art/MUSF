...
namespace ETHotfix
{
	...
	public partial class BattleMaster_MageRuneConfigCategory : ACategory<BattleMaster_MageRuneConfig>
	{
	}

	///<summary>大师-符文法师 </summary>
	public class BattleMaster_MageRuneConfig: IConfig
	{
