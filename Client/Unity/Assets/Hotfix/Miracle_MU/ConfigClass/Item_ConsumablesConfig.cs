...
namespace ETHotfix
{
	...
	public partial class Item_ConsumablesConfigCategory : ACategory<Item_ConsumablesConfig>
	{
	}

	///<summary>31.消耗品(血瓶|药水|实力提升卷轴) </summary>
	public class Item_ConsumablesConfig: IConfig
	{
