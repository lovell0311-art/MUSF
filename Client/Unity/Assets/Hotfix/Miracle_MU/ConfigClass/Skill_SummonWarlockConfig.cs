...
namespace ETHotfix
{
	...
	public partial class Skill_SummonWarlockConfigCategory : ACategory<Skill_SummonWarlockConfig>
	{
	}

	///<summary>技能-召唤术师 </summary>
	public class Skill_SummonWarlockConfig: IConfig
	{
