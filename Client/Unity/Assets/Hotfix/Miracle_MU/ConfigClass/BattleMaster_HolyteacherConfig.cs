...
namespace ETHotfix
{
	...
	public partial class BattleMaster_HolyteacherConfigCategory : ACategory<BattleMaster_HolyteacherConfig>
	{
	}

	///<summary>大师-圣导师 </summary>
	public class BattleMaster_HolyteacherConfig: IConfig
	{
