...
namespace ETHotfix
{
	...
	public partial class BattleMaster_ArcherConfigCategory : ACategory<BattleMaster_ArcherConfig>
	{
	}

	///<summary>大师-弓箭手 </summary>
	public class BattleMaster_ArcherConfig: IConfig
	{
