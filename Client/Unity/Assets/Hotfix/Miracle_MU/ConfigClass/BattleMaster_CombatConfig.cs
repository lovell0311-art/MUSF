...
namespace ETHotfix
{
	...
	public partial class BattleMaster_CombatConfigCategory : ACategory<BattleMaster_CombatConfig>
	{
	}

	///<summary>大师-格斗家 </summary>
	public class BattleMaster_CombatConfig: IConfig
	{
