...
namespace ETHotfix
{
	...
	public partial class GameTask_HuntingConfigCategory : ACategory<GameTask_HuntingConfig>
	{
	}

	///<summary>狩猎任务 </summary>
	public class GameTask_HuntingConfig: IConfig
	{
