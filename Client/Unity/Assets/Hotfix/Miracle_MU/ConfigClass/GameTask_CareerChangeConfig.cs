...
namespace ETHotfix
{
	...
	public partial class GameTask_CareerChangeConfigCategory : ACategory<GameTask_CareerChangeConfig>
	{
	}

	///<summary>转职任务 </summary>
	public class GameTask_CareerChangeConfig: IConfig
	{
