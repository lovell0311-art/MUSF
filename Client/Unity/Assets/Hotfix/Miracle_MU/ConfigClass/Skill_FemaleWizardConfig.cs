...
namespace ETHotfix
{
	...
	public partial class Skill_FemaleWizardConfigCategory : ACategory<Skill_FemaleWizardConfig>
	{
	}

	///<summary>女魔法师 </summary>
	public class Skill_FemaleWizardConfig: IConfig
	{
