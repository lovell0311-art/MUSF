...
namespace ETHotfix
{
	...
	public partial class Skill_HolyteacherConfigCategory : ACategory<Skill_HolyteacherConfig>
	{
	}

	///<summary>技能-圣导师 </summary>
	public class Skill_HolyteacherConfig: IConfig
	{
