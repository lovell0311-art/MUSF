...
namespace ETHotfix
{
	...
	public partial class ValueGift_ItemInfoConfigCategory : ACategory<ValueGift_ItemInfoConfig>
	{
	}

	///<summary>超值礼包物品信息 </summary>
	public class ValueGift_ItemInfoConfig: IConfig
	{
