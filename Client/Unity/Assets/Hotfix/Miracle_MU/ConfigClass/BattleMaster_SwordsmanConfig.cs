...
namespace ETHotfix
{
	...
	public partial class BattleMaster_SwordsmanConfigCategory : ACategory<BattleMaster_SwordsmanConfig>
	{
	}

	///<summary>大师-剑士 </summary>
	public class BattleMaster_SwordsmanConfig: IConfig
	{
