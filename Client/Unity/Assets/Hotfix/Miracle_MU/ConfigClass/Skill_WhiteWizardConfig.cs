...
namespace ETHotfix
{
	...
	public partial class Skill_WhiteWizardConfigCategory : ACategory<Skill_WhiteWizardConfig>
	{
	}

	///<summary>白魔法师 </summary>
	public class Skill_WhiteWizardConfig: IConfig
	{
