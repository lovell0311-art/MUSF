...
namespace ETHotfix
{
	...
	public partial class BattleMaster_MusketeersConfigCategory : ACategory<BattleMaster_MusketeersConfig>
	{
	}

	///<summary>大师-火枪手 </summary>
	public class BattleMaster_MusketeersConfig: IConfig
	{
