...
namespace ETHotfix
{
	...
	public partial class EnemyConfig_InfoConfigCategory : ACategory<EnemyConfig_InfoConfig>
	{
	}

	///<summary>怪物 </summary>
	public class EnemyConfig_InfoConfig: IConfig
	{
