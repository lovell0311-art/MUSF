...
namespace ETModel
{
    public class EditorResHelper
    {
        ...
        public static List<string> GetPrefabsAndScenes(string srcPath)
        {
            ...
            {
                if (str.EndsWith(".prefab") || str.EndsWith(".unity")||str.EndsWith(".mat")||str.EndsWith(".spriteatlas")
                    ||str.EndsWith(".anim")||str.EndsWith(".jpg") || str.EndsWith(".png") || str.EndsWith(".FBX")||str.EndsWith(".controller")||str.EndsWith(".tga")
                    || str.EndsWith(".fbx") || str.EndsWith(".shader"))
                {
                    files.Add(str);
                }
            }
