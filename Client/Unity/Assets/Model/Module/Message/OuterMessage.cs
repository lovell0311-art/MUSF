...
namespace ETModel {
  ...
  public partial class T2T_Ping : pb::IMessage {
    private static readonly pb::MessageParser<T2T_Ping> _parser = new pb::MessageParser<T2T_Ping>(() => (T2T_Ping)MessagePool.Instance.Fetch(typeof(T2T_Ping)));
    public static pb::MessageParser<T2T_Ping> Parser { get { return _parser; } }
