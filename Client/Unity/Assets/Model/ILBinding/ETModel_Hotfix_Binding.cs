...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_Hotfix_Binding
    {
        ...
        static StackObject* GetHotfixTypes_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.Hotfix instance_of_this_method = (ETModel.Hotfix)typeof(ETModel.Hotfix).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        {
            var result_of_this_method = ((ETModel.Hotfix)o).FixedUpdate;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }
        ...
        static StackObject* AssignFromStack_FixedUpdate_2(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            ((ETModel.Hotfix)o).FixedUpdate = @FixedUpdate;
            return ptr_of_this_method;
        }
