...
{
    unsafe class System_Collections_Generic_Queue_1_AstarNode_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Queue<ETModel.AstarNode>);
            args = new Type[]{};
        ...
        static StackObject* Clear_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Queue<ETModel.AstarNode> instance_of_this_method = (System.Collections.Generic.Queue<ETModel.AstarNode>)typeof(System.Collections.Generic.Queue<ETModel.AstarNode>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Queue<ETModel.AstarNode>();
