...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_LayoutRebuilder_Binding
    {
        ...
        static StackObject* ForceRebuildLayoutImmediate_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.RectTransform @layoutRoot = (UnityEngine.RectTransform)typeof(UnityEngine.RectTransform).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
