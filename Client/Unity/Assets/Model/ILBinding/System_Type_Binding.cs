...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Type_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_IsValueType_0);
            args = new Type[]{};
            method = type.GetMethod("get_IsArray", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_IsArray_1);
            args = new Type[]{};
            method = type.GetMethod("get_IsClass", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_IsClass_2);
            args = new Type[]{typeof(System.Reflection.BindingFlags)};
            method = type.GetMethod("GetProperties", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetProperties_3);
            args = new Type[]{};
            method = type.GetMethod("get_FullName", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_FullName_4);
            ...
            app.RegisterCLRMethodRedirection(method, get_IsAbstract_8);
            args = new Type[]{typeof(System.Type)};
            method = type.GetMethod("IsAssignableFrom", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, IsAssignableFrom_9);


        }


        static StackObject* get_IsValueType_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* get_IsArray_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_IsClass_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* GetProperties_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* get_FullName_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_IsAbstract_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* IsAssignableFrom_9(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
