...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_ETTask_1_Google_Protobuf_Adapt_IMessage_Binding_Adaptor_Binding
    {
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            ETModel.ETTask<Google.Protobuf.Adapt_IMessage.Adaptor> instance_of_this_method = (ETModel.ETTask<Google.Protobuf.Adapt_IMessage.Adaptor>)typeof(ETModel.ETTask<Google.Protobuf.Adapt_IMessage.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
