...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ETModel_SceneChangeComponent_Binding
    {
        ...
        static StackObject* ChangeSceneAsync_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ETModel.SceneChangeComponent instance_of_this_method = (ETModel.SceneChangeComponent)typeof(ETModel.SceneChangeComponent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
