...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Renderer_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SetPropertyBlock_0);


        }


        static StackObject* SetPropertyBlock_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
