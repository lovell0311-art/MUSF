...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_AnimatorStateInfo_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_fullPathHash_0);
            args = new Type[]{};
            method = type.GetMethod("get_normalizedTime", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_normalizedTime_1);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("IsName", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, IsName_2);
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref UnityEngine.AnimatorStateInfo instance_of_this_method)
        {
        ...
        static StackObject* get_fullPathHash_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* get_normalizedTime_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* IsName_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
