...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_Dropdown_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, AddOptions_4);
            args = new Type[]{};
            method = type.GetMethod("ClearOptions", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ClearOptions_5);
            args = new Type[]{typeof(System.Collections.Generic.List<UnityEngine.UI.Dropdown.OptionData>)};
            method = type.GetMethod("AddOptions", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, AddOptions_6);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("SetValueWithoutNotify", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, SetValueWithoutNotify_7);
        ...
        static StackObject* AddOptions_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* ClearOptions_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* AddOptions_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.List<UnityEngine.UI.Dropdown.OptionData> @options = (System.Collections.Generic.List<UnityEngine.UI.Dropdown.OptionData>)typeof(System.Collections.Generic.List<UnityEngine.UI.Dropdown.OptionData>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* SetValueWithoutNotify_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
