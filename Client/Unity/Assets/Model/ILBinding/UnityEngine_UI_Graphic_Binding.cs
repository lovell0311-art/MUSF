...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_UI_Graphic_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, CrossFadeAlpha_0);
            ...
            app.RegisterCLRMethodRedirection(method, SetNativeSize_2);
        ...
        static StackObject* CrossFadeAlpha_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* SetNativeSize_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
