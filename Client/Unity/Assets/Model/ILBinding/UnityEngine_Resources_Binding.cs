...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Resources_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, UnloadUnusedAssets_0);


        }


        static StackObject* UnloadUnusedAssets_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
