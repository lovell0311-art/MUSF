...
namespace ILRuntime.Runtime.Generated
{
    unsafe class LitJson_JsonMapper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(ETModel.GameSetInfo)};
            if (genericMethods.TryGetValue("ToObject", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(ETModel.GameSetInfo), typeof(System.String)))
                    {
            ...
            if (genericMethods.TryGetValue("ToObject", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(global::SpawnPoint[]), typeof(System.String)))
                    {
                        method = m.MakeGenericMethod(args);
            ...
            args = new Type[]{typeof(ETModel.UserInfo)};
            if (genericMethods.TryGetValue("ToObject", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(ETModel.UserInfo), typeof(System.String)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* ToObject_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = LitJson.JsonMapper.ToObject<ETModel.GameSetInfo>(@json);
        ...
        static StackObject* ToObject_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = LitJson.JsonMapper.ToObject<global::SpawnPoint[]>(@json);
        ...
        static StackObject* ToObject_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = LitJson.JsonMapper.ToObject<ETModel.UserInfo>(@json);
