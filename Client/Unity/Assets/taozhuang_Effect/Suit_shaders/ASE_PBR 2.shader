...
Shader "ASE/PBR"
{
	Properties
	{
		...
		_MainColorAdd("MainColorAdd", Color) = (0.1953097,0.2255388,0.3113208,1)
...
#line 42
		...
		{
			o.Albedo = ( _MainColorAdd + float4( 0,0,0,0 ) ).rgb;
			...
			float2 panner34 = ( 1.0 * _Time.y * float2( 0,0 ) + uv2_TwistTex);
			...
			float4 tex2DNode14 = tex2D( _AddtiveLightTex, ( float4( uv2_AddtiveLightTex, 0.0 , 0.0 ) + temp_output_25_0 + localMyCustomExpression27 ).rg );
			...
			o.Emission = saturate( ( ( lerpResult68 * _MainTexIntensity ) + ( _Stage_1 * ( _NoiseTexColor * tex2DNode5 * tex2DNode5.a ) * tex2DNode73.r ) + ( tex2DNode14 * tex2DNode14.a * _AddtiveLightColor * _Stage_3 * tex2DNode73.r ) + ( _Stage_2 * ( _NoiseTexColor2 * ( tex2D( _NoiseTex2, panner57 ) + 0.0 ) ) * tex2DNode73.r ) ) ).rgb;
