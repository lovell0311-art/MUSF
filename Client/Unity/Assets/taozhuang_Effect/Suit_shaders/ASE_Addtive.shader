...
Shader "ASE/Addtive"
{
	Properties
	{
		...
		_Mask("Mask", 2D) = "white" {}
		[Enum(Speed,0,Custom,1)]_Float0("Float 0", Float) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 lerpResult14 = lerp( float2( 0,0 ) , appendResult16 , _Float0);
...
/*ASEBEGIN
Version=18912
2087;156;1339;663;568.938;193.1679;1;True;False
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;15;-1749.764,428.6779;Inherit;False;1;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-1319.08,528.8557;Inherit;False;Property;_Float0;Float 0;5;1;[Enum];Create;True;0;2;Speed;0;Custom;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1;-616.512,-96.43012;Inherit;False;Property;_BaseColor;BaseColor;0;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1.003922,2.070588,5.992157,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;4;-701.1746,117.5856;Inherit;True;Property;_MainTex;MainTex;1;0;Create;True;0;0;0;False;0;False;-1;None;75dd596a286614e4ea09f7f99f4c93ac;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=60F4CB59E05B7DB66A10C6DA2C71D4D59AA41956