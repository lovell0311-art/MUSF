...
struct v2f_surf {
  ...
  float4 pack1 : TEXCOORD1; // _tex4coord
...
v2f_surf vert_surf (appdata_full v) {
  ...
  o.pack1.xyzw = TRANSFORM_TEX(v.texcoord, _tex4coord);
