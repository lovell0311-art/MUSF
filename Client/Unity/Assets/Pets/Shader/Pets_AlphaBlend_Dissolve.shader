...
Shader "ASE/Pets_AlphaBlend_Dissolve"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float smoothstepResult40 = smoothstep( ( 1.0 - 1.0 ) , 1.0 , ( tex2D( _DissolveTex, uv_DissolveTex ).r + 1.0 + ( ( texCoord31.x + texCoord31.w ) * -2.0 ) ));
...
/*ASEBEGIN
Version=18912
2083;205;1339;666;2334.964;-908.9704;1;True;False
Node;AmplifyShaderEditor.Vector2Node;25;-2119.057,192.7754;Inherit;False;Property;_TwistSpeed;TwistSpeed;6;0;Create;True;0;0;0;False;0;False;0,0;-0.1,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;31;-1929.027,998.599;Inherit;False;0;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;8;-1561.745,-69.12325;Inherit;False;Property;_MainTexSpeed;MainTexSpeed;2;0;Create;True;0;0;0;False;0;False;0,0;0.3,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;3;-751.4158,-103.6137;Inherit;True;Property;_MainTex;MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;df9eb24c860b031409b8c1f8b1a22ff4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;1;-720.2189,-289.8527;Inherit;False;Property;_MainColor;MainColor;1;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1.5,1.5,1.5,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=25AF805CEE2EED5670FE83DDAAF609ECDE04A011