...
#line 30
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 panner70 = ( 1.0 * _Time.y * float2( 0,0 ) + uv_AddtiveTex);
			...
			o.Emission = ( float4( hsvTorgb46 , 0.0 ) + ( ( ( 1.0 - step( temp_output_11_0 , 0.49 ) ) - ( 1.0 - temp_output_14_0 ) ) * _LineColor ) + ( _LineColor * tex2D( _AddtiveTex, panner70 ) * saturate( ( tex2D( _DissolveAdd, uv_DissolveAdd ) + 1.0 + ( -2.0 * _Addtive ) ) ) ) + ( _EmissionColor * tex2D( _EmissionMask, uv_EmissionMask ).r * tex2DNode2 * _EmissionIntensity ) ).rgb;
			o.Alpha = ( tex2DNode2.a * temp_output_14_0 );
		}
